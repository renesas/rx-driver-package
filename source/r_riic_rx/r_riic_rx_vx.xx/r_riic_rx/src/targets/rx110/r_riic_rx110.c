 ...
 *                               Since there is an error in the handling of pin function settings of RX110 in Rev.1.90, 
 *                               build error occurs if use RX110.
 *                               When you build the project, after create a new project with selected "RX110" series 
 *                               device as MCU, and added RIIC FIT module Rev.1.90 in reference to 
 *                               "2.10 Adding the FIT Module to Your Project".
 *                               Corrected the handling pin function settings by function riic_mcu_mpc_enable() and 
 *                               riic_mcu_mpc_disable().
