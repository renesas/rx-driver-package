...
* Description  : Functions for using DTC on RX71M devices.
*******************************************************************************/
/*******************************************************************************
...
*         : 30.09.2016 2.05    Deleted Private function r_dtc_check_DMAC_locking_byUSER(void).
*         :                    Added "Defines for DTC support".
...
const dtc_activation_source_t g_source_array[DTC_NUM_INTERRUPT_SRC] =
{
    ...
    DTCE_ICU_IRQ8,DTCE_ICU_IRQ9,DTCE_ICU_IRQ10,DTCE_ICU_IRQ11,DTCE_ICU_IRQ12,DTCE_ICU_IRQ13,DTCE_ICU_IRQ14,
    DTCE_ICU_IRQ15,
    ...
    DTCE_SCIFA11_RXIF11,DTCE_SCIFA11_TXIF11,
