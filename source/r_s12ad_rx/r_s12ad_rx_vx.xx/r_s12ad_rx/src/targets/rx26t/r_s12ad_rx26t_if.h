...
#ifndef S12AD_PRV_RX26T_IF_H
#define S12AD_PRV_RX26T_IF_H

/******************************************************************************
Macro definitions
*******************************************************************************/
#define ADC_PRV_RAMSIZE_IS_48K  ((BSP_CFG_MCU_PART_MEMORY_SIZE == 0xA) || (BSP_CFG_MCU_PART_MEMORY_SIZE == 0x8))
#define ADC_PRV_RAMSIZE_NOT_48K ((BSP_CFG_MCU_PART_MEMORY_SIZE != 0xA) && (BSP_CFG_MCU_PART_MEMORY_SIZE != 0x8))

#if ADC_PRV_RAMSIZE_IS_48K
#define ADC_0_REG_ARRAY_MAX   (7)
#define ADC_2_REG_ARRAY_MAX   (14)
#else
#define ADC_0_REG_ARRAY_MAX   (4)
#define ADC_1_REG_ARRAY_MAX   (4)
#define ADC_2_REG_ARRAY_MAX   (14)
#endif /* ADC_PRV_RAMSIZE_IS_48K */
...
typedef enum e_adc_set
{
    ADC_AUTO_SET_OFF = 0x0000,
    ADC_AUTO_SET_ON  = 0x0040
} adc_set_t;
...
typedef enum e_adc_trig           // trigger sources (set to TRSA bit or TRSB bit)
{
    ...
    ADC_TRIG_SYNC_GTADTR0AN              = 64,  // GPT0 GTADTRA
    ADC_TRIG_SYNC_GTADTR0BN              = 65,  // GPT0 GTADTRB
    ADC_TRIG_SYNC_GTADTR1AN              = 66,  // GPT1 GTADTRA
    ADC_TRIG_SYNC_GTADTR1BN              = 67,  // GPT1 GTADTRB
    ADC_TRIG_SYNC_GTADTR2AN              = 68,  // GPT2 GTADTRA
    ADC_TRIG_SYNC_GTADTR2BN              = 69,  // GPT2 GTADTRB
    ADC_TRIG_SYNC_GTADTR3AN              = 70,  // GPT3 GTADTRA
    ADC_TRIG_SYNC_GTADTR3BN              = 71,  // GPT3 GTADTRB
    ADC_TRIG_SYNC_GTADTR0AN_OR_GTADTR0BN = 72,  // GPT0 GTADTRA or GPT0 GTADTRB
    ADC_TRIG_SYNC_GTADTR1AN_OR_GTADTR1BN = 73,  // GPT1 GTADTRA or GPT1 GTADTRB
    ADC_TRIG_SYNC_GTADTR2AN_OR_GTADTR2BN = 74,  // GPT2 GTADTRA or GPT2 GTADTRB
    ADC_TRIG_SYNC_GTADTR3AN_OR_GTADTR3BN = 75,  // GPT3 GTADTRA or GPT3 GTADTRB
    ADC_TRIG_SYNC_GTADTR4AN              = 76,  // GPT4 GTADTRA
    ADC_TRIG_SYNC_GTADTR4BN              = 77,  // GPT4 GTADTRB
    ADC_TRIG_SYNC_GTADTR5AN              = 78,  // GPT5 GTADTRA
    ADC_TRIG_SYNC_GTADTR5BN              = 79,  // GPT5 GTADTRB
    ADC_TRIG_SYNC_GTADTR6AN              = 80,  // GPT6 GTADTRA
    ADC_TRIG_SYNC_GTADTR6BN              = 81,  // GPT6 GTADTRB
    ADC_TRIG_SYNC_GTADTR7AN              = 82,  // GPT7 GTADTRA
    ADC_TRIG_SYNC_GTADTR7BN              = 83,  // GPT7 GTADTRB
    ADC_TRIG_SYNC_GTADTR4AN_OR_GTADTR4BN = 84,  // GPT4 GTADTRA or GPT4 GTADTRB
    ADC_TRIG_SYNC_GTADTR5AN_OR_GTADTR5BN = 85,  // GPT5 GTADTRA or GPT5 GTADTRB
    ADC_TRIG_SYNC_GTADTR6AN_OR_GTADTR6BN = 86,  // GPT6 GTADTRA or GPT6 GTADTRB
    ADC_TRIG_SYNC_GTADTR7AN_OR_GTADTR7BN = 87,  // GPT7 GTADTRA or GPT7 GTADTRB
    ...
    ADC_TRIG_SOFTWARE                    = 128,  /* software trigger; not for Group modes
                                                   nor double trigger modes
...
typedef struct st_adc_cfg
{
    ...
    adc_set_t       setting;          // set after read
...
typedef enum e_adc_sst_reg          // sample state registers
{
    ...
    ADC_SST_CH1,
    ADC_SST_CH2,
    ADC_SST_CH3,                    // end unit0 and unit1 for RAM capacity other than 48K
    ADC_SST_CH4,
    ADC_SST_CH5,
    ADC_SST_CH6,
    ADC_SST_CH7,                    // end unit0 for 48K RAM capacity
    ADC_SST_CH8,
    ADC_SST_CH9,
    ADC_SST_CH10,
    ADC_SST_CH11,
