...
#ifndef S12AD_PRV_RX660_IF_H
#define S12AD_PRV_RX660_IF_H

/******************************************************************************
Macro definitions
*******************************************************************************/
#define ADC_0_REG_ARRAY_MAX   (24)
...
#define ADC_MASK_TEMP   (1<<24)     /* temperature sensor */
#define ADC_MASK_VOLT   (1<<25)     /* internal reference voltage sensor */
...
#define     ADC_COMP_WINB_CH21  (21)
#define     ADC_COMP_WINB_CH22  (22)
#define     ADC_COMP_WINB_CH23  (23)
...
typedef struct st_adc_ch_cfg            // bit 0 is ch0; bit 15 is ch15
{
    ...
    uint32_t               conversion_order[ADC_0_REG_ARRAY_MAX];
} adc_ch_cfg_t;
