...
#define RM_RRH46410_OPEN                                 (((uint32_t)'R' << 24U) | ((uint32_t)'H' << 16U) | ((uint32_t)'4' << 8U) | \
                                                          ((uint32_t)'6' << 0U)) // Open state, R"RH46"410
...
#if (RM_RRH46410_OPERATION_MODE_IAQ_2ND_GEN == RM_RRH46410_CFG_DEVICE0_OPERATION_MODE) || \
    (RM_RRH46410_OPERATION_MODE_IAQ_2ND_GEN_ULP == RM_RRH46410_CFG_DEVICE0_OPERATION_MODE)                                   // IAQ 2nd gen and IAQ 2nd gen ULP
...
#elif (RM_RRH46410_OPERATION_MODE_PBAQ == RM_RRH46410_CFG_DEVICE0_OPERATION_MODE)                                            // PBAQ
...
#if (RM_RRH46410_OPERATION_MODE_IAQ_2ND_GEN == RM_RRH46410_CFG_DEVICE0_OPERATION_MODE)       // IAQ 2nd gen
 #define RM_RRH46410_WARMUP_COUNTS                       (100)
#elif (RM_RRH46410_OPERATION_MODE_IAQ_2ND_GEN_ULP == RM_RRH46410_CFG_DEVICE0_OPERATION_MODE) // IAQ 2nd gen ULP
                                         ...
                                         rm_zmod4xxx_pbaq_data_t * const p_rrh46410_data)
{
    ...
    /* Calculate PBAQ data */
#if (RM_RRH46410_OPERATION_MODE_PBAQ == RM_RRH46410_CFG_DEVICE0_OPERATION_MODE) // PBAQ
...
static fsp_err_t rm_rrh46410_start_measurement (rm_rrh46410_instance_ctrl_t * const p_ctrl)
{
    ...
    p_ctrl->write_buf[1] = RM_RRH46410_CFG_DEVICE0_OPERATION_MODE;
