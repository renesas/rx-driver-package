...
void r_rsip_pa4u(const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    (void)oLoop;
    (void)OFS_ADR;
    r_rsip_func100(0x613e90cfU, 0x25dd1ecdU, 0x8d18a6deU, 0x415a28afU);
    RSIP.REG_0014H.WORD = 0x00020061U;
    RSIP.REG_00D4H.WORD = 0x40000000U;
    RSIP.REG_00D0H.WORD = 0xf7008d06U;
    ...
    r_rsip_func206();
    r_rsip_func101(0x894b9f76U, 0xfde2d20bU, 0x892b9194U, 0x2bee64e9U);
}
