...
rsip_err_t r_rsip_p32i(const uint32_t InData_KeyIndex[], const uint32_t InData_IV[])
{
    ...
    RSIP.REG_002CH.WORD = change_endian_long(0x00000032U);
    RSIP.REG_0024H.WORD = 0x00000000U;
    r_rsip_func101(0x1c5ee531U, 0xfbd6eea6U, 0x69d3aac8U, 0xe7cad022U);
    r_rsip_func043();
    ...
    RSIP.REG_002CH.WORD = change_endian_long(0x00000032U);
    RSIP.REG_0024H.WORD = 0x00000000U;
    r_rsip_func101(0xd69f10ddU, 0xbc64b922U, 0xc3cc938eU, 0xf83f3e1aU);
    r_rsip_func044();
    ...
    {
        r_rsip_func100(0x3d40268eU, 0x33fdef93U, 0x195c6e28U, 0xfc906978U);
        ...
        RSIP.REG_0040H.WORD = 0x00001800U;
        r_rsip_func100(0xab7953e1U, 0x7131e81eU, 0x034df2c4U, 0x95d90265U);
        ...
        RSIP.REG_002CH.WORD = change_endian_long(0x00000000U);
        r_rsip_func101(0xe9b14526U, 0x40f98543U, 0x029b3981U, 0x0778276cU);
        return RSIP_SUCCESS;
    }
}
