...
void r_rsip_p98u(const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    (void)oLoop;
    (void)OFS_ADR;
    r_rsip_func100(0x71eb5154U, 0x6a1e2cfaU, 0x49cb466fU, 0x943bde42U);
    RSIP.REG_0014H.WORD = 0x00020061U;
    RSIP.REG_00D0H.WORD = 0xf7000d06U;
    ...
    r_rsip_func206();
    r_rsip_func101(0xde99a8dcU, 0x0b7e538eU, 0xc9f34fbbU, 0xb12a1191U);
}
