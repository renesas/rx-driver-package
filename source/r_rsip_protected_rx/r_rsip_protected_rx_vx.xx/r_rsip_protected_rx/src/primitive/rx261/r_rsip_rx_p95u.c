...
void r_rsip_p95u(const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    (void)oLoop;
    (void)OFS_ADR;
    r_rsip_func100(0x135e10c8U, 0xf1d191a1U, 0x4b00eb7cU, 0x078c1b65U);
    RSIP.REG_0014H.WORD = 0x00020061U;
    RSIP.REG_00D0H.WORD = 0xe7000d06U;
    ...
    r_rsip_func206();
    r_rsip_func101(0x1558d5a5U, 0x11010f14U, 0x83711cfeU, 0xf8fd9dc0U);
}
