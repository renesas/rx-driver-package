...
rsip_err_t r_rsip_p29i(const uint32_t InData_KeyIndex[], const uint32_t InData_IV[])
{
    ...
    RSIP.REG_002CH.WORD = change_endian_long(0x00000029U);
    RSIP.REG_0024H.WORD = 0x00000000U;
    r_rsip_func101(0xe895589dU, 0x79a73495U, 0x9e18452aU, 0xc10b3288U);
    r_rsip_func043();
    ...
    RSIP.REG_002CH.WORD = change_endian_long(0x00000029U);
    RSIP.REG_0024H.WORD = 0x00000000U;
    r_rsip_func101(0x7772062fU, 0xf0d39a55U, 0x5f6b9a63U, 0xca9f9024U);
    r_rsip_func044();
    ...
    RSIP.REG_0040H.WORD = 0x00001800U;
    r_rsip_func100(0xe58c75b8U, 0x27e01b67U, 0x3ea5f32eU, 0xadb0305eU);
    RSIP.REG_0040H.WORD = 0x00400000U;
    RSIP.REG_0024H.WORD = 0x00000000U;
    if (1U == (RSIP.REG_0040H.BIT.B22))
    {
        r_rsip_func102(0x1016a6b6U, 0x9a6998b9U, 0xb53ba574U, 0x80e58841U);
    ...
    {
        r_rsip_func100(0xdad8ad97U, 0xe41f652fU, 0x67313aeeU, 0xc14dd4cbU);
        ...
        RSIP.REG_0040H.WORD = 0x00001800U;
        r_rsip_func100(0x7741dec5U, 0xe5979437U, 0x236d6532U, 0x802211d0U);
        ...
        RSIP.REG_002CH.WORD = change_endian_long(0x00000000U);
        r_rsip_func101(0x31f639a0U, 0xf494fcb0U, 0x6473026dU, 0x58ba28fbU);
        return RSIP_SUCCESS;
    }
}
