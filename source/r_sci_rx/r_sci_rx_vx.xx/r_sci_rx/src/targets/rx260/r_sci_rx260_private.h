...
***********************************************************************************************************************/
/***********************************************************************************************************************
* File Name    : r_sci_rx260_private.h
* Description  : Functions for using SCI on the RX260 device.
************************************************************************************************************************
...
#define SCI_CFG_CH_INCLUDED_MASK ((SCI_CFG_CH0_INCLUDED << 1) \
...
{
    volatile  struct st_sci1 R_BSP_EVENACCESS_SFR  *regs;  /* base ptr to ch registers */
