...
/* Defines for SCI_IIC support */
    ...
    #include "r_sci_iic_rx140_private.h"
...
void r_sci_iic_init_io_register (sci_iic_info_t * p_sci_iic_info)
{
    ...
    if ((SCI_IIC_NUM_CH1 == p_sci_iic_info->ch_no)||(SCI_IIC_NUM_CH5 == p_sci_iic_info->ch_no))
    {
