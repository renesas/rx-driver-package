...
/* Defines for SCI_IIC support */
    ...
    #include "r_sci_iic_rx23t_private.h"
...
sci_iic_return_t r_sci_iic_check_arguments (sci_iic_info_t * p_sci_iic_info, sci_iic_api_mode_t called_api)
{
    ...
    if ((((((((((((SCI_IIC_NUM_CH0 == p_sci_iic_info->ch_no) || (SCI_IIC_NUM_CH2 == p_sci_iic_info->ch_no))
            ...
            || (SCI_IIC_NUM_CH8 == p_sci_iic_info->ch_no)) || (SCI_IIC_NUM_CH9 == p_sci_iic_info->ch_no))
            || (SCI_IIC_NUM_CH10 == p_sci_iic_info->ch_no)) || (SCI_IIC_NUM_CH11 == p_sci_iic_info->ch_no))
            || (SCI_IIC_NUM_CH12 == p_sci_iic_info->ch_no)) || (SCI_IIC_NUM_CH12 < p_sci_iic_info->ch_no))
    {
