 ...
 **********************************************************************************************************************/
/***********************************************************************************************************************
 * File Name    : r_sci_iic_rx23e_b_private.h
...
#ifndef SCI_IIC_RX23E_B_PRIVATE_H
    #define SCI_IIC_RX23E_B_PRIVATE_H
...
/* Sets to use multi-function pin controller. */
        ...
        #define SCI_IIC_MPC_SSCL_INIT       ((uint8_t)(0x00))   /* Pin function select to Hi-Z */
            ...
            #if ((SCI_IIC_CFG_CH5_SSDA_GP == PORT3_GR) && (SCI_IIC_CFG_CH5_SSDA_PIN == 1))
            ...
            #endif
            #if ((SCI_IIC_CFG_CH5_SSCL_GP == PORT3_GR) && (SCI_IIC_CFG_CH5_SSCL_PIN == 0))
            ...
            #define SCI_IIC_MPC_SSDA9_ENABLE    ((uint8_t)(0x0B))   /* Pin function select to SCI9 SSDA pin:b01011 */
...
#endif /* SCI_IIC_RX23E_B_PRIVATE_H */
