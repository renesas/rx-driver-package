...
{
    BSP_LOCK_SCI0,
    (sci_regs_t)&SCI0, /* Cast to sci_regs_t */
...
{
    BSP_LOCK_SCI8,
    (sci_regs_t)&SCI8, /* Cast to sci_regs_t */
...
sci_iic_ch_ctrl_t g_sci_iic_ch8_ctrl =
{
    ...
    #endif /* endif SCI_IIC_CFG_CH8_INCLUDED */
...
{
    BSP_LOCK_SCI9,
    (sci_regs_t)&SCI9, /* Cast to sci_regs_t */
...
sci_iic_ch_ctrl_t g_sci_iic_ch9_ctrl =
{
    ...
    #endif /* endif SCI_IIC_CFG_CH9_INCLUDED */
...
sci_iic_return_t r_sci_iic_check_arguments(sci_iic_info_t * p_sci_iic_info, sci_iic_api_mode_t called_api)
{
    ...
    if (((((((SCI_IIC_NUM_CH2 == p_sci_iic_info->ch_no) || (SCI_IIC_NUM_CH3 == p_sci_iic_info->ch_no))  
           || (SCI_IIC_NUM_CH4 == p_sci_iic_info->ch_no)) || (SCI_IIC_NUM_CH7 == p_sci_iic_info->ch_no))  
           || (SCI_IIC_NUM_CH10 == p_sci_iic_info->ch_no)) || (SCI_IIC_NUM_CH11 == p_sci_iic_info->ch_no)) 
...
void r_sci_iic_int_disable(sci_iic_info_t * p_sci_iic_info)
{
    ...
    (*p_rom->pipr) = 0; /* Clears interrupt source priority register. */
