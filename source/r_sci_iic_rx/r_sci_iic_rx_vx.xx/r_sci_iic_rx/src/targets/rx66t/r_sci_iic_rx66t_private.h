 ...
 **********************************************************************************************************************/
/***********************************************************************************************************************
 * File Name    : r_sci_iic_rx66t_private.h
 * Description  : Functions for using SCI_IIC on RX devices. 
 **********************************************************************************************************************/
/***********************************************************************************************************************
 * History : DD.MM.YYYY Version  Description
 *         : 22.10.2017 2.30     First Release
 *         : 20.05.2019 2.41     Added support for GNUC and ICCRX.
 *                               Fixed coding style.
 **********************************************************************************************************************/
/* Guards against multiple inclusion */
#ifndef SCI_IIC_RX66T_PRIVATE_H
    #define SCI_IIC_RX66T_PRIVATE_H
/***********************************************************************************************************************
...
/* Sets to use multi-function pin controller. */
        ...
        #define SCI_IIC_MPC_SSCL_INIT       ((uint8_t)(0x00))   /* Pin function select to Hi-Z */
            ...
            #if ((SCI_IIC_CFG_CH1_SSDA_GP == PORT3_GR) && (SCI_IIC_CFG_CH1_SSDA_PIN == 5))
            ...
            #endif
            #if ((SCI_IIC_CFG_CH1_SSCL_GP == PORT3_GR) && (SCI_IIC_CFG_CH1_SSCL_PIN == 4))
           ...
           #if ((SCI_IIC_CFG_CH5_SSDA_GP == PORTK_GR) && (SCI_IIC_CFG_CH5_SSDA_PIN == 1))
                #define SCI_IIC_MPC_SSDA5_ENABLE ((uint8_t)(0x0B))   /* Pin function select to SCI5 SSDA pin:b01011 */
            #else
                #define SCI_IIC_MPC_SSDA5_ENABLE ((uint8_t)(0x0A))   /* Pin function select to SCI5 SSDA pin:b01010 */
            #endif
            #if ((SCI_IIC_CFG_CH5_SSCL_GP == PORTK_GR) && (SCI_IIC_CFG_CH5_SSCL_PIN == 0))
                #define SCI_IIC_MPC_SSCL5_ENABLE ((uint8_t)(0x0B))   /* Pin function select to SCI5 SSCL pin:b01011 */
            #else
            ...
            #if (((SCI_IIC_CFG_CH8_SSDA_GP == PORTA_GR) && (SCI_IIC_CFG_CH8_SSDA_PIN == 4)) ||  \
                 ((SCI_IIC_CFG_CH8_SSDA_GP == PORTD_GR) && (SCI_IIC_CFG_CH8_SSDA_PIN == 0)) )
                #define SCI_IIC_MPC_SSDA8_ENABLE ((uint8_t)(0x0B))   /* Pin function select to SCI8 SSDA pin:b01011 */
            #else
                #define SCI_IIC_MPC_SSDA8_ENABLE ((uint8_t)(0x0A))   /* Pin function select to SCI8 SSDA pin:b01010 */
            #endif
            #if (((SCI_IIC_CFG_CH8_SSCL_GP == PORTA_GR) && (SCI_IIC_CFG_CH8_SSCL_PIN == 5)) ||  \
                 ((SCI_IIC_CFG_CH8_SSCL_GP == PORTD_GR) && (SCI_IIC_CFG_CH8_SSCL_PIN == 1)) )
                #define SCI_IIC_MPC_SSCL8_ENABLE ((uint8_t)(0x0B))   /* Pin function select to SCI8 SSCL pin:b01011 */
            #else
            ...
            #if ((SCI_IIC_CFG_CH9_SSCL_GP == PORTA_GR) && (SCI_IIC_CFG_CH9_SSCL_PIN == 2))
                #define SCI_IIC_MPC_SSCL9_ENABLE ((uint8_t)(0x0B))   /* Pin function select to SCI9 SSCL pin:b01011 */
            #else
            ...
            #define SCI_IIC_MPC_SSDA11_ENABLE ((uint8_t)(0x0B))  /* Pin function select to SCI11 SSDA pin:b001011 */
            #define SCI_IIC_MPC_SSCL11_ENABLE ((uint8_t)(0x0B))  /* Pin function select to SCI11 SSCL pin:b001011 */
        #endif /* #ifdef SCI_IIC_CFG_CH11_INCLUDED */

        #if SCI_IIC_CFG_CH12_INCLUDED
            #define SCI_IIC_MPC_SSDA12_ENABLE   ((uint8_t)(0x0C))   /* Pin function select to SCI12 SSDA pin:b001100 */
            #define SCI_IIC_MPC_SSCL12_ENABLE   ((uint8_t)(0x0C))   /* Pin function select to SCI12 SSCL pin:b001100 */
