...
/* Defines for SCI_IIC support */
    ...
    #include "r_sci_iic_rx24u_private.h"
...
const sci_iic_ch_rom_t g_sci_iic_ch11_rom =
{
    ...
    &ICU.IR[IR_SCI11_TEI11].BYTE, BIT0_MASK,
    &ICU.IER[IER_SCI11_TXI11].BYTE, BIT4_MASK,
    &ICU.IER[IER_SCI11_TEI11].BYTE, BIT5_MASK,
...
static void sci_iic_set_frequency (sci_iic_info_t * p_sci_iic_info)
{
    ...
    if (SCI_IIC_NUM_CH11 == p_sci_iic_info->ch_no)
    {
        brr_n_tmp = brr_n;
 ...
 * Return Value : None
 **********************************************************************************************************************/
R_BSP_PRAGMA_STATIC_INTERRUPT(sci_iic_int_sci_iic11_tei_isr, VECT_SCI11_TEI11)
R_BSP_ATTRIB_STATIC_INTERRUPT void sci_iic_int_sci_iic11_tei_isr (void)
{
