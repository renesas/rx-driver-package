 ...
 **********************************************************************************************************************/
/***********************************************************************************************************************
 * File Name    : r_sci_iic_rx24u_private.h
...
#ifndef SCI_IIC_RX24U_PRIVATE_H
    #define SCI_IIC_RX24U_PRIVATE_H
...
/*============================================================================*/
            ...
            #error "ERROR - SCI_IIC_CFG_CH12_INCLUDED - This channel is not supported by the current MCU."
        #endif
...
/* Sets to use multi-function pin controller. */
        ...
        #define SCI_IIC_MPC_SSCL_INIT       ((uint8_t)(0x00))   /* Pin function select to Hi-Z */
            ...
            #define SCI_IIC_MPC_SSDA11_ENABLE   ((uint8_t)(0x0B))   /* Pin function select to SCI11 SSDA pin:b01011 */
            #define SCI_IIC_MPC_SSCL11_ENABLE   ((uint8_t)(0x0B))   /* Pin function select to SCI11 SSCL pin:b01011 */
...
typedef volatile struct st_sci R_BSP_EVENACCESS_SFR * sci_regs_t;
