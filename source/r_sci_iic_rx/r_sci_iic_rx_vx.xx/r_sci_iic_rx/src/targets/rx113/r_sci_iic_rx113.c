 ...
 *         : 27.02.2015 1.60     To unify the processing for all target products,
 *                               the processing to calculate PCLKB for the 
 *                               sci_iic_set_frequency function is omitted
 *                               by using the macros defined in the BSP module.
...
/* Defines for SCI_IIC support */
    ...
    #include "r_sci_iic_rx113_private.h"
...
const sci_iic_ch_rom_t g_sci_iic_ch0_rom =
{
    ...
    &ICU.IR[IR_SCI0_TEI0].BYTE, BIT0_MASK,
    &ICU.IER[IER_SCI0_TXI0].BYTE, BIT0_MASK,
    &ICU.IER[IER_SCI0_TEI0].BYTE, BIT1_MASK,
...
const sci_iic_ch_rom_t g_sci_iic_ch2_rom =
{
    ...
    &ICU.IR[IR_SCI2_TEI2].BYTE, BIT0_MASK,
    &ICU.IER[IER_SCI2_TXI2].BYTE, BIT4_MASK,
    &ICU.IER[IER_SCI2_TEI2].BYTE, BIT5_MASK,
...
const sci_iic_ch_rom_t g_sci_iic_ch8_rom =
{
    ...
    &ICU.IR[IR_SCI8_TEI8].BYTE, BIT0_MASK,
    &ICU.IER[IER_SCI8_TXI8].BYTE, BIT0_MASK,
    &ICU.IER[IER_SCI8_TEI8].BYTE, BIT1_MASK,
...
const sci_iic_ch_rom_t g_sci_iic_ch9_rom =
{
    ...
    &ICU.IR[IR_SCI9_TEI9].BYTE, BIT0_MASK,
    &ICU.IER[IER_SCI9_TXI9].BYTE, BIT4_MASK,
    &ICU.IER[IER_SCI9_TEI9].BYTE, BIT5_MASK,
...
sci_iic_return_t r_sci_iic_check_arguments (sci_iic_info_t * p_sci_iic_info, sci_iic_api_mode_t called_api)
{
    ...
    if ((((((SCI_IIC_NUM_CH3 == p_sci_iic_info->ch_no) || (SCI_IIC_NUM_CH4 == p_sci_iic_info->ch_no))
            || (SCI_IIC_NUM_CH7 == p_sci_iic_info->ch_no)) || (SCI_IIC_NUM_CH10 == p_sci_iic_info->ch_no))
 ...
 * Return Value : None
 **********************************************************************************************************************/
R_BSP_PRAGMA_STATIC_INTERRUPT(sci_iic_int_sci_iic0_tei_isr, VECT_SCI0_TEI0)
R_BSP_ATTRIB_STATIC_INTERRUPT void sci_iic_int_sci_iic0_tei_isr (void)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
R_BSP_PRAGMA_STATIC_INTERRUPT(sci_iic_int_sci_iic2_tei_isr, VECT_SCI2_TEI2)
R_BSP_ATTRIB_STATIC_INTERRUPT void sci_iic_int_sci_iic2_tei_isr (void)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
R_BSP_PRAGMA_STATIC_INTERRUPT(sci_iic_int_sci_iic8_tei_isr, VECT_SCI8_TEI8)
R_BSP_ATTRIB_STATIC_INTERRUPT void sci_iic_int_sci_iic8_tei_isr (void)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
R_BSP_PRAGMA_STATIC_INTERRUPT(sci_iic_int_sci_iic9_tei_isr, VECT_SCI9_TEI9)
R_BSP_ATTRIB_STATIC_INTERRUPT void sci_iic_int_sci_iic9_tei_isr (void)
{
