 ...
 **********************************************************************************************************************/
/***********************************************************************************************************************
 * File Name    : r_sci_iic_rx113_private.h
...
#ifndef SCI_IIC_RX113_PRIVATE_H
    #define SCI_IIC_RX113_PRIVATE_H
/***********************************************************************************************************************
...
/* Sets to use multi-function pin controller. */
        ...
        #define SCI_IIC_MPC_SSCL_INIT       ((uint8_t)(0x00))   /* Pin function select to Hi-Z */
            ...
            #if ((SCI_IIC_CFG_CH6_SSDA_GP == PORT2_GR) && (SCI_IIC_CFG_CH6_SSDA_PIN == 6))
                #define SCI_IIC_MPC_SSDA6_ENABLE ((uint8_t)(0x0C))   /* Pin function select to SCI6 SSDA pin:b01100 */
            #else
