...
/* Defines for SCI_IIC support */
    ...
    #include "r_sci_iic_rx26t_private.h"
...
const sci_iic_ch_rom_t g_sci_iic_ch1_rom =
{
    ...
    (volatile uint32_t R_BSP_EVENACCESS_SFR *)&ICU.GRPBL0.LONG, BIT2_MASK, /* Cast to R_BSP_EVENACCESS_SFR */
    &ICU.IER[IER_SCI1_TXI1].BYTE, BIT5_MASK,
    (volatile uint32_t R_BSP_EVENACCESS_SFR *)&ICU.GENBL0.LONG, BIT2_MASK, /* Cast to R_BSP_EVENACCESS_SFR */
...
const sci_iic_ch_rom_t g_sci_iic_ch5_rom =
{
    ...
    (volatile uint32_t R_BSP_EVENACCESS_SFR *)&ICU.GRPBL0.LONG, BIT10_MASK, /* Cast to R_BSP_EVENACCESS_SFR */
    &ICU.IER[IER_SCI5_TXI5].BYTE, BIT5_MASK,
    (volatile uint32_t R_BSP_EVENACCESS_SFR *)&ICU.GENBL0.LONG, BIT10_MASK, /* Cast to R_BSP_EVENACCESS_SFR */
...
const sci_iic_ch_rom_t g_sci_iic_ch6_rom =
{
    ...
    (volatile uint32_t R_BSP_EVENACCESS_SFR *)&ICU.GRPBL0.LONG, BIT12_MASK, /* Cast to R_BSP_EVENACCESS_SFR */
    &ICU.IER[IER_SCI6_TXI6].BYTE, BIT7_MASK,
    (volatile uint32_t R_BSP_EVENACCESS_SFR *)&ICU.GENBL0.LONG, BIT12_MASK, /* Cast to R_BSP_EVENACCESS_SFR */
...
const sci_iic_ch_rom_t g_sci_iic_ch12_rom =
{
    ...
    (volatile uint32_t R_BSP_EVENACCESS_SFR *)&ICU.GRPBL0.LONG, BIT16_MASK, /* Cast to R_BSP_EVENACCESS_SFR */
    &ICU.IER[IER_SCI12_TXI12].BYTE, BIT5_MASK,
    (volatile uint32_t R_BSP_EVENACCESS_SFR *)&ICU.GENBL0.LONG, BIT16_MASK, /* Cast to R_BSP_EVENACCESS_SFR */
