 ...
 **********************************************************************************************************************/
/***********************************************************************************************************************
 * File Name    : r_sci_iic_rx13t_private.h
...
#ifndef SCI_IIC_RX13T_PRIVATE_H
    #define SCI_IIC_RX13T_PRIVATE_H
/***********************************************************************************************************************
...
/* Sets to use multi-function pin controller. */
        ...
        #define SCI_IIC_MPC_SSCL_INIT       ((uint8_t)(0x00))   /* Pin function select to Hi-Z */
            ...
            #if ((SCI_IIC_CFG_CH1_SSDA_GP == PORTB_GR) && (SCI_IIC_CFG_CH1_SSDA_PIN == 6))
            ...
            #endif
            #if ((SCI_IIC_CFG_CH1_SSCL_GP == PORTB_GR) && (SCI_IIC_CFG_CH1_SSCL_PIN == 7))
