...
***********************************************************************************************************************/
#ifndef LVD_RX110_HEADER_FILE
#define LVD_RX110_HEADER_FILE
...
#define LVD_GROUP_SETUP                         (LVD_GROUP_SETUP_LVDAa_1)
...
#if (LVD_CFG_VOLTAGE_LEVEL_CHANNEL_1 == 310)
...
#elif (LVD_CFG_VOLTAGE_LEVEL_CHANNEL_1 == 206)
...
#if (LVD_CFG_VOLTAGE_LEVEL_CHANNEL_2 == 290)
    #define LVD_VOLTAGE_LEVEL_VALUE_CH2         (0)
#elif (LVD_CFG_VOLTAGE_LEVEL_CHANNEL_2 == 260)
    #define LVD_VOLTAGE_LEVEL_VALUE_CH2         (1)
#elif (LVD_CFG_VOLTAGE_LEVEL_CHANNEL_2 == 200)
    #define LVD_VOLTAGE_LEVEL_VALUE_CH2         (2)
#elif (LVD_CFG_VOLTAGE_LEVEL_CHANNEL_2 == 180)
