...
#include "rm_rai_data_shipper_api.h"
 ...
 #include "rm_rai_data_shipper_rl_config.h"
#else
...
/* Max number of data channels (including CRC) to be sent */
 ...
 #define __PACKED_STRUCT  struct			// RA __packed struct  RX ???
...
typedef __PACKED_STRUCT st_rai_data_shipper_header_buffer_type
{
    ...
    uint8_t  data_type[(RM_RAI_DATA_SHIPPER_CFG_MAX_CHANNELS) / 2]; // Channel data type. 4-bit for each channel.
...
typedef __PACKED_STRUCT st_rai_data_shipper_tx_info_type
{
    ...
    rai_data_shipper_data_buffer_t   data[RM_RAI_DATA_SHIPPER_CFG_MAX_CHANNELS]; // Array of data buffers to be sent
...
/*******************************************************************************************************************//**
 * @} (end defgroup RM_RAI_DATA_SHIPPER)
 **********************************************************************************************************************/
