 ...
 ***********************************************************************************************************************/
/*********************************************************************************************************************
 * File Name    : r_lpc_rx23e-b.c
 * Description  : Implementation of the LPC module for the RX23E-B
 **********************************************************************************************************************/
/*********************************************************************************************************************
...
#include "r_lpc_rx23e-b_private.h"
    ...
    switch (e_mode)
    {
        ...
        case LPC_OP_MIDDLE_SPEED:
            ...
            if ((((((iclk_freq > LPC_MAX_ICK_MID_SPEED_FREQ_HZ)
                ...
                || (pclkc_freq > LPC_MAX_PCKC_MID_SPEED_FREQ_HZ))
        ...
        case LPC_OP_LOW_SPEED:
            ...
            if ((((((iclk_freq > LPC_MAX_ICK_LOW_SPEED_FREQ_HZ)
                ...
                || (pclkc_freq > LPC_MAX_PCKC_LOW_SPEED_FREQ_HZ))
...
static uint32_t lpc_clockhzget (lpc_system_clocks_t clock)
{
    ...
    if (LPC_CLOCK_ACTIVE == SYSTEM.HOCOCR.BIT.HCSTP)
    {
        ...
        clock_frequency[LPC_CKSEL_HOCO] = hoco_frequency[SYSTEM.HOCOCR.BIT.HCSTP];
    }
            ...
            switch (rstckcr_rstcksel)
            {
                ...
                case LPC_MAIN_OSC:
                    ...
                    if (((((((BSP_CFG_XTAL_HZ >> SYSTEM.SCKCR.BIT.ICK) > LPC_MAX_ICK_MID_SPEED_FREQ_HZ)
                        ...
                        || ((BSP_CFG_XTAL_HZ >> SYSTEM.SCKCR.BIT.PCKC) > LPC_MAX_PCKC_MID_SPEED_FREQ_HZ))
...
#endif /* LPC_CFG_PARAM_CHECKING_ENABLE == 1 */
