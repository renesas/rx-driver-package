 ...
 ***********************************************************************************************************************/
/*********************************************************************************************************************
 * File Name    : r_lpc_rx110.c
 * Description  : Implementation of the LPC module for the RX110
 **********************************************************************************************************************/
/*********************************************************************************************************************
...
static uint32_t hoco_frequency[4];     // Possible HOCO frequencies; Indices 1&2&3 are not used for the RX110.
...
lpc_err_t lpc_operating_mode_set (lpc_operating_mode_t e_mode)
{
    ...
    /* Check FENTRY0(b0) */
    if (0x0000 != (FLASH.FENTRYR.WORD & 0x0001))
    {
...
static lpc_err_t lpc_freq_range_check (lpc_operating_mode_t e_mode)
{
    ...
    /* Clock source frequencies. The HOCO values need to be calculated by
