 ...
 ***********************************************************************************************************************/
/*********************************************************************************************************************
 * File Name    : r_lpc_rx230.c
 * Description  : Implementation of the LPC module for the RX230
 **********************************************************************************************************************/
/*********************************************************************************************************************
...
static uint32_t hoco_frequency[4];     // Possible HOCO frequencies; Indices 1&2 are not used for the RX230.
    ...
    switch (e_mode)
    {
        ...
        case LPC_OP_MIDDLE_SPEED:
            ...
            if ((((((iclk_freq > LPC_MAX_ICK_MID_SPEED_FREQ_HZ)
                 || (bclk_freq > LPC_MAX_BCK_MID_SPEED_FREQ_HZ))
        ...
        case LPC_OP_LOW_SPEED:
            ...
            if ((((((iclk_freq > LPC_MAX_ICK_LOW_SPEED_FREQ_HZ)
                 || (bclk_freq > LPC_MAX_BCK_LOW_SPEED_FREQ_HZ))
            ...
            switch(rstckcr_rstcksel)
            {
                ...
                case LPC_MAIN_OSC:
                    ...
                    if (((((((BSP_CFG_XTAL_HZ >> SYSTEM.SCKCR.BIT.ICK) > LPC_MAX_ICK_MID_SPEED_FREQ_HZ)
                         || ((BSP_CFG_XTAL_HZ >> SYSTEM.SCKCR.BIT.BCK) > LPC_MAX_BCK_MID_SPEED_FREQ_HZ))
