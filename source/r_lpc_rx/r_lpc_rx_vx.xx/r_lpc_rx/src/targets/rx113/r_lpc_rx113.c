 ...
 ***********************************************************************************************************************/
/*********************************************************************************************************************
 * File Name    : r_lpc_rx113.c
 * Description  : Implementation of the LPC module for the RX113
 **********************************************************************************************************************/
/*********************************************************************************************************************
...
static uint32_t hoco_frequency[4];     // Possible HOCO frequencies; Indices 1&2&3 are not used for the RX113.
    ...
    switch (e_mode)
    {
        ...
        case LPC_OP_LOW_SPEED:
            ...
            if (((((LPC_CLOCK_ACTIVE == SYSTEM.LOCOCR.BYTE)  /* Check if LOCO is running */
                ...
                || (LPC_CLOCK_ACTIVE == SYSTEM.UPLLCR2.BYTE)) /* Check if USB PLL is running */
            {
                return LPC_ERR_CLOCK_EXCEEDED;
            }
        break;
