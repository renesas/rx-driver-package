 ...
 ***********************************************************************************************************************/
/***********************************************************************************************************************
 * File Name    : r_lpc_rx111_private.h
 * Description  : Definitions used by the r_lpc_rx111.c module.
 ***********************************************************************************************************************/
/***********************************************************************************************************************
...
#ifndef R_LPC_RX111_PRIVATE_H
    #define R_LPC_RX111_PRIVATE_H
...
/* Internally used definitions */
    ...
    #define LPC_CLOCK_ACTIVE      (0x00)
        ...
        #define LPC_MAX_HIGH_SPEED_FREQ_HZ (32000000)
        #define LPC_MAX_MIDDLE_SPEED_FREQ_HZ (12000000)
        #define LPC_MAX_LOW_SPEED_FREQ_HZ (32768)
    #elif (BSP_CFG_MCU_VCC_MV > 2399)
        #define LPC_MAX_HIGH_SPEED_FREQ_HZ (16000000)
        #define LPC_MAX_MIDDLE_SPEED_FREQ_HZ (12000000)
        #define LPC_MAX_LOW_SPEED_FREQ_HZ (32768)
    #elif (BSP_CFG_MCU_VCC_MV > 1799)
        #define LPC_MAX_HIGH_SPEED_FREQ_HZ (8000000)
        #define LPC_MAX_MIDDLE_SPEED_FREQ_HZ (8000000)
        #define LPC_MAX_LOW_SPEED_FREQ_HZ (32768)
    #endif
