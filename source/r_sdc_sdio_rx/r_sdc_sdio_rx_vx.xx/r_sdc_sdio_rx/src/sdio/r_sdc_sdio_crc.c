...
**********************************************************************************************************************/
static sdc_sd_exchg_short_t g_sdc_sd_crc16[8];    /* 16 Bytes = 2 Bytes * 8 */
static const uint16_t g_sdc_sd_crc_ccitt[] =        /* CRC16(CRC-CCITT) calculation table */
{
...
/**********************************************************************************************************************
* Outline      : CRC-CCITT Clearing Operation
* Function Name: r_sdc_sdio_clear_crc16
* Description  : Clears CRC-CCITT data.
...
{
    g_sdc_sd_crc16[card_no].us = 0;
} /* End of function r_sdc_sdio_clear_crc16() */

/**********************************************************************************************************************
* Outline      : CRC-CCITT Setting Operation
* Function Name: r_sdc_sdio_set_crc16
* Description  : Sets CRC-CCITT data.
* Arguments    : uint32_t       card_no         ; SDHI Channel No
...
void r_sdc_sdio_set_crc16(uint32_t card_no, uint8_t * p_buff)
{
    ...
    uc_tmp = g_sdc_sd_crc16[card_no].uc[1];
    g_sdc_sd_crc16[card_no].us = g_sdc_sd_crc_ccitt[g_sdc_sd_crc16[card_no].uc[0] ^ (*p_buff)];
    g_sdc_sd_crc16[card_no].uc[0] = (g_sdc_sd_crc16[card_no].uc[0] ^ uc_tmp);
#else
    uc_tmp = g_sdc_sd_crc16[card_no].uc[0];
    g_sdc_sd_crc16[card_no].us = g_sdc_sd_crc_ccitt[g_sdc_sd_crc16[card_no].uc[1] ^ (*p_buff)];
    g_sdc_sd_crc16[card_no].uc[1] = (g_sdc_sd_crc16[card_no].uc[1] ^ uc_tmp);
#endif /* SDC_SD_BIG_ENDIAN */
} /* End of function r_sdc_sdio_set_crc16() */

/**********************************************************************************************************************
* Outline      : CRC-CCITT Getting Operation
* Function Name: r_sdc_sdio_get_crc16
* Description  : Gets CRC-CCITT data.
* Arguments    : uint32_t       card_no         ; SDHI Channel No
* Return Value : Calculated CRC-CCITT data
*----------------------------------------------------------------------------------------------------------------------
* Notes        : None
**********************************************************************************************************************/
uint16_t r_sdc_sdio_get_crc16(uint32_t card_no)
{
    return g_sdc_sd_crc16[card_no].us;
} /* End of function r_sdc_sdio_get_crc16() */
