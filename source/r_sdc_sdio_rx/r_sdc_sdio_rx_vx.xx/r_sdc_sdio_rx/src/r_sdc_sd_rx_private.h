...
#define SDC_SD_SPEC_10              (0)         /* SD Specifications Part 1 Physical Layer Specification Ver.1.01 */
#define SDC_SD_SPEC_11              (1)         /* SD Specifications Part 1 Physical Layer Specification Ver.1.10 */
#define SDC_SD_SPEC_20              (2)         /* SD Specifications Part 1 Physical Layer Specification Ver.2.00 */
...
#define SDC_SD_SW_FUNC_STATUS_HIGH_SPEED_SUP    (0x00020000ul)
#define SDC_SD_SW_FUNC_STATUS_FUNC_GP1_MASK     (0x0f000000ul)
#define SDC_SD_SW_FUNC_STATUS_FUNC_GP1          (0x01000000ul)
...
/* ==== CMD6 Arg ==== */
#define SDC_SD_CMD6_ARG_HIGH_SPEED_MODE0        (0x00ffff00ul)
#define SDC_SD_CMD6_ARG_HIGH_SPEED_MODE0_GP1    (0x00ffff01ul)
#define SDC_SD_CMD6_ARG_HIGH_SPEED_MODE1_GP1    (0x80ffff01ul)
#define SDC_SD_CMD6_ARG_MODE                    (0x80000000ul)
...
sdc_sd_status_t r_sdc_sdmem_set_speed(uint32_t card_no);
sdc_sd_status_t r_sdc_sdmem_card_switch_func(uint32_t card_no, uint32_t arg);
sdc_sd_status_t r_sdc_sdmem_card_switch_func_access_mode0(uint32_t card_no, uint32_t arg);
sdc_sd_status_t r_sdc_sdmem_card_switch_func_access_mode1(uint32_t card_no, uint32_t arg);
