...
* Description  : Functions for using RSCI on the RX261 device.
***********************************************************************************************************************
...
#include "r_rsci_rx261_private.h"
...
rsci_err_t rsci_mcu_param_check(uint8_t const chan)
{
    ...
    return RSCI_SUCCESS;
} /* End of function rsci_mcu_param_check() */
...
*                interrupts in both the ICU and RSCI peripheral. These include 
                            ...
                            void            *p_args)
{
    ...
    if (((NULL == p_args) || (FIT_NO_PTR == p_args))
            && ((RSCI_CMD_TX_Q_BYTES_FREE == cmd) || (RSCI_CMD_RX_Q_BYTES_AVAIL_TO_READ == cmd)
                    || (RSCI_CMD_COMPARE_RECEIVED_DATA == cmd)))
    {
...
#endif  /* (RSCI_CFG_RX_DATA_SAMPLING_TIMING_INCLUDED || RSCI_CFG_TX_SIGNAL_TRANSITION_TIMING_INCLUDED) */
        default:
        {
            err = RSCI_ERR_INVALID_ARG;
            break;
                        ...
                        void            *p_args)
{
    ...
    switch (cmd)
    {
        ...
        case (RSCI_CMD_CHANGE_SPI_MODE):
        {
            ...
            if ((RSCI_SPI_MODE_0 != spi_mode) && (RSCI_SPI_MODE_1 != spi_mode) && (RSCI_SPI_MODE_2 != spi_mode)
                    && (RSCI_SPI_MODE_3 != spi_mode))
            {
                return RSCI_ERR_INVALID_ARG;
            }
#endif
...
/*******************************************************************************
 * Function Name: rsci0_txi_isr
 * Description  : TXI interrupt routines for RSCI0 channel
 ******************************************************************************/
...
/*******************************************************************************
 * Function Name: rsci8_txi_isr
 * Description  : TXI interrupt routines for RSCI8 channel
 ******************************************************************************/
...
/*******************************************************************************
 * Function Name: rsci9_txi_isr
 * Description  : TXI interrupt routines for RSCI9 channel
 ******************************************************************************/
...
#if RSCI_CFG_CH0_INCLUDED
/*****************************************************************************
* Function Name: rsci0_tei_isr
* Description  : TEI interrupt routines for RSCI0 channel.
******************************************************************************/
...
#if RSCI_CFG_CH8_INCLUDED
/*****************************************************************************
* Function Name: rsci8_tei_isr
* Description  : TEI interrupt routines for RSCI8 channel.
******************************************************************************/
...
#if RSCI_CFG_CH9_INCLUDED
/*****************************************************************************
* Function Name: rsci9_tei_isr
* Description  : TEI interrupt routines for RSCI9 channel.
******************************************************************************/
...
#if RSCI_CFG_CH0_INCLUDED
/*******************************************************************************
 * Function Name: rsci0_rxi_isr
 * Description  : RXI interrupt routines for RSCI0 channel
 ******************************************************************************/
...
#if RSCI_CFG_CH8_INCLUDED
/*******************************************************************************
 * Function Name: rsci8_rxi_isr
 * Description  : RXI interrupt routines for RSCI8 channel
 ******************************************************************************/
...
#if RSCI_CFG_CH9_INCLUDED
/*******************************************************************************
 * Function Name: rsci9_rxi_isr
 * Description  : RXI interrupt routines for RSCI9 channel
 ******************************************************************************/
...
#if RSCI_CFG_CH0_INCLUDED
/*****************************************************************************
* Function name: rsci0_eri_isr
* Description  : ERI interrupt routines for RSCI0 channel.
******************************************************************************/
...
#if RSCI_CFG_CH8_INCLUDED
/*****************************************************************************
* Function name: rsci8_eri_isr
* Description  : ERI interrupt routines for RSCI8 channel.
******************************************************************************/
...
#if RSCI_CFG_CH9_INCLUDED
/*****************************************************************************
* Function name: rsci9_eri_isr
* Description  : ERI interrupt routines for RSCI9 channel.
******************************************************************************/
