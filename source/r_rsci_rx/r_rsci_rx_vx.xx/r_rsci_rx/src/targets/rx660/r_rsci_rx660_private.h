...
***********************************************************************************************************************/
/***********************************************************************************************************************
* File Name    : r_rsci_rx660_private.h
...
{
    volatile  struct st_rsci R_BSP_EVENACCESS_SFR  *regs;  /* base ptr to ch registers */
...
extern const rsci_ch_rom_t      g_rsci_ch10_rom;
extern rsci_ch_ctrl_t           g_rsci_ch10_ctrl;
#endif
...
******************************************************************************/
#if RSCI_CFG_TEI_INCLUDED
extern void rsci10_tei_isr(void *cb_args);
extern void rsci11_tei_isr(void *cb_args);
#endif

extern void rsci10_eri_isr(void *cb_args);
