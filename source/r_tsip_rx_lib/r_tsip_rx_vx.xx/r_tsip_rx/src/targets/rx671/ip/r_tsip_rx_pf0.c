...
e_tsip_err_t R_TSIP_EcdsaSigunatureGenerateSub(uint32_t *InData_Cmd, uint32_t *InData_KeyIndex, uint32_t *InData_MsgDgst, uint32_t *OutData_Signature)
{
    ...
    RX671_func100(change_endian_long(0xa66b3587u), change_endian_long(0x27937888u), change_endian_long(0xb389ae4cu), change_endian_long(0x45d834d5u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX671_func102(change_endian_long(0x643e8f49u), change_endian_long(0xda0caf35u), change_endian_long(0x18caf9dau), change_endian_long(0xed3b5f56u));
    ...
    {
        RX671_func100(change_endian_long(0xfe61861du), change_endian_long(0xddbec47fu), change_endian_long(0x270812a2u), change_endian_long(0x75275e55u));
        ...
        OFS_ADR = S_RAM[0];
        RX671_func100(change_endian_long(0xecd34dcfu), change_endian_long(0xf584620cu), change_endian_long(0x09b750fau), change_endian_long(0x45825a3au));
        ...
        RX671_func103();
        RX671_func100(change_endian_long(0xcac04eb8u), change_endian_long(0x876e33bcu), change_endian_long(0x636d5582u), change_endian_long(0xf469978bu));
        ...
        RX671_func100(change_endian_long(0xa9490844u), change_endian_long(0x58144660u), change_endian_long(0xcb916e92u), change_endian_long(0xabc6f46eu));
        ...
        RX671_func100(change_endian_long(0xfd2d9513u), change_endian_long(0x69e0a5d4u), change_endian_long(0xb9778bc6u), change_endian_long(0x059b36d4u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX671_func102(change_endian_long(0x1ee305d6u), change_endian_long(0xf16c80cbu), change_endian_long(0x3f7581f0u), change_endian_long(0x8fecabc8u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX671_func100(change_endian_long(0x3133eca7u), change_endian_long(0xfa600699u), change_endian_long(0xc6dabb52u), change_endian_long(0x4b50ca26u));
            ...
            TSIP.REG_1CH.WORD = 0x00001f00u;
            TSIP.REG_1CH.WORD = 0x00210000u;
            RX671_func100(change_endian_long(0x44af2eecu), change_endian_long(0xce054533u), change_endian_long(0x449e991bu), change_endian_long(0xdbde467du));
            TSIP.REG_1CH.WORD = 0x00400000u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
            if (1u == (TSIP.REG_1CH.BIT.B22))
            {
                RX671_func102(change_endian_long(0x73d518e1u), change_endian_long(0x3c6de445u), change_endian_long(0xbd5302b0u), change_endian_long(0x474f75a1u));
                TSIP.REG_1BCH.WORD = 0x00000040u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_18H.BIT.B12)
                {
            ...
            {
                RX671_func100(change_endian_long(0xeff9c051u), change_endian_long(0xe0d4b4ecu), change_endian_long(0x2a11b5b2u), change_endian_long(0x0afe0070u));
                TSIP.REG_34H.WORD = 0x00000800u;
                TSIP.REG_24H.WORD = 0x800068d0u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_24H.BIT.B21)
                ...
                TSIP.REG_1CH.WORD = 0x00001800u;
                RX671_func100(change_endian_long(0x8ab37a5eu), change_endian_long(0xf0006355u), change_endian_long(0xbf24efd2u), change_endian_long(0xe7644d59u));
                TSIP.REG_1CH.WORD = 0x00400000u;
                TSIP.REG_1D0H.WORD = 0x00000000u;
                if (1u == (TSIP.REG_1CH.BIT.B22))
                {
                    RX671_func102(change_endian_long(0x66daf136u), change_endian_long(0x9995b967u), change_endian_long(0xcd5cf22au), change_endian_long(0x362ecf04u));
                    TSIP.REG_1BCH.WORD = 0x00000040u;
                    /* WAIT_LOOP */
                    while (0u != TSIP.REG_18H.BIT.B12)
                    {
                ...
                else
                {
                    ...
                    TSIP.REG_1CH.WORD = 0x00001f00u;
                    TSIP.REG_1CH.WORD = 0x00210000u;
                    RX671_func100(change_endian_long(0x524da85eu), change_endian_long(0x9aa3e3c7u), change_endian_long(0xf133b3c0u), change_endian_long(0x5720fe52u));
                    TSIP.REG_1CH.WORD = 0x00400000u;
                    TSIP.REG_1D0H.WORD = 0x00000000u;
                    if (1u == (TSIP.REG_1CH.BIT.B22))
                    {
                        RX671_func102(change_endian_long(0x9cf7f8c8u), change_endian_long(0xcc9225e9u), change_endian_long(0xee2cceb7u), change_endian_long(0xe989d4f6u));
                        TSIP.REG_1BCH.WORD = 0x00000040u;
                        /* WAIT_LOOP */
                        while (0u != TSIP.REG_18H.BIT.B12)
                        {
                    ...
                    {
                        RX671_func100(change_endian_long(0xf57b58a8u), change_endian_long(0x686c38ebu), change_endian_long(0x7c766fdbu), change_endian_long(0x1f4c2318u));
                        ...
                        RX671_func100(change_endian_long(0x0edf4b04u), change_endian_long(0xc7ced7cfu), change_endian_long(0x5eebb8b5u), change_endian_long(0x7280f01fu));
                        ...
                        RX671_func102(change_endian_long(0xb11a1da8u), change_endian_long(0xde8d45ecu), change_endian_long(0xecf0ca5bu), change_endian_long(0x56827abcu));
                        TSIP.REG_1BCH.WORD = 0x00000040u;
                        /* WAIT_LOOP */
                        while (0u != TSIP.REG_18H.BIT.B12)
                        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_pf0.prc
 *********************************************************************************************************************/
