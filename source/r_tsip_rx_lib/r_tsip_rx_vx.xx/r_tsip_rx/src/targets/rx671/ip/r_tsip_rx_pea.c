...
e_tsip_err_t R_TSIP_GenerateTls13P256EccKeyIndexSub(uint32_t *InData_Cmd, uint32_t *InData_Handle, uint32_t *OutData_KeyIndex, uint32_t *OutData_PubKey)
{
    ...
    else
    {
        ...
        RX671_func100(change_endian_long(0x1674f497u), change_endian_long(0x20f3f22au), change_endian_long(0x16bd3feeu), change_endian_long(0x4a23ce56u));
        ...
        RX671_func100(change_endian_long(0xf9d39adbu), change_endian_long(0x1a1ca27au), change_endian_long(0x259f7e6eu), change_endian_long(0xe5981521u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            ...
            RX671_func101(change_endian_long(0x232c6b28u), change_endian_long(0x05857c0cu), change_endian_long(0x222b4b2bu), change_endian_long(0x048d6633u));
        }
        RX671_func100(change_endian_long(0x69efa689u), change_endian_long(0x6d53fba9u), change_endian_long(0x8af81113u), change_endian_long(0x2ac260e1u));
        RX671_func072();
        ...
        RX671_func100(change_endian_long(0xf6018278u), change_endian_long(0x70edeefeu), change_endian_long(0x6e6c672eu), change_endian_long(0xe761171du));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        RX671_func100(change_endian_long(0x81e34521u), change_endian_long(0xa418a67cu), change_endian_long(0x8ecf2c41u), change_endian_long(0xb344e936u));
        ...
        RX671_func100(change_endian_long(0x479077e7u), change_endian_long(0x5b1a5fc1u), change_endian_long(0x9706f1e3u), change_endian_long(0x24904fd5u));
        ...
        RX671_func100(change_endian_long(0x532c5e89u), change_endian_long(0xd227aa89u), change_endian_long(0xc94c121fu), change_endian_long(0x22055f03u));
        ...
        RX671_func102(change_endian_long(0xcc855c69u), change_endian_long(0xd89c5293u), change_endian_long(0x6a51dedeu), change_endian_long(0x9e63f207u));
        TSIP.REG_1B8H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_pea.prc
 *********************************************************************************************************************/
