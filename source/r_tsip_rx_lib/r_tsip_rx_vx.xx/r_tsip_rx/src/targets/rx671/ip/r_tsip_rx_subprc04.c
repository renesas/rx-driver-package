...
*******************************************************************************************************************/ /**
* @details       RX671 PRF1 function of TLS - subprocedure 04
* @note          None
*/
void R_TSIP_TlsGenerateSubSub(void)
{
    ...
    RX671_func100(change_endian_long(0xb0d3051au), change_endian_long(0x188b7000u), change_endian_long(0xbf09197cu), change_endian_long(0x3f0e9997u));
    ...
    for (iLoop = 0; iLoop < S_RAM[0]; iLoop = iLoop + 1)
    {
        ...
        RX671_func101(change_endian_long(0x94c6b02au), change_endian_long(0xff127e22u), change_endian_long(0xc9b03755u), change_endian_long(0x3b62ffb7u));
    }
    TSIP.REG_ECH.WORD = 0x00007c0du;
    TSIP.REG_1CH.WORD = 0x00602000u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX671_func100(change_endian_long(0xc30c18b6u), change_endian_long(0x9ef798cfu), change_endian_long(0x60e99e58u), change_endian_long(0xb6a662fbu));
    TSIP.REG_ECH.WORD = 0x00007c01u;
    TSIP.REG_1CH.WORD = 0x00600000u;
}
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_subprc04.prc
 *********************************************************************************************************************/
