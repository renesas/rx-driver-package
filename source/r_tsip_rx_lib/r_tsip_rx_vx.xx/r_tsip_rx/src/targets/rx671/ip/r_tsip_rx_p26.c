...
*******************************************************************************************************************/ /**
* @details       RX671 Program integrity check
...
e_tsip_err_t R_TSIP_VerifyFirmwareMacSub(uint32_t *InData_Program, uint32_t MAX_CNT)
{
    ...
    RX671_func100(change_endian_long(0x5fe7bad3u), change_endian_long(0xf31a5bbbu), change_endian_long(0xfac95f34u), change_endian_long(0x2f829aedu));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        TSIP.REG_13CH.WORD = 0x000002ffu;
        RX671_func102(change_endian_long(0x9ef17026u), change_endian_long(0x9e100e7au), change_endian_long(0xa137f001u), change_endian_long(0x4edddbb8u));
    ...
    {
        RX671_func102(change_endian_long(0xac9a66e9u), change_endian_long(0x7a1e8babu), change_endian_long(0xaa3a63f2u), change_endian_long(0x1e9445acu));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX671/RX671_p26.prc
 *********************************************************************************************************************/
TSIP_SEC_DEFAULT
