...
*******************************************************************************************************************/ /**
* @details       RX65NHU AES-256 Decryption and MAC verification with CCM Mode Update
...
void R_TSIP_Aes256CcmDecryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX65NHU_func100(change_endian_long(0x7685cf91u), change_endian_long(0x92b22ff7u), change_endian_long(0x9e1da17au), change_endian_long(0x53e25a3cu));
    ...
    RX65NHU_func101(change_endian_long(0xcbaecb9du), change_endian_long(0x14775503u), change_endian_long(0x43acf6c5u), change_endian_long(0x69e749b2u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_pa4u_r1.prc
 *********************************************************************************************************************/
