...
*******************************************************************************************************************/ /**
* @details       RX65NHU TSIP RSA2048 PSS Signature Verification subprocedure 03
* @note          None
*/
void R_TSIP_TlsRootCertificateVerificationSubSub(void)
{
    ...
    RX65NHU_func100(change_endian_long(0xd7a24dfcu), change_endian_long(0x60f5c356u), change_endian_long(0xad3602d9u), change_endian_long(0x98e4601eu));
    ...
    TSIP.REG_ECH.WORD = 0x00002862u;
    RX65NHU_func100(change_endian_long(0x54586142u), change_endian_long(0x35776e47u), change_endian_long(0x06515081u), change_endian_long(0x3be57211u));
    TSIP.REG_E0H.WORD = 0x81010020u;
    ...
    for (iLoop = 0; iLoop < S_RAM[0]; iLoop = iLoop + 1)
    {
        ...
        RX65NHU_func101(change_endian_long(0xf5f752f5u), change_endian_long(0xfd187332u), change_endian_long(0x4383d5cfu), change_endian_long(0x3ce3ada9u));
    }
    ...
    TSIP.REG_ECH.WORD = 0x0000b460u;
    TSIP.REG_ECH.WORD = 0x80000000u;
    RX65NHU_func100(change_endian_long(0x58455fb4u), change_endian_long(0xe8f1c30bu), change_endian_long(0xa679c483u), change_endian_long(0xd23ccdcau));
    TSIP.REG_E0H.WORD = 0x81010020u;
    TSIP.REG_04H.WORD = 0x00000707u;
    /* WAIT_LOOP */
    while (1u != TSIP.REG_04H.BIT.B30)
    ...
    for (iLoop = 0; iLoop < S_RAM[0]; iLoop = iLoop + 1)
    {
        ...
        RX65NHU_func101(change_endian_long(0x456fa4a9u), change_endian_long(0x46297cafu), change_endian_long(0xa7d8fa7eu), change_endian_long(0x18f0586bu));
    }
    TSIP.REG_ECH.WORD = 0x00007c01u;
    TSIP.REG_1CH.WORD = 0x00602000u;
    TSIP.REG_F8H.WORD = 0x00000040u;
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_subprc03.prc
 *********************************************************************************************************************/
