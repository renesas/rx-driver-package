...
*******************************************************************************************************************/ /**
* @details       RX65NHU Install 1024bit RSA Public Key
...
e_tsip_err_t R_TSIP_GenerateRsa1024PublicKeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX65NHU_func100(change_endian_long(0xcfeb2a57u), change_endian_long(0x6ca7e6c8u), change_endian_long(0xfed7207cu), change_endian_long(0xf2d84febu));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0xe1736ea7u), change_endian_long(0x76a21fa0u), change_endian_long(0x1d2e3766u), change_endian_long(0x0b3f5184u));
    ...
    {
        RX65NHU_func100(change_endian_long(0x5ce9b0bcu), change_endian_long(0x4ffb2e6cu), change_endian_long(0x01f5c5dfu), change_endian_long(0xfd6862d7u));
        ...
        RX65NHU_func100(change_endian_long(0x73628d6eu), change_endian_long(0x4baddd4du), change_endian_long(0xc1485036u), change_endian_long(0xc6435c2au));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func100(change_endian_long(0x1d6e53a3u), change_endian_long(0x2787d430u), change_endian_long(0x76e1e8cbu), change_endian_long(0x6f2b6104u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func100(change_endian_long(0x70cb4505u), change_endian_long(0x257eb3e8u), change_endian_long(0x7ae49d2bu), change_endian_long(0xf429353fu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func103();
        RX65NHU_func100(change_endian_long(0x5a9c1ae9u), change_endian_long(0x6ef0a33fu), change_endian_long(0x40ad3de8u), change_endian_long(0x108ecb52u));
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX65NHU_func100(change_endian_long(0x34746940u), change_endian_long(0xddffe9a3u), change_endian_long(0x00e18600u), change_endian_long(0x6e411c43u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func100(change_endian_long(0xdc518f67u), change_endian_long(0x817c71e8u), change_endian_long(0x3d5963feu), change_endian_long(0xba4a08d9u));
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX65NHU_func100(change_endian_long(0xa40de676u), change_endian_long(0x9d41edd3u), change_endian_long(0x0f341f35u), change_endian_long(0xffc234c4u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX65NHU_func100(change_endian_long(0x744189afu), change_endian_long(0xee4b290bu), change_endian_long(0x3ced7db1u), change_endian_long(0x66221b85u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX65NHU_func102(change_endian_long(0x541f6105u), change_endian_long(0x4b29c1cdu), change_endian_long(0x15f1b3c4u), change_endian_long(0x4ca106d3u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX65NHU_func100(change_endian_long(0xa5b2cd98u), change_endian_long(0x0b6fc3c4u), change_endian_long(0x2fd183bbu), change_endian_long(0xbabd2a8cu));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX65NHU_func102(change_endian_long(0xc50cd5a8u), change_endian_long(0x5de73092u), change_endian_long(0x786b0eb9u), change_endian_long(0x1f89170cu));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p59.prc
 *********************************************************************************************************************/
