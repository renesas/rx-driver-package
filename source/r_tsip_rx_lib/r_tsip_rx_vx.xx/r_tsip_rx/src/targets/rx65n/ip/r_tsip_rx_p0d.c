...
*******************************************************************************************************************/ /**
* @details       RX65NHU Update 2048bit RSA Public Key
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateRsa2048PublicKeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX65NHU_func100(change_endian_long(0x4c70239cu), change_endian_long(0xf4ffad79u), change_endian_long(0xe8db3bccu), change_endian_long(0x6ae911c5u));
    ...
    RX65NHU_func100(change_endian_long(0x6b6df8cbu), change_endian_long(0x68c665a5u), change_endian_long(0x345fa7cau), change_endian_long(0xa8492081u));
    ...
    RX65NHU_func100(change_endian_long(0x789633acu), change_endian_long(0xb8f7cdfcu), change_endian_long(0xb22d21edu), change_endian_long(0x1869a179u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX65NHU_func103();
    RX65NHU_func100(change_endian_long(0x048bd9b5u), change_endian_long(0x965962dbu), change_endian_long(0x4a90662bu), change_endian_long(0xdb10fe04u));
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0xdb353550u), change_endian_long(0x718ea3b7u), change_endian_long(0xd90c8e1eu), change_endian_long(0xee779fceu));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX65NHU_func100(change_endian_long(0xdcd8ac20u), change_endian_long(0xdc6e0a0bu), change_endian_long(0x2e88f7b5u), change_endian_long(0xb5b880d8u));
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0x01972b81u), change_endian_long(0xeb794c7du), change_endian_long(0x0a58f3adu), change_endian_long(0x0f47ef5du));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0x4c2665a9u), change_endian_long(0x954ab700u), change_endian_long(0x3c349bb0u), change_endian_long(0xc44478a3u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0x8668782du), change_endian_long(0x9f899857u), change_endian_long(0x193eb9b3u), change_endian_long(0xd15ebc9du));
    ...
    {
        RX65NHU_func100(change_endian_long(0x01d26696u), change_endian_long(0x2d063ff2u), change_endian_long(0xd73a9fa5u), change_endian_long(0x93dad031u));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX65NHU_func102(change_endian_long(0x8955f243u), change_endian_long(0x240a7848u), change_endian_long(0x261e6a8eu), change_endian_long(0xbc461dc5u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p0d.prc
 *********************************************************************************************************************/
