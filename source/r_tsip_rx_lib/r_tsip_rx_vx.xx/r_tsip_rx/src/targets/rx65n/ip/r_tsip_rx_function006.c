...
/***********************************************************************************************************************
* Function Name: RX65NHU_func006
*******************************************************************************************************************/ /**
* @details       RX65NHU func006
* @note          None
*/
void RX65NHU_func006(void)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX65NHU_func100(change_endian_long(0x9413cf4du), change_endian_long(0x52c6725fu), change_endian_long(0x282f6115u), change_endian_long(0x25d1367fu));
    ...
    RX65NHU_func100(change_endian_long(0x7d132faau), change_endian_long(0x1e2d640au), change_endian_long(0x3ee291e2u), change_endian_long(0xec3b06e0u));
    TSIP.REG_24H.WORD = 0x00001dc0u;
    /* WAIT_LOOP */
    while (0u != TSIP.REG_24H.BIT.B21)
    {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_func006.prc
 *********************************************************************************************************************/
