...
*******************************************************************************************************************/ /**
* @details       RX65NHU SHA-1 Message Digest Generation
...
e_tsip_err_t R_TSIP_Sha1GenerateMessageDigestSub(uint32_t *InData_SHA1InitVal, uint32_t *InData_PaddedMsg, uint32_t MAX_CNT, uint32_t *OutData_MsgDigest)
{
    ...
    RX65NHU_func100(change_endian_long(0xda0ea306u), change_endian_long(0xa361cd8au), change_endian_long(0xf17efcf2u), change_endian_long(0x6066380au));
    ...
    RX65NHU_func102(change_endian_long(0xe668c937u), change_endian_long(0x9bfa63bau), change_endian_long(0x178720d3u), change_endian_long(0x28337459u));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p71.prc
 *********************************************************************************************************************/
