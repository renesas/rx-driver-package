...
*******************************************************************************************************************/ /**
* @details       RX65NHU Install P-384 ECC Private Key
...
e_tsip_err_t R_TSIP_GenerateEccP384PrivateKeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX65NHU_func100(change_endian_long(0x2e0e47cfu), change_endian_long(0x253d9ebcu), change_endian_long(0xd53b8571u), change_endian_long(0x5b7a5424u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0x9b672ea7u), change_endian_long(0x580b0340u), change_endian_long(0xf2b1b14bu), change_endian_long(0xabec553au));
    ...
    {
        RX65NHU_func100(change_endian_long(0x3950158fu), change_endian_long(0xd310ebc7u), change_endian_long(0x7cd806eeu), change_endian_long(0x908336bcu));
        ...
        RX65NHU_func100(change_endian_long(0x157f4189u), change_endian_long(0x3344e83fu), change_endian_long(0x0e010b25u), change_endian_long(0xfde154a1u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func100(change_endian_long(0xd81dee2du), change_endian_long(0xfab05e92u), change_endian_long(0x7e900bcbu), change_endian_long(0x20c0c1ebu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func100(change_endian_long(0xe7fd809eu), change_endian_long(0x6b3f33bcu), change_endian_long(0x4fbc63c0u), change_endian_long(0x11f12c95u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func103();
        RX65NHU_func100(change_endian_long(0xccce4e2bu), change_endian_long(0xf0a09667u), change_endian_long(0x116783b5u), change_endian_long(0x1a27e1efu));
        ...
        RX65NHU_func100(change_endian_long(0xa0cebdbcu), change_endian_long(0x7f257ce4u), change_endian_long(0x9e709b46u), change_endian_long(0x0a7acae9u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX65NHU_func100(change_endian_long(0xe5f85251u), change_endian_long(0xde5072b4u), change_endian_long(0x1a871269u), change_endian_long(0x30ce48cau));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX65NHU_func102(change_endian_long(0xa158be08u), change_endian_long(0x117804e1u), change_endian_long(0xdedf2076u), change_endian_long(0x3bfed2d3u));
            TSIP.REG_1B4H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX65NHU_func100(change_endian_long(0xfe7f7c8eu), change_endian_long(0x2f86b64du), change_endian_long(0xa7e34702u), change_endian_long(0xef9f2be0u));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX65NHU_func102(change_endian_long(0x9a8b40aeu), change_endian_long(0xfb1b11cau), change_endian_long(0xf32b4b9eu), change_endian_long(0x9de18b71u));
            TSIP.REG_1B4H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_pf8.prc
 *********************************************************************************************************************/
