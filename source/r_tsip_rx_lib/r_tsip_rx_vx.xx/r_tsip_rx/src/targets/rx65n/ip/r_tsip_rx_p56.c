...
e_tsip_err_t R_TSIP_Rsa2048ModularExponentEncryptSub(uint32_t *InData_KeyIndex, uint32_t *InData_Text, uint32_t *OutData_Text)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0x2754ce05u), change_endian_long(0x6b1c2ea8u), change_endian_long(0xc97cfbd1u), change_endian_long(0x2fa9ba81u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0x0b6f5bdeu), change_endian_long(0xaba89c80u), change_endian_long(0x8769472du), change_endian_long(0xcf0f4b03u));
    ...
    {
        RX65NHU_func100(change_endian_long(0x16f43cc8u), change_endian_long(0x7b78cb01u), change_endian_long(0x4c1ab3afu), change_endian_long(0xc2ea8736u));
        ...
        RX65NHU_func100(change_endian_long(0x720eb3fcu), change_endian_long(0xd7a239acu), change_endian_long(0x8d088483u), change_endian_long(0x031e9e94u));
        ...
        RX65NHU_func102(change_endian_long(0xf9907b34u), change_endian_long(0xea56a25cu), change_endian_long(0x1eafbfd0u), change_endian_long(0xdc9497ddu));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p56.prc
 *********************************************************************************************************************/
