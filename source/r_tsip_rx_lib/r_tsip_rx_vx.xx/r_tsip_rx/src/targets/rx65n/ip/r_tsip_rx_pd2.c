...
*******************************************************************************************************************/ /**
* @details       RX65NHU TLS PreMasterSecret Generation with ECC P-256 Key for Server
...
e_tsip_err_t R_TSIP_TlsSVGeneratePreMasterSecretWithEccP256KeySub(uint32_t *InData_PubKey, uint32_t *InData_KeyIndex, uint32_t *OutData_PreMasterSecretIndex)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001f00u;
    TSIP.REG_1CH.WORD = 0x00210000u;
    RX65NHU_func100(change_endian_long(0x40c5421bu), change_endian_long(0x40cbdc58u), change_endian_long(0xc75ea04fu), change_endian_long(0xb943c16au));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0xa99e1ca2u), change_endian_long(0xd60f1b95u), change_endian_long(0x17d5ddc5u), change_endian_long(0x2042b043u));
    ...
    else
    {
        ...
        RX65NHU_func008();
        RX65NHU_func100(change_endian_long(0xcb3e5b20u), change_endian_long(0xe389f898u), change_endian_long(0x6b518c51u), change_endian_long(0xa6da5137u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX65NHU_func102(change_endian_long(0xba635617u), change_endian_long(0x62f22a49u), change_endian_long(0xb54d91f8u), change_endian_long(0x401969c3u));
            TSIP.REG_1B8H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        else
        {
            ...
            RX65NHU_func100(change_endian_long(0x8044c671u), change_endian_long(0x81984ff7u), change_endian_long(0x55c82f1eu), change_endian_long(0x18fa81c5u));
            TSIP.REG_1CH.WORD = 0x00400000u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
            if (1u == (TSIP.REG_1CH.BIT.B22))
            {
                RX65NHU_func102(change_endian_long(0x450c22d3u), change_endian_long(0x25f482c9u), change_endian_long(0x133d29cau), change_endian_long(0xa377236au));
                TSIP.REG_1B8H.WORD = 0x00000040u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_18H.BIT.B12)
                {
            ...
            else
            {
                ...
                TSIP.REG_1CH.WORD = 0x00001800u;
                RX65NHU_func100(change_endian_long(0xff8311ebu), change_endian_long(0x1ff78a2bu), change_endian_long(0x419408a0u), change_endian_long(0xbe472677u));
                TSIP.REG_1CH.WORD = 0x00400000u;
                TSIP.REG_1D0H.WORD = 0x00000000u;
                if (1u == (TSIP.REG_1CH.BIT.B22))
                {
                    RX65NHU_func102(change_endian_long(0x22bb1c9au), change_endian_long(0xe70551b8u), change_endian_long(0x3158f220u), change_endian_long(0xd2d2f93fu));
                    TSIP.REG_1B8H.WORD = 0x00000040u;
                    /* WAIT_LOOP */
                    while (0u != TSIP.REG_18H.BIT.B12)
                    {
                ...
                {
                    RX65NHU_func100(change_endian_long(0x50031f3fu), change_endian_long(0x5d1ed551u), change_endian_long(0x33814908u), change_endian_long(0xb5ec003du));
                    TSIP.REG_24H.WORD = 0x0000dcd0u;
                    /* WAIT_LOOP */
                    while (0u != TSIP.REG_24H.BIT.B21)
                    {
                    ...
                    TSIP.REG_1CH.WORD = 0x00001f00u;
                    TSIP.REG_1CH.WORD = 0x00210000u;
                    RX65NHU_func100(change_endian_long(0xe06ee1b3u), change_endian_long(0x1778bac9u), change_endian_long(0xd215f05cu), change_endian_long(0xf16198f1u));
                    TSIP.REG_1CH.WORD = 0x00400000u;
                    TSIP.REG_1D0H.WORD = 0x00000000u;
                    if (1u == (TSIP.REG_1CH.BIT.B22))
                    {
                        RX65NHU_func102(change_endian_long(0x802e6643u), change_endian_long(0x75c0e943u), change_endian_long(0xfdcfd749u), change_endian_long(0xd69d435du));
                        TSIP.REG_1B8H.WORD = 0x00000040u;
                        /* WAIT_LOOP */
                        while (0u != TSIP.REG_18H.BIT.B12)
                        {
                    ...
                    {
                        RX65NHU_func100(change_endian_long(0x795f1ee5u), change_endian_long(0x7aca59a1u), change_endian_long(0x1ed015b0u), change_endian_long(0x3827c0a6u));
                        ...
                        TSIP.REG_18H.WORD = 0x00000000u;
                        RX65NHU_func100(change_endian_long(0xea0d36a6u), change_endian_long(0xaf9fc7fau), change_endian_long(0xe38c98f1u), change_endian_long(0x18a51ce0u));
                        TSIP.REG_34H.WORD = 0x00000003u;
                        TSIP.REG_24H.WORD = 0x800048d0u;
                        /* WAIT_LOOP */
                        while (0u != TSIP.REG_24H.BIT.B21)
                        ...
                        RX65NHU_func103();
                        RX65NHU_func100(change_endian_long(0x4a560f7cu), change_endian_long(0x224bbd1cu), change_endian_long(0x2a36d841u), change_endian_long(0x47d9d617u));
                        ...
                        RX65NHU_func100(change_endian_long(0x64bfd23fu), change_endian_long(0x260e01abu), change_endian_long(0x4ef0caaau), change_endian_long(0x43d55b3fu));
                        TSIP.REG_104H.WORD = 0x00000052u;
                        ...
                        RX65NHU_func100(change_endian_long(0x87c1e2a9u), change_endian_long(0x464e7855u), change_endian_long(0xc2daccddu), change_endian_long(0x9386be3au));
                        TSIP.REG_E0H.WORD = 0x81040000u;
                        ...
                        RX65NHU_func102(change_endian_long(0x631ceac2u), change_endian_long(0x3102dbecu), change_endian_long(0x4265eaa3u), change_endian_long(0xf43d5f24u));
                        TSIP.REG_1B8H.WORD = 0x00000040u;
                        /* WAIT_LOOP */
                        while (0u != TSIP.REG_18H.BIT.B12)
                        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_pd2_r1.prc
 *********************************************************************************************************************/
