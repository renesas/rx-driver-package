...
*******************************************************************************************************************/ /**
* @details       RX65NHU Create 256bit AES Key
...
e_tsip_err_t R_TSIP_GenerateAes256RandomKeyIndexSub(uint32_t *OutData_KeyIndex)
{
    ...
    RX65NHU_func100(change_endian_long(0x944be22cu), change_endian_long(0x2ee07c85u), change_endian_long(0x95bf0583u), change_endian_long(0x2a003a60u));
    RX65NHU_func103();
    ...
    RX65NHU_func100(change_endian_long(0x562a137au), change_endian_long(0xa66accceu), change_endian_long(0xfba43028u), change_endian_long(0x2d768c43u));
    ...
    RX65NHU_func100(change_endian_long(0x70703d92u), change_endian_long(0xe31d5c2bu), change_endian_long(0x0a725c4au), change_endian_long(0x5a60536fu));
    RX65NHU_func103();
    TSIP.REG_104H.WORD = 0x00000052u;
    TSIP.REG_C4H.WORD = 0x01000c84u;
    /* WAIT_LOOP */
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0x5f29e891u), change_endian_long(0x05408116u), change_endian_long(0xf7acd4b6u), change_endian_long(0xddc4d84cu));
    RX65NHU_func103();
    TSIP.REG_104H.WORD = 0x00000052u;
    TSIP.REG_C4H.WORD = 0x01000c84u;
    /* WAIT_LOOP */
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0x6f9260c8u), change_endian_long(0x0d15f18bu), change_endian_long(0x3d7ab4c2u), change_endian_long(0x6dacc8f5u));
    ...
    RX65NHU_func102(change_endian_long(0xffccb57eu), change_endian_long(0xb5e2a5fcu), change_endian_long(0x7264554du), change_endian_long(0xa2315faeu));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p08.prc
 *********************************************************************************************************************/
