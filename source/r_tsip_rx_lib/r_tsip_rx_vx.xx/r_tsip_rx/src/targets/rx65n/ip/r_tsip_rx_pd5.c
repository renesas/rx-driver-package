...
*******************************************************************************************************************/ /**
* @details       RX65NHU MD5 Message Digest Generation
...
e_tsip_err_t R_TSIP_Md5GenerateMessageDigestSub(uint32_t *InData_MD5InitVal, uint32_t *InData_PaddedMsg, uint32_t MAX_CNT, uint32_t *OutData_MsgDigest)
{
    ...
    RX65NHU_func100(change_endian_long(0xfee887e7u), change_endian_long(0x5a72a2bcu), change_endian_long(0x0b141026u), change_endian_long(0x16e127ebu));
    ...
    RX65NHU_func102(change_endian_long(0x4fc14256u), change_endian_long(0x3bbecaccu), change_endian_long(0x28d29114u), change_endian_long(0xf690eb98u));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_pd5.prc
 *********************************************************************************************************************/
#endif /* #if TSIP_MD5 == 1 */
