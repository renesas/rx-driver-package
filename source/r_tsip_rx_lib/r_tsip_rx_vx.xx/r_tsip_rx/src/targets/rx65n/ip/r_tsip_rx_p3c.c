...
*******************************************************************************************************************/ /**
* @details       RX65NHU TLS1.3 Client Handshake Traffic Key Generation for Server
* @param[in]     InData_Cmd
...
e_tsip_err_t R_TSIP_Tls13SVGenerateClientHandshakeTrafficKeySub(uint32_t *InData_Cmd, uint32_t *InData_Handshake_SecretKeyIndex, uint32_t *InData_MsgHash, uint32_t *OutData_ClientWriteKeyIndex, uint32_t *OutData_ClientFinishedKeyIndex)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0xde105ad2u), change_endian_long(0x1d44a577u), change_endian_long(0x8d556219u), change_endian_long(0x7f4b8bcbu));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0x347f45f2u), change_endian_long(0x1c253d49u), change_endian_long(0xb65d8380u), change_endian_long(0x0e0c0ad6u));
    ...
    {
        RX65NHU_func100(change_endian_long(0x3ee2057eu), change_endian_long(0x8141c87fu), change_endian_long(0xe788e0b5u), change_endian_long(0x73aae90eu));
        ...
        RX65NHU_func100(change_endian_long(0xbb7f3c7bu), change_endian_long(0x9c5ca316u), change_endian_long(0xed5b35f3u), change_endian_long(0xb9692845u));
        ...
        RX65NHU_func100(change_endian_long(0x3fefbec6u), change_endian_long(0xc21c1219u), change_endian_long(0xbfcb7310u), change_endian_long(0xf9274794u));
        TSIP.REG_C4H.WORD = 0x400c0b0cu;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
        ...
        RX65NHU_func100(change_endian_long(0xaf70f401u), change_endian_long(0x1aeda052u), change_endian_long(0x20e4d422u), change_endian_long(0x3659e5bfu));
        TSIP.REG_E0H.WORD = 0x81040280u;
        TSIP.REG_04H.WORD = 0x00000612u;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_04H.BIT.B30)
        ...
        RX65NHU_func102(change_endian_long(0xbebde28cu), change_endian_long(0x78d88706u), change_endian_long(0x4e9be984u), change_endian_long(0xaf3d5065u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p3c_r1.prc
 *********************************************************************************************************************/
