...
*******************************************************************************************************************/ /**
* @details       RX65NHU Update HMAC-SHA1/SHA224/SHA256 Key
* @param[in]     InData_Cmd
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateShaHmacKeyIndexSub(uint32_t *InData_Cmd, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX65NHU_func100(change_endian_long(0xb6c72a1au), change_endian_long(0x46ae9bbeu), change_endian_long(0x3bfeaa4bu), change_endian_long(0x6e676d54u));
    ...
    RX65NHU_func100(change_endian_long(0xce5c6f36u), change_endian_long(0x969edf95u), change_endian_long(0xeb618c9fu), change_endian_long(0x88091e41u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX65NHU_func100(change_endian_long(0x629c55a8u), change_endian_long(0x72fa5054u), change_endian_long(0x8c935473u), change_endian_long(0x230e95ddu));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX65NHU_func103();
    RX65NHU_func100(change_endian_long(0x0f6eea44u), change_endian_long(0xc2685665u), change_endian_long(0xfe3c2c96u), change_endian_long(0x517a9485u));
    ...
    RX65NHU_func100(change_endian_long(0xac228c50u), change_endian_long(0xce28efceu), change_endian_long(0xd62a1b38u), change_endian_long(0xf877b12du));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0x7cd838d0u), change_endian_long(0xa3d3e6f7u), change_endian_long(0x57bca7ffu), change_endian_long(0x75dd4a63u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0x42605c84u), change_endian_long(0x7869f286u), change_endian_long(0x4f98132au), change_endian_long(0x497d6ecfu));
    ...
    {
        RX65NHU_func100(change_endian_long(0x5a359063u), change_endian_long(0xf1e30e0au), change_endian_long(0x3f82f110u), change_endian_long(0x85a95da1u));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX65NHU_func102(change_endian_long(0x4ebe9e8fu), change_endian_long(0xf911ceedu), change_endian_long(0x51935833u), change_endian_long(0xe92ed526u));
        TSIP.REG_1B4H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p0f_r1.prc
 *********************************************************************************************************************/
