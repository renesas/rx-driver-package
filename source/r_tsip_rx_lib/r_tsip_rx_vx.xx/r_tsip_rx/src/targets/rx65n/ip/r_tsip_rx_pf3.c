...
*******************************************************************************************************************/ /**
* @details       RX65NHU Install P-192/224/256 ECC Private Key
...
e_tsip_err_t R_TSIP_GenerateEccPrivateKeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_Cmd, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX65NHU_func100(change_endian_long(0xb682d0b6u), change_endian_long(0x015cd35au), change_endian_long(0x8413a9d0u), change_endian_long(0x9700e196u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0xc7725b5au), change_endian_long(0x79216e80u), change_endian_long(0x58ff6d5bu), change_endian_long(0x6f2d5572u));
    ...
    {
        RX65NHU_func100(change_endian_long(0x9da109ecu), change_endian_long(0x3e4c58b4u), change_endian_long(0xc66c333eu), change_endian_long(0xc49b2c43u));
        ...
        RX65NHU_func100(change_endian_long(0x54e338c2u), change_endian_long(0x3937c2b8u), change_endian_long(0x88fbbacbu), change_endian_long(0xb56fbe11u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func100(change_endian_long(0x274d4548u), change_endian_long(0xecd0440au), change_endian_long(0x53ff1720u), change_endian_long(0x3c893f05u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func100(change_endian_long(0x97902c1bu), change_endian_long(0x58dc0d50u), change_endian_long(0x7b1cf73du), change_endian_long(0x5ef7c777u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func103();
        RX65NHU_func100(change_endian_long(0x49964cd8u), change_endian_long(0xe5880514u), change_endian_long(0x492ec817u), change_endian_long(0x82a75b61u));
        ...
        RX65NHU_func100(change_endian_long(0xea953bdau), change_endian_long(0x0bbf6920u), change_endian_long(0xb6c5dabbu), change_endian_long(0x1dfefee1u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX65NHU_func100(change_endian_long(0x26a953e4u), change_endian_long(0xa73aa2b9u), change_endian_long(0xdd934605u), change_endian_long(0x8803396bu));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX65NHU_func102(change_endian_long(0xad22c3f7u), change_endian_long(0xb9655455u), change_endian_long(0x14dcc630u), change_endian_long(0x7330a73au));
            TSIP.REG_1B4H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX65NHU_func100(change_endian_long(0x718ade68u), change_endian_long(0xa7e73544u), change_endian_long(0x5fe1e756u), change_endian_long(0x68d1c644u));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX65NHU_func102(change_endian_long(0xca8df1f9u), change_endian_long(0x9616e85du), change_endian_long(0x0cf51456u), change_endian_long(0xd80c8e23u));
            TSIP.REG_1B4H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_pf3_r1.prc
 *********************************************************************************************************************/
