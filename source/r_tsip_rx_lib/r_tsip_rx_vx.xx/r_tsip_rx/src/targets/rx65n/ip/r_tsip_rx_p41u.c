...
*******************************************************************************************************************/ /**
* @details       RX65NHU AES-128 CMAC generation/verification Update
...
void R_TSIP_Aes128CmacUpdateSub(uint32_t *InData_Text, uint32_t MAX_CNT)
{
    ...
    RX65NHU_func101(change_endian_long(0x5389598au), change_endian_long(0x2a8bf00cu), change_endian_long(0xd5c829e7u), change_endian_long(0xfbba65f9u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p41u.prc
 *********************************************************************************************************************/
