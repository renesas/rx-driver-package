...
*******************************************************************************************************************/ /**
* @details       RX65NHU RSA2048 Decryption with Private Key
...
e_tsip_err_t R_TSIP_Rsa2048ModularExponentDecryptSub(uint32_t *InData_KeyIndex, uint32_t *InData_Text, uint32_t *OutData_Text)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0x2a780230u), change_endian_long(0x3c3d9658u), change_endian_long(0x0ddc2a4cu), change_endian_long(0xfaaf4824u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0xf3961a20u), change_endian_long(0x687eff96u), change_endian_long(0x0e0a0a08u), change_endian_long(0xeab85a61u));
    ...
    {
        RX65NHU_func100(change_endian_long(0xada18c31u), change_endian_long(0xc4704079u), change_endian_long(0x67a672f2u), change_endian_long(0x82db3150u));
        ...
        RX65NHU_func100(change_endian_long(0x9b6fda2au), change_endian_long(0x98f8c104u), change_endian_long(0xb2ac5c73u), change_endian_long(0x5e2bbcb9u));
        ...
        RX65NHU_func102(change_endian_long(0x03725f2eu), change_endian_long(0xcb4c79c6u), change_endian_long(0x980eb2d9u), change_endian_long(0x5c8bc3b5u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p57_r1.prc
 *********************************************************************************************************************/
