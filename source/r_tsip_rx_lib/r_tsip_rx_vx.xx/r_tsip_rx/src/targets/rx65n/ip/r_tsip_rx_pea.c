...
*******************************************************************************************************************/ /**
* @details       RX65NHU TLS1.3 P-256 Key Generation
* @param[in]     InData_Cmd
...
e_tsip_err_t R_TSIP_GenerateTls13P256EccKeyIndexSub(uint32_t *InData_Cmd, uint32_t *InData_Handle, uint32_t *OutData_KeyIndex, uint32_t *OutData_PubKey)
{
    ...
    RX65NHU_func100(change_endian_long(0xb61ef649u), change_endian_long(0x9525ed80u), change_endian_long(0x4bd5f4f2u), change_endian_long(0x4503e08du));
    RX65NHU_func103();
    ...
    RX65NHU_func100(change_endian_long(0xb9e5051fu), change_endian_long(0x27e5f4c7u), change_endian_long(0x199a5393u), change_endian_long(0x6dbb9bcbu));
    RX65NHU_func103();
    TSIP.REG_104H.WORD = 0x00000052u;
    TSIP.REG_C4H.WORD = 0x01000c84u;
    /* WAIT_LOOP */
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0xb0de1b4fu), change_endian_long(0x98bcb420u), change_endian_long(0xbe6d55ffu), change_endian_long(0xb6601c0eu));
    RX65NHU_func103();
    TSIP.REG_104H.WORD = 0x00000052u;
    TSIP.REG_C4H.WORD = 0x01000c84u;
    /* WAIT_LOOP */
    ...
    RX65NHU_func100(change_endian_long(0xcdd9c278u), change_endian_long(0x94d5b85eu), change_endian_long(0xd163d835u), change_endian_long(0x1fafccd2u));
    ...
    RX65NHU_func100(change_endian_long(0x0b61aae7u), change_endian_long(0x33c88237u), change_endian_long(0x40a10ca1u), change_endian_long(0x5ef61515u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0xfa27583bu), change_endian_long(0xe7997346u), change_endian_long(0x5d6d28a8u), change_endian_long(0xa2789e01u));
    ...
    {
        RX65NHU_func100(change_endian_long(0xb4ef33b7u), change_endian_long(0x71a9278fu), change_endian_long(0x07e543feu), change_endian_long(0xe2c59580u));
        ...
        RX65NHU_func100(change_endian_long(0xbf8ae2b8u), change_endian_long(0x0087872fu), change_endian_long(0xb267c2bau), change_endian_long(0xfb826783u));
        ...
        RX65NHU_func100(change_endian_long(0xfa4f642cu), change_endian_long(0x559df749u), change_endian_long(0x6df9bac7u), change_endian_long(0x0e9b4448u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            ...
            RX65NHU_func101(change_endian_long(0x88763346u), change_endian_long(0xdad3579eu), change_endian_long(0xf40d2707u), change_endian_long(0xf9c55213u));
        }
        RX65NHU_func100(change_endian_long(0x70ba188bu), change_endian_long(0xca1df8ccu), change_endian_long(0x0aabfdaau), change_endian_long(0xf6eec413u));
        RX65NHU_func072();
        ...
        RX65NHU_func100(change_endian_long(0xe4f0ba6eu), change_endian_long(0x19e75d21u), change_endian_long(0xb2eb6e49u), change_endian_long(0xa0e46481u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        RX65NHU_func100(change_endian_long(0xf26660d2u), change_endian_long(0x3af9a104u), change_endian_long(0xef15165du), change_endian_long(0x37e0ba17u));
        ...
        RX65NHU_func100(change_endian_long(0x2f0ef7b9u), change_endian_long(0x371ea50eu), change_endian_long(0xcaf7e25du), change_endian_long(0xba3696d3u));
        ...
        RX65NHU_func100(change_endian_long(0x600b504bu), change_endian_long(0x9e45b999u), change_endian_long(0x943a07acu), change_endian_long(0xc64fd7fdu));
        ...
        RX65NHU_func102(change_endian_long(0x8098435eu), change_endian_long(0x98480819u), change_endian_long(0xd60166dbu), change_endian_long(0x80da0c2au));
        TSIP.REG_1B8H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_pea_r3.prc
 *********************************************************************************************************************/
