...
*******************************************************************************************************************/ /**
* @details       RX65NHU TLS RSA Key Install
...
e_tsip_err_t R_TSIP_GenerateTlsRsaInstallDataSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_InstData)
{
    ...
    RX65NHU_func100(change_endian_long(0x042d2aebu), change_endian_long(0xb477a673u), change_endian_long(0x66ec5be4u), change_endian_long(0x1dc64884u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0x8b734ec6u), change_endian_long(0xc9a56bccu), change_endian_long(0xbce3ba82u), change_endian_long(0x1863508au));
    ...
    {
        RX65NHU_func100(change_endian_long(0x2ac0579eu), change_endian_long(0x213a43f7u), change_endian_long(0x1ff690e3u), change_endian_long(0xcefd8450u));
        ...
        RX65NHU_func100(change_endian_long(0x26402a42u), change_endian_long(0x9a5de401u), change_endian_long(0xc16b68c6u), change_endian_long(0x6260b710u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func100(change_endian_long(0xb64b8fcfu), change_endian_long(0xf1b84a33u), change_endian_long(0x9cd3de52u), change_endian_long(0x3d800563u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func100(change_endian_long(0x4816848du), change_endian_long(0x9a28048du), change_endian_long(0xbe931673u), change_endian_long(0x3b540223u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func103();
        RX65NHU_func100(change_endian_long(0x10d10683u), change_endian_long(0xa3f7a0b5u), change_endian_long(0xefc7fae3u), change_endian_long(0xb76112eeu));
        ...
        RX65NHU_func100(change_endian_long(0x1a9c9a81u), change_endian_long(0x72fa99f3u), change_endian_long(0xe8abd7a1u), change_endian_long(0xc2ddba6eu));
        TSIP.REG_00H.WORD = 0x00012303u;
        ...
        RX65NHU_func100(change_endian_long(0xf0aa8a49u), change_endian_long(0xfc5bfe98u), change_endian_long(0x7f0197afu), change_endian_long(0x172e8753u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        OutData_InstData[4+jLoop + 2] = TSIP.REG_100H.WORD;
        OutData_InstData[4+jLoop + 3] = TSIP.REG_100H.WORD;
        RX65NHU_func100(change_endian_long(0xa40b2becu), change_endian_long(0x16bc176cu), change_endian_long(0x4b16d4beu), change_endian_long(0xdefef582u));
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX65NHU_func100(change_endian_long(0x19d46f3fu), change_endian_long(0xdf68cabeu), change_endian_long(0x55b92e85u), change_endian_long(0x4d834882u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX65NHU_func102(change_endian_long(0xa1f14944u), change_endian_long(0x2f50eb3fu), change_endian_long(0xd51d99a0u), change_endian_long(0x7aef170bu));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX65NHU_func100(change_endian_long(0x5bd7095bu), change_endian_long(0xebe5d219u), change_endian_long(0xadc32969u), change_endian_long(0x36fc2527u));
            TSIP.REG_104H.WORD = 0x00000052u;
            ...
            RX65NHU_func102(change_endian_long(0xa81be92cu), change_endian_long(0x58705125u), change_endian_long(0x3f807a45u), change_endian_long(0x3065e6c4u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_pdf.prc
 *********************************************************************************************************************/
