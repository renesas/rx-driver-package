...
*******************************************************************************************************************/ /**
* @details       RX65NHU Install 2048bit RSA Private Key
...
e_tsip_err_t R_TSIP_GenerateRsa2048PrivateKeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX65NHU_func100(change_endian_long(0xcb1894bbu), change_endian_long(0x50e0ac12u), change_endian_long(0x67349dc8u), change_endian_long(0x92e2e1ebu));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0xe9f58375u), change_endian_long(0xd9b747ebu), change_endian_long(0xd616a9f4u), change_endian_long(0xb19834b4u));
    ...
    {
        RX65NHU_func100(change_endian_long(0xa033e195u), change_endian_long(0x524fe282u), change_endian_long(0xff6e8b85u), change_endian_long(0x7bf292c4u));
        ...
        RX65NHU_func100(change_endian_long(0xeeaea7f8u), change_endian_long(0x7ef6de21u), change_endian_long(0x68dff609u), change_endian_long(0xdde2d45eu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func100(change_endian_long(0x34b2fbf8u), change_endian_long(0x20d62d7cu), change_endian_long(0x6ab37190u), change_endian_long(0x2190649cu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func100(change_endian_long(0xd30f7b12u), change_endian_long(0x632591eeu), change_endian_long(0xe245140fu), change_endian_long(0x6ecefef3u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func103();
        RX65NHU_func100(change_endian_long(0x5d51dc6cu), change_endian_long(0x4f01b1b3u), change_endian_long(0x4d48b9eeu), change_endian_long(0xd0a22f33u));
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX65NHU_func100(change_endian_long(0x9b36fe16u), change_endian_long(0xc3698925u), change_endian_long(0xb662c5f3u), change_endian_long(0x244e89fdu));
        TSIP.REG_00H.WORD = 0x00013103u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX65NHU_func100(change_endian_long(0x868b6eb5u), change_endian_long(0xa8c763ceu), change_endian_long(0x0519f93cu), change_endian_long(0x0add8344u));
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX65NHU_func100(change_endian_long(0x7be2e8fdu), change_endian_long(0x3b231e2fu), change_endian_long(0x26138274u), change_endian_long(0x85ffd0efu));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX65NHU_func100(change_endian_long(0x9e439109u), change_endian_long(0xc7015b5du), change_endian_long(0x8f2a2ee7u), change_endian_long(0x9fd675dbu));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX65NHU_func102(change_endian_long(0x0385c6b4u), change_endian_long(0xc43268adu), change_endian_long(0x8a52db1du), change_endian_long(0x76b1ac98u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX65NHU_func100(change_endian_long(0x4ba1a194u), change_endian_long(0x72c0ffabu), change_endian_long(0x4484348fu), change_endian_long(0xd7fe5e27u));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX65NHU_func102(change_endian_long(0x5075b2f1u), change_endian_long(0x0e28114eu), change_endian_long(0xb42bd663u), change_endian_long(0x693f0fe0u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p63_r1.prc
 *********************************************************************************************************************/
