...
*******************************************************************************************************************/ /**
* @details       RX65NHU HMAC-SHA1/SHA224/SHA256 Key Install
...
e_tsip_err_t R_TSIP_GenerateShaHmacKeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_Cmd, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX65NHU_func100(change_endian_long(0x64b107b5u), change_endian_long(0x407d1d91u), change_endian_long(0x4e6b7bdbu), change_endian_long(0xb9b193e7u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0x9ce9fba7u), change_endian_long(0x1b621dbfu), change_endian_long(0x34fbd551u), change_endian_long(0xe83e6daau));
    ...
    {
        RX65NHU_func100(change_endian_long(0x2cdf013bu), change_endian_long(0xdf9d4c79u), change_endian_long(0xff684ff5u), change_endian_long(0x5dd35210u));
        ...
        RX65NHU_func100(change_endian_long(0xa7131bc4u), change_endian_long(0xedc30202u), change_endian_long(0x0c77c681u), change_endian_long(0x660e1ea0u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func100(change_endian_long(0x9f4e5d83u), change_endian_long(0x50a21173u), change_endian_long(0x2d8252bfu), change_endian_long(0xeb777055u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func100(change_endian_long(0x132d394fu), change_endian_long(0x7e8f5b81u), change_endian_long(0xd426d1f4u), change_endian_long(0x1d05802eu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func103();
        RX65NHU_func100(change_endian_long(0xc064e556u), change_endian_long(0xc69e89d9u), change_endian_long(0x6b42807fu), change_endian_long(0x5261f6f4u));
        ...
        RX65NHU_func100(change_endian_long(0x229437c0u), change_endian_long(0x335ad40bu), change_endian_long(0xdcc54fa9u), change_endian_long(0x63ab6b20u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX65NHU_func100(change_endian_long(0xe8c8f96fu), change_endian_long(0x88a571d3u), change_endian_long(0x88b542e3u), change_endian_long(0x1d32ccd7u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX65NHU_func102(change_endian_long(0x8c5f9a61u), change_endian_long(0xdbe744a1u), change_endian_long(0x37689b7du), change_endian_long(0xb518c8e7u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX65NHU_func100(change_endian_long(0xdd26daa6u), change_endian_long(0x13c9f1b7u), change_endian_long(0xdd41416eu), change_endian_long(0x1802a1a3u));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX65NHU_func102(change_endian_long(0x3f99a793u), change_endian_long(0x65f8044fu), change_endian_long(0xc8a1571au), change_endian_long(0x33c36739u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p80_r1.prc
 *********************************************************************************************************************/
