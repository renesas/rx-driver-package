...
*******************************************************************************************************************/ /**
* @details       RX65NHU Update TDES Key
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateTdesKeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX65NHU_func100(change_endian_long(0x825e4613u), change_endian_long(0xf983a655u), change_endian_long(0x787a0d0au), change_endian_long(0x201b1797u));
    ...
    RX65NHU_func100(change_endian_long(0x9b687fd8u), change_endian_long(0x1eef3990u), change_endian_long(0x93906138u), change_endian_long(0x5feac57cu));
    ...
    RX65NHU_func100(change_endian_long(0xb73c7a7fu), change_endian_long(0x85fb1a4cu), change_endian_long(0x89829ce6u), change_endian_long(0xbe6ab79au));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX65NHU_func103();
    RX65NHU_func100(change_endian_long(0xcff7ae46u), change_endian_long(0x5569463bu), change_endian_long(0x57df04dcu), change_endian_long(0xe0d9dff7u));
    ...
    RX65NHU_func100(change_endian_long(0xa650ca8eu), change_endian_long(0xd514bac5u), change_endian_long(0x1d99a330u), change_endian_long(0x46affb04u));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0x40a5d8d2u), change_endian_long(0xc7f8b213u), change_endian_long(0x4488c915u), change_endian_long(0x774d1f22u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0x87c0ac6au), change_endian_long(0x19dbeb4fu), change_endian_long(0xc5e80e25u), change_endian_long(0x0d267a10u));
    ...
    {
        RX65NHU_func100(change_endian_long(0x375b0aaeu), change_endian_long(0x8aa66c4cu), change_endian_long(0x471560a5u), change_endian_long(0x06e72ad3u));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX65NHU_func102(change_endian_long(0xcfd533d8u), change_endian_long(0x43aa941du), change_endian_long(0xb2dfe1a8u), change_endian_long(0x06a28797u));
        TSIP.REG_1B4H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p0a.prc
 *********************************************************************************************************************/
