...
*******************************************************************************************************************/ /**
* @details       RX65NHU AES-128 Encryption with CCM Mode Update
...
void R_TSIP_Aes128CcmEncryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX65NHU_func100(change_endian_long(0x51a26356u), change_endian_long(0xd9a8b507u), change_endian_long(0xc6871716u), change_endian_long(0x460a29d6u));
    ...
    RX65NHU_func101(change_endian_long(0xfe55a14eu), change_endian_long(0xb9774d7cu), change_endian_long(0xbb09526bu), change_endian_long(0xd66115ddu));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p95u_r1.prc
 *********************************************************************************************************************/
