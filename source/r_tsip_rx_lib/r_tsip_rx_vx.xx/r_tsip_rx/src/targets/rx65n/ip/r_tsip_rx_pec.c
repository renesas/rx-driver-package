...
*******************************************************************************************************************/ /**
* @details       RX65NHU TLS1.3 Handshake Secret Generation
...
e_tsip_err_t R_TSIP_Tls13GenerateHandshakeSecretSub(uint32_t *InData_SharedSecretKeyIndex, uint32_t *OutData_Handshake_SecretKeyIndex)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0x9e6b466du), change_endian_long(0x130f1d8bu), change_endian_long(0x398755dbu), change_endian_long(0x29b55cffu));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0x6fd279d2u), change_endian_long(0x5528443fu), change_endian_long(0x031be7b3u), change_endian_long(0xe60423e9u));
    ...
    else
    {
        ...
        RX65NHU_func070();
        RX65NHU_func100(change_endian_long(0xd27905a0u), change_endian_long(0x7060422eu), change_endian_long(0x869afcf9u), change_endian_long(0x03f0d28eu));
        ...
        RX65NHU_func100(change_endian_long(0xbf4c6685u), change_endian_long(0xf1cc15dfu), change_endian_long(0x70d49bc9u), change_endian_long(0x3c6c531eu));
        TSIP.REG_E0H.WORD = 0x81040280u;
        ...
        RX65NHU_func102(change_endian_long(0x4cad1d98u), change_endian_long(0x6af43098u), change_endian_long(0xc393dcc0u), change_endian_long(0xa2011a9fu));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_pec_r3.prc
 *********************************************************************************************************************/
