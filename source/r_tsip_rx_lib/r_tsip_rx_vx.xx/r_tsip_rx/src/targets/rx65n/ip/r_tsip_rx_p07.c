...
*******************************************************************************************************************/ /**
* @details       RX65NHU Create 128bit AES Key
...
e_tsip_err_t R_TSIP_GenerateAes128RandomKeyIndexSub(uint32_t *OutData_KeyIndex)
{
    ...
    RX65NHU_func100(change_endian_long(0x2a318a4cu), change_endian_long(0x8f9fc96au), change_endian_long(0x29271a19u), change_endian_long(0x5b51968eu));
    RX65NHU_func103();
    ...
    RX65NHU_func100(change_endian_long(0x7fc0f3e9u), change_endian_long(0xf2484f8cu), change_endian_long(0x74d712eeu), change_endian_long(0x19112438u));
    ...
    RX65NHU_func100(change_endian_long(0x4a860637u), change_endian_long(0x71a34131u), change_endian_long(0x9040eb0fu), change_endian_long(0x0f429f86u));
    RX65NHU_func103();
    TSIP.REG_104H.WORD = 0x00000052u;
    TSIP.REG_C4H.WORD = 0x01000c84u;
    /* WAIT_LOOP */
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0x4bdf58fdu), change_endian_long(0xfc12b845u), change_endian_long(0xa8790667u), change_endian_long(0x4b094883u));
    ...
    RX65NHU_func102(change_endian_long(0xbc61aef6u), change_endian_long(0x330981ddu), change_endian_long(0x14abaeb7u), change_endian_long(0x27ec30a7u));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p07.prc
 *********************************************************************************************************************/
