...
*******************************************************************************************************************/ /**
* @details       RX65NHU Install 1024bit RSA Private Key
...
e_tsip_err_t R_TSIP_GenerateRsa1024PrivateKeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX65NHU_func100(change_endian_long(0xbafde3b4u), change_endian_long(0xeb73c9b7u), change_endian_long(0xe91fdf14u), change_endian_long(0xf5b1749au));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0x3e6838b0u), change_endian_long(0x34ef2382u), change_endian_long(0x2c74b3bdu), change_endian_long(0x98bb05bcu));
    ...
    {
        RX65NHU_func100(change_endian_long(0xa731e216u), change_endian_long(0xeb14ec90u), change_endian_long(0xc57b1f87u), change_endian_long(0x92df5409u));
        ...
        RX65NHU_func100(change_endian_long(0x07285247u), change_endian_long(0x141eae23u), change_endian_long(0x35179f91u), change_endian_long(0x85264b9fu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func100(change_endian_long(0x24969095u), change_endian_long(0xfb57826fu), change_endian_long(0x527c6f69u), change_endian_long(0x4d92a1deu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func100(change_endian_long(0xff2c2394u), change_endian_long(0x9929dae4u), change_endian_long(0x98976b53u), change_endian_long(0x21561733u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func103();
        RX65NHU_func100(change_endian_long(0x5d383a7cu), change_endian_long(0x4a1d360bu), change_endian_long(0xb5834c42u), change_endian_long(0xecaf57dbu));
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX65NHU_func100(change_endian_long(0x94c92342u), change_endian_long(0x7b8376e7u), change_endian_long(0xea2d3be4u), change_endian_long(0x115deb2au));
        TSIP.REG_00H.WORD = 0x00003183u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX65NHU_func100(change_endian_long(0xce290072u), change_endian_long(0xe4fca02bu), change_endian_long(0x068708f3u), change_endian_long(0x6ee8d2d9u));
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX65NHU_func100(change_endian_long(0xff0be616u), change_endian_long(0x622796a9u), change_endian_long(0x0704b05fu), change_endian_long(0x99f1ce7eu));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX65NHU_func100(change_endian_long(0xc3de7debu), change_endian_long(0xf72ce419u), change_endian_long(0x18e08a98u), change_endian_long(0x2c032fdcu));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX65NHU_func102(change_endian_long(0x5c78d4fau), change_endian_long(0x9737b0ceu), change_endian_long(0xd35b3f67u), change_endian_long(0x6b935013u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX65NHU_func100(change_endian_long(0x6b6d7294u), change_endian_long(0xc25a5592u), change_endian_long(0x2641548fu), change_endian_long(0x2f9ff55eu));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX65NHU_func102(change_endian_long(0xcbef6b08u), change_endian_long(0x75917851u), change_endian_long(0x8a161038u), change_endian_long(0x1fc20519u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p60_r1.prc
 *********************************************************************************************************************/
