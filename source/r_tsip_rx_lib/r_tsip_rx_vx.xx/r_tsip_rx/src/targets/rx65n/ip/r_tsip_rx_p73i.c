...
*******************************************************************************************************************/ /**
* @details       RX65NHU HMAC-SHA1 Message Digest Generation Init
...
e_tsip_err_t R_TSIP_Sha1HmacInitSub(uint32_t *InData_KeyType, uint32_t *InData_Cmd, uint32_t *InData_KeyIndex)
{
    ...
    RX65NHU_func100(change_endian_long(0x71b67582u), change_endian_long(0x7c1533dbu), change_endian_long(0x0d3626b7u), change_endian_long(0x58fd90e4u));
    ...
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        ...
        RX65NHU_func101(change_endian_long(0x9f1a7a94u), change_endian_long(0xbc2aba66u), change_endian_long(0x98ae3427u), change_endian_long(0x01c383edu));
    }
    else
    {
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX65NHU_func101(change_endian_long(0x70eaef74u), change_endian_long(0xe1abd0aau), change_endian_long(0xc6781a49u), change_endian_long(0x9f6d65e3u));
    }
    RX65NHU_func100(change_endian_long(0x1701b4a1u), change_endian_long(0x8beb7c5du), change_endian_long(0x2ac7979bu), change_endian_long(0x97f759b4u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0xf874f072u), change_endian_long(0x9bf5c5b2u), change_endian_long(0x3408284au), change_endian_long(0xefea3fcfu));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p73i_r1.prc
 *********************************************************************************************************************/
