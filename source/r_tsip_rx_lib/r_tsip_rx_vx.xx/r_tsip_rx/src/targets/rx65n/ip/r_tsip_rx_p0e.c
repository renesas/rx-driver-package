...
*******************************************************************************************************************/ /**
* @details       RX65NHU Update 2048bit RSA Private Key
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateRsa2048PrivateKeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX65NHU_func100(change_endian_long(0x68af1e96u), change_endian_long(0x300736beu), change_endian_long(0x24290fdcu), change_endian_long(0x5b44dbcfu));
    ...
    RX65NHU_func100(change_endian_long(0xdf952569u), change_endian_long(0x2f5913efu), change_endian_long(0x634d8a41u), change_endian_long(0xa1de13d7u));
    ...
    RX65NHU_func100(change_endian_long(0x11e88475u), change_endian_long(0x9eda7460u), change_endian_long(0x9d01eeacu), change_endian_long(0xa3db509au));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX65NHU_func103();
    RX65NHU_func100(change_endian_long(0x6ba6293fu), change_endian_long(0x9e0d158bu), change_endian_long(0xd16742beu), change_endian_long(0x22786528u));
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0x352c0eb2u), change_endian_long(0x484803ffu), change_endian_long(0x8e5e4c04u), change_endian_long(0x885e8845u));
    TSIP.REG_00H.WORD = 0x00013103u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0x0d6fe9e3u), change_endian_long(0xc7569e66u), change_endian_long(0x4a9fd43au), change_endian_long(0x14e2a11cu));
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0x05ff0066u), change_endian_long(0x1bb6e21cu), change_endian_long(0x0635987eu), change_endian_long(0xd76b0cc2u));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0xbd8075d7u), change_endian_long(0x97b2d2d0u), change_endian_long(0x34163c3bu), change_endian_long(0xe43d93bau));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0xfef728adu), change_endian_long(0xdd73c82bu), change_endian_long(0xd5f3d76au), change_endian_long(0xe39ede58u));
    ...
    {
        RX65NHU_func100(change_endian_long(0x383e2ca5u), change_endian_long(0xb6a82e29u), change_endian_long(0xe048844bu), change_endian_long(0x6412b7dau));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX65NHU_func102(change_endian_long(0xdaabd74eu), change_endian_long(0x9edf42afu), change_endian_long(0xa4627a59u), change_endian_long(0xffd6ddc1u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p0e_r1.prc
 *********************************************************************************************************************/
