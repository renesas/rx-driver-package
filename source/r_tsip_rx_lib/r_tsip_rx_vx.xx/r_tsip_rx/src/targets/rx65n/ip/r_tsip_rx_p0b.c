...
*******************************************************************************************************************/ /**
* @details       RX65NHU Update 1024bit RSA Public Key
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateRsa1024PublicKeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX65NHU_func100(change_endian_long(0x467c1616u), change_endian_long(0x3b3498e3u), change_endian_long(0x82738768u), change_endian_long(0xea1ad958u));
    ...
    RX65NHU_func100(change_endian_long(0xd9570624u), change_endian_long(0xe29fc7bcu), change_endian_long(0xdcf4e70au), change_endian_long(0xeb6d093fu));
    ...
    RX65NHU_func100(change_endian_long(0x67f793a1u), change_endian_long(0xd26e313du), change_endian_long(0xde616ce5u), change_endian_long(0x7d8d133fu));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX65NHU_func103();
    RX65NHU_func100(change_endian_long(0xf0f93e73u), change_endian_long(0xa5cf1836u), change_endian_long(0xde37f7c3u), change_endian_long(0xfeeb30b1u));
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0xb5d8fb3eu), change_endian_long(0x160e8fc5u), change_endian_long(0x98b04ccbu), change_endian_long(0x9aa011afu));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX65NHU_func100(change_endian_long(0xcb4f1650u), change_endian_long(0xa7649552u), change_endian_long(0x947d4bcau), change_endian_long(0x377dc8e2u));
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0xab23b7ffu), change_endian_long(0xb6e5198fu), change_endian_long(0x6d178f69u), change_endian_long(0x6d9032a6u));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0x3f3235cau), change_endian_long(0xfeae9741u), change_endian_long(0x84ba00deu), change_endian_long(0x5073a254u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0xda8ade15u), change_endian_long(0x5474bffcu), change_endian_long(0x551729f9u), change_endian_long(0x8f8feb2du));
    ...
    {
        RX65NHU_func100(change_endian_long(0x4d6028b5u), change_endian_long(0xabe52cabu), change_endian_long(0x9689307cu), change_endian_long(0x0c111d40u));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX65NHU_func102(change_endian_long(0x0fca2619u), change_endian_long(0x7a2dba25u), change_endian_long(0xccce37f2u), change_endian_long(0x43bd69f4u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p0b.prc
 *********************************************************************************************************************/
