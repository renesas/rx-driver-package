...
*******************************************************************************************************************/ /**
* @details       RX65NHU ARC4 Encryption/Decryption Update
...
void R_TSIP_Arc4EncryptDecryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX65NHU_func100(change_endian_long(0xd81ac70eu), change_endian_long(0xe46c6926u), change_endian_long(0x2f1cc9eau), change_endian_long(0xb98209fau));
    ...
    RX65NHU_func101(change_endian_long(0x6ed678d9u), change_endian_long(0x4039875eu), change_endian_long(0x650e87f1u), change_endian_long(0x5b3f7cb3u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_pd6u_r1.prc
 *********************************************************************************************************************/
