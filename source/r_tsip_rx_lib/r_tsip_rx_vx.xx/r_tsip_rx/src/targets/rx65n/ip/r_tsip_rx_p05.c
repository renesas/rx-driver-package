...
*******************************************************************************************************************/ /**
* @details       RX65NHU Update 128bit AES Key
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateAes128KeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX65NHU_func100(change_endian_long(0x9a88d10eu), change_endian_long(0x58b68699u), change_endian_long(0xc56fb968u), change_endian_long(0x77440846u));
    ...
    RX65NHU_func100(change_endian_long(0x5d1f3f46u), change_endian_long(0xa9d75eadu), change_endian_long(0x45fbc9f4u), change_endian_long(0x6ec6644du));
    ...
    RX65NHU_func100(change_endian_long(0x708c2555u), change_endian_long(0x64ad4657u), change_endian_long(0x85ba2ad9u), change_endian_long(0x4f8241a6u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX65NHU_func103();
    RX65NHU_func100(change_endian_long(0x743b1defu), change_endian_long(0xe05e92aeu), change_endian_long(0x375d7fa4u), change_endian_long(0xfbe877c0u));
    ...
    RX65NHU_func100(change_endian_long(0x8b09c696u), change_endian_long(0x73372afau), change_endian_long(0x2912c956u), change_endian_long(0x735d9abdu));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0xb0f8bfe7u), change_endian_long(0x63e2663bu), change_endian_long(0x0af0ea8fu), change_endian_long(0xbf4f22cau));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0x99ac7e05u), change_endian_long(0x8a71c197u), change_endian_long(0xf309b246u), change_endian_long(0x69b72d66u));
    ...
    {
        RX65NHU_func100(change_endian_long(0x4e98ac6bu), change_endian_long(0xea0353c8u), change_endian_long(0x17801861u), change_endian_long(0x5a96bfabu));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX65NHU_func102(change_endian_long(0x42aae293u), change_endian_long(0x6aabae33u), change_endian_long(0x94eee09du), change_endian_long(0xd6622b40u));
        TSIP.REG_1B4H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p05.prc
 *********************************************************************************************************************/
