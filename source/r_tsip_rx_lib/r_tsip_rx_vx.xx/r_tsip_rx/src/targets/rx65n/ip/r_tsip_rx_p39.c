...
*******************************************************************************************************************/ /**
* @details       RX65NHU TLS1.3 Handshake Secret Generation for Server
...
e_tsip_err_t R_TSIP_Tls13SVGenerateHandshakeSecretSub(uint32_t *InData_SharedSecretKeyIndex, uint32_t *OutData_Handshake_SecretKeyIndex)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0xb4c2294bu), change_endian_long(0x7b5f9cbfu), change_endian_long(0x07278322u), change_endian_long(0xb4e3b392u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0x5cf228d6u), change_endian_long(0x1849361fu), change_endian_long(0x46ab273du), change_endian_long(0xb6ddcd6du));
    ...
    else
    {
        ...
        RX65NHU_func070();
        RX65NHU_func100(change_endian_long(0xf6c32e8fu), change_endian_long(0x071c2a9cu), change_endian_long(0x2cf79b69u), change_endian_long(0x56213b8fu));
        ...
        RX65NHU_func100(change_endian_long(0x46f00753u), change_endian_long(0x6b29bdecu), change_endian_long(0x1859d050u), change_endian_long(0x5dab7790u));
        TSIP.REG_E0H.WORD = 0x81040280u;
        ...
        RX65NHU_func102(change_endian_long(0x06400844u), change_endian_long(0x8fe538b3u), change_endian_long(0xa013a6edu), change_endian_long(0x09d98b5du));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p39.prc
 *********************************************************************************************************************/
