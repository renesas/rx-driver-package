...
*******************************************************************************************************************/ /**
* @details       RX65NHU TLS1.3 0-RTT Application Write Key Generation
...
e_tsip_err_t R_TSIP_Tls13Generate0RttApplicationWriteKeySub(uint32_t *InData_Handle, uint32_t *InData_PreSharedKeyIndex, uint32_t *InData_MsgHash, uint32_t *OutData_ClientWriteKeyIndex)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0x9e7f6f6eu), change_endian_long(0xea4a20bdu), change_endian_long(0x45998c25u), change_endian_long(0xfbb405a7u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0x53c71001u), change_endian_long(0x1c57f426u), change_endian_long(0x3ca2f82du), change_endian_long(0x29820b1au));
    ...
    {
        RX65NHU_func100(change_endian_long(0x47c75c43u), change_endian_long(0x28f06a9fu), change_endian_long(0xf506d5e8u), change_endian_long(0x99d524b9u));
        ...
        RX65NHU_func100(change_endian_long(0xfc1cfa1cu), change_endian_long(0xfc561ef2u), change_endian_long(0xf88b73a3u), change_endian_long(0xd61e01d5u));
        TSIP.REG_E0H.WORD = 0x81040280u;
        ...
        RX65NHU_func102(change_endian_long(0xb1f97593u), change_endian_long(0xc963d72du), change_endian_long(0x4eefa3f9u), change_endian_long(0xe8737ed8u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_pee_r1.prc
 *********************************************************************************************************************/
