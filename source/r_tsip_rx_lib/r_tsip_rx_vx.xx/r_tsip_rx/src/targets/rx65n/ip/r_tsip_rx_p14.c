...
*******************************************************************************************************************/ /**
* @details       RX65NHU Install TDES Key
...
e_tsip_err_t R_TSIP_GenerateTdesKeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX65NHU_func100(change_endian_long(0xc0601845u), change_endian_long(0x595a6238u), change_endian_long(0x9b046a3cu), change_endian_long(0x01322b04u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0xe5cb6080u), change_endian_long(0xcc622f79u), change_endian_long(0x563e4560u), change_endian_long(0xa4354d7cu));
    ...
    {
        RX65NHU_func100(change_endian_long(0xefbcf8e8u), change_endian_long(0x270a97dcu), change_endian_long(0xfc5bf82cu), change_endian_long(0x200f2960u));
        ...
        RX65NHU_func100(change_endian_long(0x7e9af688u), change_endian_long(0x449c0decu), change_endian_long(0x2bcc4720u), change_endian_long(0x2330f7bcu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func100(change_endian_long(0x4f29106du), change_endian_long(0x0dd3da76u), change_endian_long(0x97b12487u), change_endian_long(0x7f5801fdu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func100(change_endian_long(0xca3c3136u), change_endian_long(0xa879ad9cu), change_endian_long(0xcf0b0c5bu), change_endian_long(0xfec9dda5u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func103();
        RX65NHU_func100(change_endian_long(0x6228b122u), change_endian_long(0xdfaa95e2u), change_endian_long(0x990dda85u), change_endian_long(0x1a32cbacu));
        ...
        RX65NHU_func100(change_endian_long(0x7d01d3cbu), change_endian_long(0x5c632a3du), change_endian_long(0x23558b7du), change_endian_long(0x27785290u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX65NHU_func100(change_endian_long(0x627ef6b4u), change_endian_long(0x86d4a663u), change_endian_long(0x81a91d75u), change_endian_long(0x59fc05ceu));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX65NHU_func102(change_endian_long(0xe2d94207u), change_endian_long(0x5c64c1c2u), change_endian_long(0xfc40c547u), change_endian_long(0xe716411fu));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX65NHU_func100(change_endian_long(0xdf38d7aau), change_endian_long(0x725ca981u), change_endian_long(0x83255e81u), change_endian_long(0xb0ec6e35u));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX65NHU_func102(change_endian_long(0xb6739c64u), change_endian_long(0x6728fde3u), change_endian_long(0x906ad392u), change_endian_long(0xc5bf7ef1u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p14.prc
 *********************************************************************************************************************/
