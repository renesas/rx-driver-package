...
*******************************************************************************************************************/ /**
* @details       RX65NHU Update 1024bit RSA Private Key
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateRsa1024PrivateKeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX65NHU_func100(change_endian_long(0x25700cd1u), change_endian_long(0xcef65c3eu), change_endian_long(0x16d2b7a6u), change_endian_long(0x6e44e9d9u));
    ...
    RX65NHU_func100(change_endian_long(0xcd575b86u), change_endian_long(0x148284afu), change_endian_long(0x7981b115u), change_endian_long(0x3b8a41e0u));
    ...
    RX65NHU_func100(change_endian_long(0x1a80ecdcu), change_endian_long(0x838e1afdu), change_endian_long(0xf45f866bu), change_endian_long(0xa2db0a17u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX65NHU_func103();
    RX65NHU_func100(change_endian_long(0x53ad32e2u), change_endian_long(0x8c77757cu), change_endian_long(0xa730665bu), change_endian_long(0x329b3213u));
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0x195592efu), change_endian_long(0xacb6da43u), change_endian_long(0xd3140f0eu), change_endian_long(0x8d95f5adu));
    TSIP.REG_00H.WORD = 0x00003183u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0x8df0613eu), change_endian_long(0x95977677u), change_endian_long(0x9f08edeeu), change_endian_long(0x4f6a562cu));
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0x9c0977fcu), change_endian_long(0x45a5e709u), change_endian_long(0xc0e870dbu), change_endian_long(0x7582d689u));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0x5f118bfbu), change_endian_long(0x7f1683d4u), change_endian_long(0x473163b5u), change_endian_long(0x9edde54eu));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0x36a65d72u), change_endian_long(0x1a84d835u), change_endian_long(0xf8f674b3u), change_endian_long(0x2523fe97u));
    ...
    {
        RX65NHU_func100(change_endian_long(0xa8149700u), change_endian_long(0x1a141ce8u), change_endian_long(0x6315d8a7u), change_endian_long(0xba3769ecu));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX65NHU_func102(change_endian_long(0x87458ebbu), change_endian_long(0x5574439eu), change_endian_long(0xca94d7cdu), change_endian_long(0xea44bb89u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p0c_r1.prc
 *********************************************************************************************************************/
