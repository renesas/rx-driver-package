...
*******************************************************************************************************************/ /**
* @details       RX65NHU SHA-224/256 Message Digest Generation
...
e_tsip_err_t R_TSIP_Sha224256GenerateMessageDigestSub(uint32_t *InData_SHA_InitVal, uint32_t *InData_PaddedMsg, uint32_t MAX_CNT, uint32_t *OutData_MsgDigest)
{
    ...
    RX65NHU_func100(change_endian_long(0x5acc0ad4u), change_endian_long(0x0a324286u), change_endian_long(0x140a462eu), change_endian_long(0x72e282b7u));
    ...
    RX65NHU_func102(change_endian_long(0x974c3902u), change_endian_long(0x83ac2aadu), change_endian_long(0x82efe481u), change_endian_long(0xe32df143u));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p72.prc
 *********************************************************************************************************************/
