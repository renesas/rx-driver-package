...
*******************************************************************************************************************/ /**
* @details       RX65NHU Install 256bit AES Key
...
e_tsip_err_t R_TSIP_GenerateAes256KeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX65NHU_func100(change_endian_long(0x2f7f22c9u), change_endian_long(0x40330d50u), change_endian_long(0xcce7dd0au), change_endian_long(0x85d65496u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0x0a093b18u), change_endian_long(0xfcd35d30u), change_endian_long(0x6e97847fu), change_endian_long(0x3796f385u));
    ...
    {
        RX65NHU_func100(change_endian_long(0xc2c8b207u), change_endian_long(0x7a6ef074u), change_endian_long(0x85515293u), change_endian_long(0x289ae664u));
        ...
        RX65NHU_func100(change_endian_long(0x58c82f83u), change_endian_long(0x60b6c32du), change_endian_long(0xbc58bfb1u), change_endian_long(0xa3865b18u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func100(change_endian_long(0xe3a36c2bu), change_endian_long(0x1bfabccfu), change_endian_long(0x3110614au), change_endian_long(0x5d941bbcu));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func100(change_endian_long(0x4ac8fa7bu), change_endian_long(0x5b5fa78eu), change_endian_long(0x4377e8a5u), change_endian_long(0x7495564au));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func103();
        RX65NHU_func100(change_endian_long(0xd1208096u), change_endian_long(0xc55b7ddfu), change_endian_long(0x564836dcu), change_endian_long(0xa497b18eu));
        ...
        RX65NHU_func100(change_endian_long(0x060ef9ecu), change_endian_long(0x60220b31u), change_endian_long(0x51fb2824u), change_endian_long(0x513c7fe2u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX65NHU_func100(change_endian_long(0x4b006867u), change_endian_long(0x52b4bcbdu), change_endian_long(0x8adabab7u), change_endian_long(0x8cf9b4a0u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX65NHU_func102(change_endian_long(0x93637607u), change_endian_long(0x1bde1289u), change_endian_long(0xdbf30dd1u), change_endian_long(0xa4494285u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX65NHU_func100(change_endian_long(0xce23d238u), change_endian_long(0x77bcd1a4u), change_endian_long(0x0fc69728u), change_endian_long(0x71c3b9bfu));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX65NHU_func102(change_endian_long(0xa75e6537u), change_endian_long(0x3ec07075u), change_endian_long(0x453e56b4u), change_endian_long(0xb2c868e3u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p04.prc
 *********************************************************************************************************************/
