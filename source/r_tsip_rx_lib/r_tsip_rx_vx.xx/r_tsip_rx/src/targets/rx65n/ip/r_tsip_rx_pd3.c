...
*******************************************************************************************************************/ /**
* @details       RX65NHU TLS P-256 ECC Key Generation for Server
...
e_tsip_err_t R_TSIP_GenerateTlsSVP256EccKeyIndexSub(uint32_t *OutData_KeyIndex, uint32_t *OutData_PubKey)
{
    ...
    RX65NHU_func100(change_endian_long(0x5ca396f4u), change_endian_long(0xd326f2a6u), change_endian_long(0x8200da62u), change_endian_long(0xab79c15eu));
    RX65NHU_func103();
    ...
    RX65NHU_func100(change_endian_long(0xb62296c9u), change_endian_long(0xe90de0ccu), change_endian_long(0xbd7d5004u), change_endian_long(0x404f5b06u));
    RX65NHU_func103();
    TSIP.REG_104H.WORD = 0x00000052u;
    TSIP.REG_C4H.WORD = 0x01000c84u;
    /* WAIT_LOOP */
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0x2cad3219u), change_endian_long(0xcf6ccad0u), change_endian_long(0x33d9e73fu), change_endian_long(0xd372cc83u));
    RX65NHU_func103();
    TSIP.REG_104H.WORD = 0x00000052u;
    TSIP.REG_C4H.WORD = 0x01000c84u;
    /* WAIT_LOOP */
    ...
    RX65NHU_func100(change_endian_long(0xb5481c22u), change_endian_long(0xcfd64c86u), change_endian_long(0x713c81c9u), change_endian_long(0xdc60fd00u));
    ...
    RX65NHU_func100(change_endian_long(0x3de5974eu), change_endian_long(0x376dfa9au), change_endian_long(0xa099f872u), change_endian_long(0x1066d5a9u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0x7a05bce0u), change_endian_long(0x595229a5u), change_endian_long(0x2e253574u), change_endian_long(0xf4c6c5c8u));
    ...
    {
        RX65NHU_func100(change_endian_long(0xe40a4227u), change_endian_long(0x3b93d232u), change_endian_long(0xacb7d6e0u), change_endian_long(0x5bdde65du));
        ...
        RX65NHU_func100(change_endian_long(0x280bf8a5u), change_endian_long(0x9ba54767u), change_endian_long(0x5159fc09u), change_endian_long(0xdadb3d2bu));
        RX65NHU_func103();
        RX65NHU_func100(change_endian_long(0xc9cbf78fu), change_endian_long(0x4fe56caau), change_endian_long(0x067bdd77u), change_endian_long(0xc1715cf9u));
        TSIP.REG_104H.WORD = 0x00000052u;
        TSIP.REG_C4H.WORD = 0x01000c84u;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        ...
        RX65NHU_func100(change_endian_long(0x8dee97f9u), change_endian_long(0x68599f6fu), change_endian_long(0xf906ae1eu), change_endian_long(0x36c99a84u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        RX65NHU_func100(change_endian_long(0x63497d70u), change_endian_long(0x1508743au), change_endian_long(0x380af145u), change_endian_long(0xe59b210bu));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX65NHU_func100(change_endian_long(0x19688fefu), change_endian_long(0xda812e25u), change_endian_long(0x66184009u), change_endian_long(0x6ad0636au));
        ...
        RX65NHU_func100(change_endian_long(0x8af4e1d2u), change_endian_long(0x4f9295e6u), change_endian_long(0x51ed63e9u), change_endian_long(0x48d50ec1u));
        ...
        RX65NHU_func102(change_endian_long(0x11dc0499u), change_endian_long(0x49369b86u), change_endian_long(0xb4d17cafu), change_endian_long(0x8cb90bbdu));
        TSIP.REG_1B8H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_pd3.prc
 *********************************************************************************************************************/
