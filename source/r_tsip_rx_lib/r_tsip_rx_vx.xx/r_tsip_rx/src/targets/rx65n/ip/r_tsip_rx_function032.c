...
void RX65NHU_func032(void)
{
    ...
    RX65NHU_func100(change_endian_long(0x724bf17eu), change_endian_long(0x7f0ea5f6u), change_endian_long(0x5e8b9d2du), change_endian_long(0x568b8891u));
    ...
    for (iLoop = 0; iLoop < S_RAM[0]; iLoop = iLoop + 1)
    {
        ...
        RX65NHU_func101(change_endian_long(0xb824356cu), change_endian_long(0x6d41401bu), change_endian_long(0x09ecb92du), change_endian_long(0x4378b72eu));
    }
    TSIP.REG_ECH.WORD = 0x00007c0du;
    TSIP.REG_1CH.WORD = 0x00602000u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0xa99867d4u), change_endian_long(0x75af5673u), change_endian_long(0xc016941cu), change_endian_long(0x84ad1311u));
    TSIP.REG_ECH.WORD = 0x00007c01u;
    TSIP.REG_1CH.WORD = 0x00600000u;
}
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_func032.prc
 *********************************************************************************************************************/
