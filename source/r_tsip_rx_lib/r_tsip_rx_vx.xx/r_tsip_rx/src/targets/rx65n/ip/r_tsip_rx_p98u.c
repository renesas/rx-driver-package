...
*******************************************************************************************************************/ /**
* @details       RX65NHU AES-128 Decryption and MAC verification with CCM Mode Update
...
void R_TSIP_Aes128CcmDecryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX65NHU_func100(change_endian_long(0x4cab03d9u), change_endian_long(0x00021b0du), change_endian_long(0xc8c6b492u), change_endian_long(0x3fa15c75u));
    ...
    RX65NHU_func207();//DisableINTEGRATE_WRRDYBandINTEGRATE_RDRDYBinthisfunction.
    RX65NHU_func101(change_endian_long(0xc7b9c907u), change_endian_long(0xd2f303b5u), change_endian_long(0x06796c61u), change_endian_long(0xfe681e7fu));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p98u_r1.prc
 *********************************************************************************************************************/
