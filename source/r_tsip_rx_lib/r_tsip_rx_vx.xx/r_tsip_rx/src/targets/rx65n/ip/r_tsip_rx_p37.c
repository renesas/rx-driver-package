...
*******************************************************************************************************************/ /**
* @details       RX65NHU TLS1.3 P-256 Key Generation for Server
* @param[in]     InData_Cmd
...
e_tsip_err_t R_TSIP_GenerateTls13SVP256EccKeyIndexSub(uint32_t *InData_Cmd, uint32_t *InData_Handle, uint32_t *OutData_KeyIndex, uint32_t *OutData_PubKey)
{
    ...
    RX65NHU_func100(change_endian_long(0x56f9fb8eu), change_endian_long(0x546e2aaeu), change_endian_long(0x50dbcbe0u), change_endian_long(0x9341dd47u));
    RX65NHU_func103();
    ...
    RX65NHU_func100(change_endian_long(0x00f1a7e7u), change_endian_long(0x995b9076u), change_endian_long(0x3c89ae75u), change_endian_long(0xe5ce5e13u));
    RX65NHU_func103();
    TSIP.REG_104H.WORD = 0x00000052u;
    TSIP.REG_C4H.WORD = 0x01000c84u;
    /* WAIT_LOOP */
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0x39adf871u), change_endian_long(0xcdbae4c5u), change_endian_long(0x7a2a3028u), change_endian_long(0xeac6c5adu));
    RX65NHU_func103();
    TSIP.REG_104H.WORD = 0x00000052u;
    TSIP.REG_C4H.WORD = 0x01000c84u;
    /* WAIT_LOOP */
    ...
    RX65NHU_func100(change_endian_long(0x72569e18u), change_endian_long(0x00eeae58u), change_endian_long(0x9401c7f8u), change_endian_long(0x8297b489u));
    ...
    RX65NHU_func100(change_endian_long(0xdcad25ceu), change_endian_long(0x948be438u), change_endian_long(0x81ddec7fu), change_endian_long(0x066b244du));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0xb26b1d26u), change_endian_long(0xbbf8d3aeu), change_endian_long(0x6470af48u), change_endian_long(0x92872f01u));
    ...
    {
        RX65NHU_func100(change_endian_long(0xe98c6d7au), change_endian_long(0x9db00824u), change_endian_long(0x5970fa82u), change_endian_long(0xd150d467u));
        ...
        RX65NHU_func100(change_endian_long(0xa9faf571u), change_endian_long(0xbcc6bea4u), change_endian_long(0x7b63873bu), change_endian_long(0xc35038d1u));
        ...
        RX65NHU_func100(change_endian_long(0xa1fcf879u), change_endian_long(0xc3c36860u), change_endian_long(0x199d0116u), change_endian_long(0xdbc63d20u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            ...
            RX65NHU_func101(change_endian_long(0xf046f64du), change_endian_long(0x6c707b93u), change_endian_long(0xebb90d8cu), change_endian_long(0x505c1753u));
        }
        RX65NHU_func100(change_endian_long(0xe9c5d8efu), change_endian_long(0xe6dfca82u), change_endian_long(0x97c0a808u), change_endian_long(0xc59603c5u));
        RX65NHU_func075();
        ...
        RX65NHU_func100(change_endian_long(0xb0ed91e5u), change_endian_long(0x7d310641u), change_endian_long(0x70a1975eu), change_endian_long(0x338ebb95u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        RX65NHU_func100(change_endian_long(0xcf5dde23u), change_endian_long(0x688bf1d1u), change_endian_long(0xa01ac46cu), change_endian_long(0xb57c2c73u));
        ...
        RX65NHU_func100(change_endian_long(0x565ae8a0u), change_endian_long(0xd77c83ffu), change_endian_long(0x2830b315u), change_endian_long(0xd86e4f17u));
        ...
        RX65NHU_func100(change_endian_long(0xd1ea305eu), change_endian_long(0x52756b3cu), change_endian_long(0x3dca91e1u), change_endian_long(0x0be4dcd4u));
        ...
        RX65NHU_func102(change_endian_long(0xe0a9ba67u), change_endian_long(0xa40c3892u), change_endian_long(0xf0d478f6u), change_endian_long(0x0231680au));
        TSIP.REG_1B8H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p37_r1.prc
 *********************************************************************************************************************/
