...
*******************************************************************************************************************/ /**
* @details       RX65NHU TLS1.3 Application Traffic Key Update
* @param[in]     InData_Cmd
...
e_tsip_err_t R_TSIP_Tls13UpdateApplicationTrafficKeySub(uint32_t *InData_Cmd, uint32_t *InData_UpdateKeyType, uint32_t *InData_Handle, uint32_t *InData_ApplicationSecretKeyIndex, uint32_t *OutData_ApplicationSecretKeyIndex, uint32_t *OutData_ApplicationWriteKeyIndex)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0x9c0c5cf0u), change_endian_long(0xc741ded9u), change_endian_long(0x0addb8a5u), change_endian_long(0x1444bb51u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0xc3ac67fau), change_endian_long(0x9515f56au), change_endian_long(0x01e3672eu), change_endian_long(0x846f91c5u));
    ...
    {
        RX65NHU_func100(change_endian_long(0xfae06f69u), change_endian_long(0xfa316a3au), change_endian_long(0xad099bfcu), change_endian_long(0xab701579u));
        ...
        RX65NHU_func100(change_endian_long(0x46aedc8fu), change_endian_long(0x2baf58a7u), change_endian_long(0x1b6d6debu), change_endian_long(0x868634efu));
        ...
        RX65NHU_func100(change_endian_long(0x4d20bafau), change_endian_long(0x4395705au), change_endian_long(0x461f8a4bu), change_endian_long(0x9a333406u));
        TSIP.REG_E0H.WORD = 0x81040280u;
        ...
        RX65NHU_func102(change_endian_long(0xe04763c9u), change_endian_long(0x1e673e2au), change_endian_long(0x2d21995du), change_endian_long(0x732a831bu));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_pcf_r4.prc
 *********************************************************************************************************************/
