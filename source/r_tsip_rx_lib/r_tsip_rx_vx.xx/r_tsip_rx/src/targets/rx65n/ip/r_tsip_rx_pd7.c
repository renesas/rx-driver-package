...
*******************************************************************************************************************/ /**
* @details       RX65NHU Update TLS RSA Key for Server
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateTlsSVRsaDataSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_InstData)
{
    ...
    RX65NHU_func100(change_endian_long(0x5141e199u), change_endian_long(0xa9b5c08au), change_endian_long(0xf28c0205u), change_endian_long(0xcfa3937du));
    ...
    RX65NHU_func100(change_endian_long(0xba2a4003u), change_endian_long(0x77d617b3u), change_endian_long(0xae2b2e20u), change_endian_long(0xc44a4f3bu));
    ...
    RX65NHU_func100(change_endian_long(0x8ad3974du), change_endian_long(0x52383f90u), change_endian_long(0x60ee5ff9u), change_endian_long(0xaa71c2acu));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX65NHU_func103();
    RX65NHU_func100(change_endian_long(0xcce1d1f8u), change_endian_long(0x4f0cb11fu), change_endian_long(0x29ee0cdcu), change_endian_long(0xc3b696b7u));
    ...
    RX65NHU_func100(change_endian_long(0x8f7437bbu), change_endian_long(0x61fca9e3u), change_endian_long(0x79da4ceau), change_endian_long(0x57f3dac7u));
    TSIP.REG_00H.WORD = 0x00012303u;
    ...
    RX65NHU_func100(change_endian_long(0x19bdef94u), change_endian_long(0xc6200425u), change_endian_long(0x099a863fu), change_endian_long(0x7a93a110u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    OutData_InstData[4+jLoop + 2] = TSIP.REG_100H.WORD;
    OutData_InstData[4+jLoop + 3] = TSIP.REG_100H.WORD;
    RX65NHU_func100(change_endian_long(0x5ac67dfeu), change_endian_long(0xd2b298e2u), change_endian_long(0x2e9a2336u), change_endian_long(0xbaad6577u));
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0xc5ea05e3u), change_endian_long(0x1c64c46bu), change_endian_long(0x99b3bb6au), change_endian_long(0xe4b96025u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0x42936936u), change_endian_long(0x3a822800u), change_endian_long(0x8821e29eu), change_endian_long(0xba65b992u));
    ...
    {
        RX65NHU_func100(change_endian_long(0x923b880fu), change_endian_long(0x652aea4cu), change_endian_long(0xb7b868a1u), change_endian_long(0xb7b52dbcu));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        RX65NHU_func102(change_endian_long(0x540edf65u), change_endian_long(0x5252a337u), change_endian_long(0xc33dd198u), change_endian_long(0x4a74652au));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_pd7.prc
 *********************************************************************************************************************/
