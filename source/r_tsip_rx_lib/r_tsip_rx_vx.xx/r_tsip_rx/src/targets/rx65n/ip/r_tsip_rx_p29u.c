...
*******************************************************************************************************************/ /**
* @details       RX65NHU AES-128 Encryption with GCM Mode Update
...
void R_TSIP_Aes128GcmEncryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX65NHU_func100(change_endian_long(0x6886165du), change_endian_long(0xcb4f0e47u), change_endian_long(0x792498b0u), change_endian_long(0xe99649cbu));
    ...
    RX65NHU_func101(change_endian_long(0xaea2da39u), change_endian_long(0xccd1b021u), change_endian_long(0xb4aa8e4eu), change_endian_long(0xefd3ac8cu));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p29u_r1.prc
 *********************************************************************************************************************/
