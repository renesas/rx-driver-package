...
*******************************************************************************************************************/ /**
* @details       RX65NHU AES-256 Decryption with GCM Mode Update
...
void R_TSIP_Aes256GcmDecryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX65NHU_func100(change_endian_long(0x823a272fu), change_endian_long(0xfa3f0b80u), change_endian_long(0x38fce7bcu), change_endian_long(0xb08b41bfu));
    ...
    RX65NHU_func200();//DisableINTEGRATE_WRRDYBandINTEGRATE_RDRDYBinthisfunction.
    RX65NHU_func101(change_endian_long(0xd8620e03u), change_endian_long(0x0cc9d34cu), change_endian_long(0x09ddc145u), change_endian_long(0x3e53a5b5u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p36u_r1.prc
 *********************************************************************************************************************/
