...
*******************************************************************************************************************/ /**
* @details       RX65NHU RSA1024 Encryption with Public Key
...
e_tsip_err_t R_TSIP_Rsa1024ModularExponentEncryptSub(uint32_t *InData_KeyIndex, uint32_t *InData_Text, uint32_t *OutData_Text)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0xc5a2b72bu), change_endian_long(0x698f299cu), change_endian_long(0xc75e7b8eu), change_endian_long(0xc84a07f6u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0xb12fbb8bu), change_endian_long(0x659187ffu), change_endian_long(0x6a0217a8u), change_endian_long(0x712b2adcu));
    ...
    {
        RX65NHU_func100(change_endian_long(0xe017a047u), change_endian_long(0x5c79da68u), change_endian_long(0xc9f46476u), change_endian_long(0x80e0f446u));
        ...
        RX65NHU_func100(change_endian_long(0x59f901dbu), change_endian_long(0x5bb99cf5u), change_endian_long(0x0ef840b9u), change_endian_long(0x5f465347u));
        ...
        RX65NHU_func102(change_endian_long(0x371e75bfu), change_endian_long(0xcaa07d49u), change_endian_long(0x11550342u), change_endian_long(0xb13af35du));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p53.prc
 *********************************************************************************************************************/
