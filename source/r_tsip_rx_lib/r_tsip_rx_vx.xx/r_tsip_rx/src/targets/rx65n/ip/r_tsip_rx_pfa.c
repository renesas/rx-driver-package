...
*******************************************************************************************************************/ /**
* @details       RX65NHU Install P-192/224/256 ECC Public key
...
e_tsip_err_t R_TSIP_GenerateEccPublicKeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_Cmd, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX65NHU_func100(change_endian_long(0xc1692cd0u), change_endian_long(0x85263018u), change_endian_long(0x93d4c743u), change_endian_long(0xc519a566u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0xde5723ebu), change_endian_long(0x1919f5a5u), change_endian_long(0x5ab023e3u), change_endian_long(0x0c616963u));
    ...
    {
        RX65NHU_func100(change_endian_long(0xbca77fc0u), change_endian_long(0xc8d9e420u), change_endian_long(0x9478f908u), change_endian_long(0xb161ca72u));
        ...
        RX65NHU_func100(change_endian_long(0xd4442439u), change_endian_long(0x75157d5cu), change_endian_long(0xc2b99dc3u), change_endian_long(0x3b869831u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func100(change_endian_long(0x07dc083eu), change_endian_long(0x7a14964du), change_endian_long(0x0fe5edd2u), change_endian_long(0x241f21f5u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func100(change_endian_long(0x9eccfa22u), change_endian_long(0xe632bcf9u), change_endian_long(0x61ced59du), change_endian_long(0x9c056246u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX65NHU_func103();
        RX65NHU_func100(change_endian_long(0x628a0c9du), change_endian_long(0xa679788bu), change_endian_long(0x90038415u), change_endian_long(0xd309e13cu));
        ...
        RX65NHU_func100(change_endian_long(0x189481cdu), change_endian_long(0xe233e29du), change_endian_long(0x2512293bu), change_endian_long(0xdd4be350u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        RX65NHU_func100(change_endian_long(0x774831d2u), change_endian_long(0x4736b831u), change_endian_long(0x8659cf5fu), change_endian_long(0x2cffa1e2u));
        TSIP.REG_104H.WORD = 0x00000052u;
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX65NHU_func100(change_endian_long(0x71117ea2u), change_endian_long(0xa0071b27u), change_endian_long(0x2e4a6154u), change_endian_long(0xe1005cf9u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX65NHU_func102(change_endian_long(0xcacb2d3au), change_endian_long(0x3f138571u), change_endian_long(0x308f16f4u), change_endian_long(0x680bd827u));
            TSIP.REG_1B4H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX65NHU_func100(change_endian_long(0x4de334b2u), change_endian_long(0x1069de29u), change_endian_long(0x88c07ebcu), change_endian_long(0xa54918a0u));
            TSIP.REG_E0H.WORD = 0x81040000u;
            ...
            RX65NHU_func102(change_endian_long(0x36a0394du), change_endian_long(0x6ff42ceeu), change_endian_long(0xf7e48acau), change_endian_long(0x8585a22au));
            TSIP.REG_1B4H.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_pfa_r1.prc
 *********************************************************************************************************************/
