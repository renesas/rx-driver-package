...
*******************************************************************************************************************/ /**
* @details       RX65NHU AES-256 Decryption with GCM Mode Final
...
e_tsip_err_t R_TSIP_Aes256GcmDecryptFinalSub(uint32_t *InData_Text, uint32_t *InData_DataT, uint32_t *InData_DataALen, uint32_t *InData_TextLen, uint32_t *InData_DataTLen, uint32_t *OutData_Text)
{
    ...
    TSIP.REG_E0H.WORD = 0x00000080u;
    TSIP.REG_1CH.WORD = 0x00260000u;
    RX65NHU_func100(change_endian_long(0xe491d2dau), change_endian_long(0x66a321feu), change_endian_long(0x16dffc3cu), change_endian_long(0xbdb4f11fu));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0xe9694a49u), change_endian_long(0x17138fb4u), change_endian_long(0xcb62ec4du), change_endian_long(0x995a7215u));
    ...
    else
    {
        ...
        RX65NHU_func100(change_endian_long(0x0c29d896u), change_endian_long(0xf7b09a2cu), change_endian_long(0x1cd5c754u), change_endian_long(0x4aa9309bu));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            ...
            RX65NHU_func100(change_endian_long(0xb87007a8u), change_endian_long(0xd2e7f219u), change_endian_long(0x14179e45u), change_endian_long(0xaf1c990cu));
            ...
            RX65NHU_func101(change_endian_long(0x9faaaa4bu), change_endian_long(0xbfa983c1u), change_endian_long(0xf8d91194u), change_endian_long(0x4ea78514u));
        }
        ...
        RX65NHU_func100(change_endian_long(0xcc94176au), change_endian_long(0x371902e0u), change_endian_long(0x99b5669au), change_endian_long(0x2a4407afu));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX65NHU_func102(change_endian_long(0x0d3411d2u), change_endian_long(0xb85125aeu), change_endian_long(0xff5756bbu), change_endian_long(0xac8e86b6u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX65NHU_func102(change_endian_long(0xaf9b8cc4u), change_endian_long(0x4cdaf34cu), change_endian_long(0xc739b931u), change_endian_long(0xf6306015u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p36f_r1.prc
 *********************************************************************************************************************/
