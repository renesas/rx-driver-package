...
*******************************************************************************************************************/ /**
* @details       RX65NHU AES-256 CMAC generation/verification Update
...
void R_TSIP_Aes256CmacUpdateSub(uint32_t *InData_Text, uint32_t MAX_CNT)
{
    ...
    RX65NHU_func101(change_endian_long(0xb484dff1u), change_endian_long(0xf9c0a550u), change_endian_long(0x4067120au), change_endian_long(0x6c659bf9u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p44u.prc
 *********************************************************************************************************************/
