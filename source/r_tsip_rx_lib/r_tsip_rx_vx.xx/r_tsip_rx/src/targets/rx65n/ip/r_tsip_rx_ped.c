...
*******************************************************************************************************************/ /**
* @details       RX65NHU TLS1.3 Server Handshake Traffic Key Generation
* @param[in]     InData_Cmd
...
e_tsip_err_t R_TSIP_Tls13GenerateServerHandshakeTrafficKeySub(uint32_t *InData_Cmd, uint32_t *InData_Handshake_SecretKeyIndex, uint32_t *InData_MsgHash, uint32_t *OutData_ServerWriteKeyIndex, uint32_t *OutData_ServerFinishedKeyIndex)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0x41c79e8fu), change_endian_long(0x2bc96e89u), change_endian_long(0x8d81dc99u), change_endian_long(0x6cd3d906u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0x3d2ec8cfu), change_endian_long(0xa841126bu), change_endian_long(0x41f73e48u), change_endian_long(0x9d473066u));
    ...
    {
        RX65NHU_func100(change_endian_long(0xa34fce2du), change_endian_long(0x42afeb24u), change_endian_long(0x3d13ffd1u), change_endian_long(0xfef48821u));
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX65NHU_func100(change_endian_long(0xd3cef1b8u), change_endian_long(0x768c75f0u), change_endian_long(0xb485e53fu), change_endian_long(0x9a69cce1u));
        ...
        RX65NHU_func100(change_endian_long(0x1f7a9891u), change_endian_long(0x711b05bfu), change_endian_long(0x18141f83u), change_endian_long(0x98932850u));
        ...
        RX65NHU_func100(change_endian_long(0x5b45bc37u), change_endian_long(0x7a457b79u), change_endian_long(0xa9eec916u), change_endian_long(0x2e561842u));
        TSIP.REG_C4H.WORD = 0x400c0b0cu;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
        ...
        RX65NHU_func100(change_endian_long(0x5ae9da54u), change_endian_long(0x4ed1f58du), change_endian_long(0x89989696u), change_endian_long(0x3403e9beu));
        TSIP.REG_E0H.WORD = 0x81040280u;
        TSIP.REG_04H.WORD = 0x00000612u;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_04H.BIT.B30)
        ...
        RX65NHU_func102(change_endian_long(0x4b07d5bbu), change_endian_long(0x176cc7fau), change_endian_long(0xf444c211u), change_endian_long(0xc9757d1du));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_ped_r3.prc
 *********************************************************************************************************************/
