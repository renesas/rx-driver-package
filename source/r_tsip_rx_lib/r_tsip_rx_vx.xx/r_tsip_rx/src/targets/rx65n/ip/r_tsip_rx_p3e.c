...
*******************************************************************************************************************/ /**
* @details       RX65NHU TLS1.3 Application Traffic Key Generation for Server
* @param[in]     InData_Cmd
...
e_tsip_err_t R_TSIP_Tls13SVGenerateApplicationTrafficKeySub(uint32_t *InData_Cmd, uint32_t *InData_Handle, uint32_t *InData_Master_SecretKeyIndex, uint32_t *InData_MsgHash, uint32_t *OutData_ServerApplicationSecretKeyIndex, uint32_t *OutData_ClientApplicationSecretKeyIndex, uint32_t *OutData_ServerWriteKeyIndex, uint32_t *OutData_ClientWriteKeyIndex)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0x0b614ae2u), change_endian_long(0xe9c40e69u), change_endian_long(0x50bd4276u), change_endian_long(0x5ebc4ee3u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0x2f08fe2bu), change_endian_long(0xbc3b68cdu), change_endian_long(0x45f863c0u), change_endian_long(0x56cb368fu));
    ...
    {
        RX65NHU_func100(change_endian_long(0xfe45551bu), change_endian_long(0x13dafb43u), change_endian_long(0x63e80dfeu), change_endian_long(0x8963567cu));
        ...
        RX65NHU_func100(change_endian_long(0x2e118fddu), change_endian_long(0x35668263u), change_endian_long(0xab3b6f86u), change_endian_long(0x876fb639u));
        TSIP.REG_C4H.WORD = 0x400c0b0cu;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
        ...
        RX65NHU_func100(change_endian_long(0xec211329u), change_endian_long(0x344eb6fau), change_endian_long(0x8dca2064u), change_endian_long(0x426d99b2u));
        ...
        RX65NHU_func100(change_endian_long(0x711f26bbu), change_endian_long(0x48137333u), change_endian_long(0xdc9ce496u), change_endian_long(0x4bc102ddu));
        TSIP.REG_E0H.WORD = 0x81040280u;
        ...
        RX65NHU_func100(change_endian_long(0x16da5e69u), change_endian_long(0xf1acf334u), change_endian_long(0x0937c8eau), change_endian_long(0xb75a6a19u));
        TSIP.REG_C4H.WORD = 0x400c0b0cu;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
        ...
        RX65NHU_func100(change_endian_long(0x920e6b97u), change_endian_long(0x3f554f7fu), change_endian_long(0x68ccba69u), change_endian_long(0xfea0529du));
        TSIP.REG_E0H.WORD = 0x81040280u;
        TSIP.REG_04H.WORD = 0x00000612u;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_04H.BIT.B30)
        ...
        RX65NHU_func102(change_endian_long(0x351134b8u), change_endian_long(0x8d58de4eu), change_endian_long(0x115e479bu), change_endian_long(0x663031ebu));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p3e_r1.prc
 *********************************************************************************************************************/
