...
*******************************************************************************************************************/ /**
* @details       RX65NHU TLS1.3 0-RTT Application Write Key Generation for Server
...
e_tsip_err_t R_TSIP_Tls13SVGenerate0RttApplicationWriteKeySub(uint32_t *InData_Handle, uint32_t *InData_PreSharedKeyIndex, uint32_t *InData_MsgHash, uint32_t *OutData_ClientWriteKeyIndex)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0xfd6ca775u), change_endian_long(0x75a80472u), change_endian_long(0x1c1fa4dbu), change_endian_long(0xf52d4275u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0xf9d1e7dbu), change_endian_long(0x2359a196u), change_endian_long(0xaa7e8b4au), change_endian_long(0xf661eb84u));
    ...
    {
        RX65NHU_func100(change_endian_long(0xc572402au), change_endian_long(0xf37e4f64u), change_endian_long(0xd1a2074bu), change_endian_long(0x11bd463eu));
        ...
        RX65NHU_func100(change_endian_long(0x983747edu), change_endian_long(0x06ca0c09u), change_endian_long(0xd42f9e27u), change_endian_long(0x7e332973u));
        TSIP.REG_E0H.WORD = 0x81040280u;
        ...
        RX65NHU_func102(change_endian_long(0xbb2d4f55u), change_endian_long(0xcd7c80c5u), change_endian_long(0xe38ec723u), change_endian_long(0x997b31a7u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_pbb.prc
 *********************************************************************************************************************/
