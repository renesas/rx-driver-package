...
*******************************************************************************************************************/ /**
* @details       RX65NHU TLS1.3 Resumption/0-RTT Binder Key Generation for Server
...
e_tsip_err_t R_TSIP_Tls13SVGeneratePskBinderKeySub(uint32_t *InData_Handle, uint32_t *InData_PreSharedKeyIndex, uint32_t *OutData_BinderKeyIndex)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0x06f32ec9u), change_endian_long(0xa16e82dbu), change_endian_long(0xdd74d7c9u), change_endian_long(0x071b2f32u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0xc5c4ab3fu), change_endian_long(0xb6f74a46u), change_endian_long(0x156012d4u), change_endian_long(0x57b3d66au));
    ...
    else
    {
        ...
        RX65NHU_func070();
        RX65NHU_func100(change_endian_long(0x80336b2bu), change_endian_long(0x58c0cdc4u), change_endian_long(0xd8a033c7u), change_endian_long(0x257070c2u));
        TSIP.REG_C4H.WORD = 0x400c0b0cu;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
        ...
        RX65NHU_func100(change_endian_long(0xc0f8137eu), change_endian_long(0xe7eb5e37u), change_endian_long(0xcb94f287u), change_endian_long(0xc7fd2a42u));
        TSIP.REG_E0H.WORD = 0x81040280u;
        ...
        RX65NHU_func102(change_endian_long(0xfc4c7a35u), change_endian_long(0xf33385cdu), change_endian_long(0xbc6656eeu), change_endian_long(0xa0e35daau));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_pbe.prc
 *********************************************************************************************************************/
