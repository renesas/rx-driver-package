...
*******************************************************************************************************************/ /**
* @details       RX65NHU TLS1.3 Server Handshake Traffic Key Generation for Server
* @param[in]     InData_Cmd
...
e_tsip_err_t R_TSIP_Tls13SVGenerateServerHandshakeTrafficKeySub(uint32_t *InData_Cmd, uint32_t *InData_Handshake_SecretKeyIndex, uint32_t *InData_MsgHash, uint32_t *OutData_ServerWriteKeyIndex, uint32_t *OutData_ServerFinishedKeyIndex)
{
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0x34d2b647u), change_endian_long(0x11cf95afu), change_endian_long(0x0d4ac0b6u), change_endian_long(0xb3698f21u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0x8e28a1feu), change_endian_long(0x74fa6849u), change_endian_long(0x1441694fu), change_endian_long(0x4ec4bf00u));
    ...
    {
        RX65NHU_func100(change_endian_long(0x350b566au), change_endian_long(0xbe05c2deu), change_endian_long(0x040a9f1du), change_endian_long(0x662e8cbau));
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX65NHU_func100(change_endian_long(0x03b9cb08u), change_endian_long(0x47c643ffu), change_endian_long(0xb7441762u), change_endian_long(0xf06771c6u));
        ...
        RX65NHU_func100(change_endian_long(0x03bedeebu), change_endian_long(0x3a145556u), change_endian_long(0x059a6b0bu), change_endian_long(0xb4014f62u));
        ...
        RX65NHU_func100(change_endian_long(0x3c33c0ebu), change_endian_long(0xfcf080e2u), change_endian_long(0x91c0f22eu), change_endian_long(0x46aebd38u));
        TSIP.REG_C4H.WORD = 0x400c0b0cu;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        {
        ...
        RX65NHU_func100(change_endian_long(0x94fa6baeu), change_endian_long(0x184f1447u), change_endian_long(0xe841619au), change_endian_long(0xf04a76d5u));
        TSIP.REG_E0H.WORD = 0x81040280u;
        TSIP.REG_04H.WORD = 0x00000612u;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_04H.BIT.B30)
        ...
        RX65NHU_func102(change_endian_long(0x0d448f59u), change_endian_long(0xf82617f0u), change_endian_long(0x22b44e26u), change_endian_long(0x8f548c60u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p3a_r1.prc
 *********************************************************************************************************************/
