...
*******************************************************************************************************************/ /**
* @details       RX65NHU Update P-384 ECC Private Key
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateEccP384PrivateKeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX65NHU_func100(change_endian_long(0xf77eeb20u), change_endian_long(0xb2e08391u), change_endian_long(0xf5afee21u), change_endian_long(0x67bde55fu));
    ...
    RX65NHU_func100(change_endian_long(0xcc640135u), change_endian_long(0xb5c1a55eu), change_endian_long(0x33cc6bafu), change_endian_long(0x952c0356u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX65NHU_func100(change_endian_long(0x4932d6d7u), change_endian_long(0xc74b012bu), change_endian_long(0xa31fb6adu), change_endian_long(0x26c76009u));
    TSIP.REG_104H.WORD = 0x00000361u;
    ...
    RX65NHU_func103();
    RX65NHU_func100(change_endian_long(0xd2e2d75du), change_endian_long(0x3cc86949u), change_endian_long(0xd44468c3u), change_endian_long(0x3946084au));
    ...
    RX65NHU_func100(change_endian_long(0x40859479u), change_endian_long(0xd91e0573u), change_endian_long(0x10db210eu), change_endian_long(0x254814dbu));
    TSIP.REG_104H.WORD = 0x00000052u;
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX65NHU_func100(change_endian_long(0xbff30505u), change_endian_long(0x9aff5517u), change_endian_long(0x32729922u), change_endian_long(0x300d4de2u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0x553e03b6u), change_endian_long(0x58cb3e60u), change_endian_long(0xe8f09ad7u), change_endian_long(0xd8b6b260u));
    ...
    {
        RX65NHU_func100(change_endian_long(0xbce7434bu), change_endian_long(0x6f580377u), change_endian_long(0xe636f615u), change_endian_long(0xbd485370u));
        TSIP.REG_E0H.WORD = 0x81040000u;
        ...
        RX65NHU_func102(change_endian_long(0x011a0623u), change_endian_long(0xc89f698au), change_endian_long(0x9e6fbc71u), change_endian_long(0x571b5eb1u));
        TSIP.REG_1B4H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p2d.prc
 *********************************************************************************************************************/
