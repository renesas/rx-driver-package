...
*******************************************************************************************************************/ /**
* @details       RX65NHU AES-256 Encryption with GCM Mode Update
...
void R_TSIP_Aes256GcmEncryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX65NHU_func100(change_endian_long(0xe8b59652u), change_endian_long(0xa909eb26u), change_endian_long(0x6d3f0087u), change_endian_long(0x40a6e743u));
    ...
    RX65NHU_func101(change_endian_long(0xa69b7382u), change_endian_long(0x605c0bb7u), change_endian_long(0xe718febeu), change_endian_long(0x44b25edbu));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_p34u_r1.prc
 *********************************************************************************************************************/
