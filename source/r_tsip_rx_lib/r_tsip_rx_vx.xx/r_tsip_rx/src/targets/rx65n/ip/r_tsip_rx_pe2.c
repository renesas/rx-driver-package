...
*******************************************************************************************************************/ /**
* @details       RX65NHU RSA2048 Encryption with Public Key
...
e_tsip_err_t R_TSIP_TlsEncryptPreMasterSecretSub(uint32_t *InData_PubKey, uint32_t *InData_PreMasterSecret, uint32_t *OutData_PreMasterSecret)
{
    ...
    RX65NHU_func100(change_endian_long(0x5201d6dfu), change_endian_long(0xae8a625bu), change_endian_long(0xb02cb58du), change_endian_long(0x8b213f06u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX65NHU_func102(change_endian_long(0xfe8f59b7u), change_endian_long(0x2c5c1d53u), change_endian_long(0xd4523b93u), change_endian_long(0x53aa64c8u));
    ...
    else
    {
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX65NHU_func100(change_endian_long(0x62414fb5u), change_endian_long(0x1eff79c3u), change_endian_long(0xc48acac1u), change_endian_long(0xaf62cfe6u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX65NHU_func102(change_endian_long(0x6d6397c9u), change_endian_long(0xd9f7c7f7u), change_endian_long(0x5f362085u), change_endian_long(0x36ea7229u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        else
        {
            ...
            RX65NHU_func100(change_endian_long(0x35a98b02u), change_endian_long(0x53e7be52u), change_endian_long(0x7f9c2118u), change_endian_long(0x8de27c3fu));
            RX65NHU_func103();
            ...
            {
                RX65NHU_func100(change_endian_long(0x8cd89256u), change_endian_long(0x4193f096u), change_endian_long(0x4fb46f09u), change_endian_long(0x8cf47010u));
                RX65NHU_func103();
                TSIP.REG_104H.WORD = 0x00000052u;
                TSIP.REG_C4H.WORD = 0x01000c84u;
                /* WAIT_LOOP */
                ...
                RX65NHU_func101(change_endian_long(0xfa257436u), change_endian_long(0xa43c9e10u), change_endian_long(0x4d585d4cu), change_endian_long(0x95a711a5u));
            }
            ...
            RX65NHU_func100(change_endian_long(0x9a50a430u), change_endian_long(0x820c4187u), change_endian_long(0x49792eb0u), change_endian_long(0xc9015aacu));
            RX65NHU_func103();
            TSIP.REG_104H.WORD = 0x00000052u;
            TSIP.REG_C4H.WORD = 0x01000c84u;
            /* WAIT_LOOP */
            ...
            TSIP.REG_1CH.WORD = 0x00001800u;
            RX65NHU_func100(change_endian_long(0x3856c666u), change_endian_long(0xbd429236u), change_endian_long(0xd3c39e69u), change_endian_long(0xde18dbc1u));
            TSIP.REG_1CH.WORD = 0x00400000u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
            if (1u == (TSIP.REG_1CH.BIT.B22))
            {
                RX65NHU_func102(change_endian_long(0x9602b03eu), change_endian_long(0xf15735b2u), change_endian_long(0x24027cd8u), change_endian_long(0x735c19eeu));
                TSIP.REG_1BCH.WORD = 0x00000040u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_18H.BIT.B12)
                {
            ...
            {
                RX65NHU_func100(change_endian_long(0x3219ce5au), change_endian_long(0x22e90c68u), change_endian_long(0xdda64fb8u), change_endian_long(0xc3bd49b0u));
                ...
                TSIP.REG_28H.WORD = 0x00bf0001u;
                RX65NHU_func100(change_endian_long(0x178399e6u), change_endian_long(0xbe60bf42u), change_endian_long(0x3b19293bu), change_endian_long(0x4e66429fu));
                ...
                RX65NHU_func102(change_endian_long(0x76d3cfbdu), change_endian_long(0x1ba2c9fau), change_endian_long(0x23c2baa5u), change_endian_long(0x2ffd6c04u));
                TSIP.REG_1BCH.WORD = 0x00000040u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_18H.BIT.B12)
                {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX65NHU/RX65NHU_pe2.prc
 *********************************************************************************************************************/
#endif /* #if TSIP_TLS == 1 */
