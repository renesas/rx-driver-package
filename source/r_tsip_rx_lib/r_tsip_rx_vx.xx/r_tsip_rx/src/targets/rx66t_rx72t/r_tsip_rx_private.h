...
#include "iodefine/r_tsip_rx66t_rx72t_iodefine.h"
...
void RX66T_RX72T_function001(uint32_t ARG1, uint32_t ARG2, uint32_t ARG3, uint32_t ARG4);
void RX66T_RX72T_function002(uint32_t ARG1, uint32_t ARG2, uint32_t ARG3, uint32_t ARG4);
void RX66T_RX72T_function003(uint32_t ARG1, uint32_t ARG2, uint32_t ARG3, uint32_t ARG4);
void RX66T_RX72T_function030(void);
void RX66T_RX72T_function205(void);
void RX66T_RX72T_function206(void);
void RX66T_RX72T_function207(void);
