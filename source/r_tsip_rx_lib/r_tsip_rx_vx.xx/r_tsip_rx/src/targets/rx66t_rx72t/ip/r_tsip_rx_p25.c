...
*******************************************************************************************************************/ /**
* @details       RX66T Program integrity check
...
e_tsip_err_t R_TSIP_VerifyFirmwareMacSub(uint32_t *InData_Program, uint32_t MAX_CNT)
{
    ...
    RX66T_RX72T_function001(change_endian_long(0x8bc6288cu), change_endian_long(0x5c5f1284u), change_endian_long(0x341b1a8eu), change_endian_long(0x275c07bau));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        TSIP.REG_13CH.WORD = 0x000002ffu;
        RX66T_RX72T_function003(change_endian_long(0xb4940420u), change_endian_long(0x2e2f7795u), change_endian_long(0xc90a7c48u), change_endian_long(0xfc6a2089u));
    ...
    {
        RX66T_RX72T_function003(change_endian_long(0x06ba6113u), change_endian_long(0xd95ea5b1u), change_endian_long(0x70616f45u), change_endian_long(0xd0120957u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX66T/RX66T_p25.prc
 *********************************************************************************************************************/
TSIP_SEC_DEFAULT
