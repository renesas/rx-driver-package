...
*******************************************************************************************************************/ /**
* @details       RX66T Install 128bit AES Key
...
e_tsip_err_t R_TSIP_GenerateAes128KeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX66T_RX72T_function001(change_endian_long(0x7ecd9a3eu), change_endian_long(0x4048c595u), change_endian_long(0x22b2ffc0u), change_endian_long(0x5678dad7u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX66T_RX72T_function003(change_endian_long(0x817d9110u), change_endian_long(0xab5262a5u), change_endian_long(0x7504dc55u), change_endian_long(0x89f0b0a7u));
    ...
    {
        RX66T_RX72T_function001(change_endian_long(0xea1e4d2fu), change_endian_long(0x9862ab0bu), change_endian_long(0x538a9124u), change_endian_long(0x15d304ccu));
        ...
        RX66T_RX72T_function001(change_endian_long(0x40cbcc8bu), change_endian_long(0x565533feu), change_endian_long(0xdb051b89u), change_endian_long(0x22fb8277u));
        ...
        RX66T_RX72T_function001(change_endian_long(0x25d36235u), change_endian_long(0x6522a9aeu), change_endian_long(0x594c781fu), change_endian_long(0xd8015021u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX66T_RX72T_function001(change_endian_long(0x8c0f9e71u), change_endian_long(0x4c50cdfdu), change_endian_long(0xd9b20576u), change_endian_long(0xbd02c0d0u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        TSIP.REG_100H.WORD = change_endian_long(0x00000000u);
        RX66T_RX72T_function001(change_endian_long(0x3d3319cdu), change_endian_long(0x54c45401u), change_endian_long(0xaf2972f4u), change_endian_long(0xa5c3b76eu));
        ...
        RX66T_RX72T_function001(change_endian_long(0x46eaad75u), change_endian_long(0xf9331bc8u), change_endian_long(0x895c19c9u), change_endian_long(0xf4b21be1u));
        TSIP.REG_104H.WORD = 0x00000051u;
        TSIP.REG_A4H.WORD = 0x01000684u;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX66T_RX72T_function001(change_endian_long(0x6c61e987u), change_endian_long(0x4f800ab9u), change_endian_long(0xf198c317u), change_endian_long(0x9eb3cafbu));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX66T_RX72T_function003(change_endian_long(0x398baebeu), change_endian_long(0x5b57df54u), change_endian_long(0xed5a897au), change_endian_long(0x983fb4d8u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX66T_RX72T_function001(change_endian_long(0x0caade67u), change_endian_long(0x8918baf8u), change_endian_long(0xad3dfca2u), change_endian_long(0x5eb7251cu));
            TSIP.REG_E0H.WORD = 0x81040000u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
            ...
            RX66T_RX72T_function003(change_endian_long(0xf35b15f4u), change_endian_long(0x901b2bdeu), change_endian_long(0xf229dfacu), change_endian_long(0xbc7a036fu));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX66T/RX66T_p04_r1.prc
 *********************************************************************************************************************/
TSIP_SEC_DEFAULT
