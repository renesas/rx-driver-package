...
*******************************************************************************************************************/ /**
* @details       RX66T Update 128bit AES Key
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateAes128KeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX66T_RX72T_function001(change_endian_long(0xbf7211cdu), change_endian_long(0x28e62d5fu), change_endian_long(0x82c45c16u), change_endian_long(0xcba7b5e5u));
    ...
    RX66T_RX72T_function001(change_endian_long(0x4e7e3598u), change_endian_long(0x033f9960u), change_endian_long(0x2776f0a0u), change_endian_long(0xacbfa224u));
    ...
    RX66T_RX72T_function001(change_endian_long(0xefc7763au), change_endian_long(0xd9fc1b36u), change_endian_long(0x4c384f13u), change_endian_long(0xcc4645e4u));
    ...
    TSIP.REG_100H.WORD = change_endian_long(0x00000000u);
    RX66T_RX72T_function001(change_endian_long(0x9bb33780u), change_endian_long(0x838486fcu), change_endian_long(0xbaa33250u), change_endian_long(0x7df598e0u));
    ...
    RX66T_RX72T_function001(change_endian_long(0x56e4c182u), change_endian_long(0x544ada6bu), change_endian_long(0x52c10140u), change_endian_long(0xf6bf6952u));
    TSIP.REG_104H.WORD = 0x00000051u;
    TSIP.REG_A4H.WORD = 0x01000684u;
    /* WAIT_LOOP */
    while (1u != TSIP.REG_104H.BIT.B31)
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX66T_RX72T_function001(change_endian_long(0xcb9c77c6u), change_endian_long(0x486d523au), change_endian_long(0x21b043a2u), change_endian_long(0x6c801880u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX66T_RX72T_function003(change_endian_long(0x6c5f5dedu), change_endian_long(0x44e00d02u), change_endian_long(0xc3f6eba2u), change_endian_long(0xbc89857bu));
    ...
    {
        RX66T_RX72T_function001(change_endian_long(0x3d1e7eddu), change_endian_long(0x2d609a6du), change_endian_long(0xc5417951u), change_endian_long(0x50f8b158u));
        TSIP.REG_E0H.WORD = 0x81040000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        ...
        RX66T_RX72T_function003(change_endian_long(0x185b18acu), change_endian_long(0xbc7ad524u), change_endian_long(0x187ca008u), change_endian_long(0x27c0e5e2u));
        TSIP.REG_1B4H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX66T/RX66T_p91.prc
 *********************************************************************************************************************/
