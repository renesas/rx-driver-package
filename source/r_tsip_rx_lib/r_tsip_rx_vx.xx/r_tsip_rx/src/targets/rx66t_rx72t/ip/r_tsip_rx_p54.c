...
*******************************************************************************************************************/ /**
* @details       RX66T AES-256 CMAC generation/verification Update
...
void R_TSIP_Aes256CmacUpdateSub(uint32_t *InData_Text, uint32_t MAX_CNT)
{
    ...
    RX66T_RX72T_function002(change_endian_long(0x01f23ec3u), change_endian_long(0xe25007fcu), change_endian_long(0x231b04b9u), change_endian_long(0x89b8e45du));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX66T/RX66T_p54.prc
 *********************************************************************************************************************/
