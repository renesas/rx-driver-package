...
*******************************************************************************************************************/ /**
* @details       RX66T AES-128 Encryption with CCM Mode Update
...
void R_TSIP_Aes128CcmEncryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX66T_RX72T_function001(change_endian_long(0x4f7035b9u), change_endian_long(0xd4b83a4eu), change_endian_long(0xeadffd93u), change_endian_long(0x15ea6cf6u));
    ...
    RX66T_RX72T_function002(change_endian_long(0x84b4e623u), change_endian_long(0xa8cd2194u), change_endian_long(0xd61bd671u), change_endian_long(0xe75aecadu));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX66T/RX66T_p71.prc
 *********************************************************************************************************************/
