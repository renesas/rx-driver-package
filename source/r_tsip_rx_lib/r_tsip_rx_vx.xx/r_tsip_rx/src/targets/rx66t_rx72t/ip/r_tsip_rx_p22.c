...
*******************************************************************************************************************/ /**
* @details       RX66T GHASH calculation
* @param[in]     InData_HV
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_Ghash(uint32_t *InData_HV, uint32_t *InData_IV, uint32_t *InData_Text, uint32_t *OutData_DataT, uint32_t MAX_CNT)
{
    ...
    RX66T_RX72T_function001(change_endian_long(0x4276c350u), change_endian_long(0x6017fa35u), change_endian_long(0x146b190eu), change_endian_long(0xadebd469u));
    ...
    RX66T_RX72T_function003(change_endian_long(0xf8e4debau), change_endian_long(0x0467db1fu), change_endian_long(0x36119ec0u), change_endian_long(0x280c6caeu));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX66T/RX66T_p22.prc
 *********************************************************************************************************************/
