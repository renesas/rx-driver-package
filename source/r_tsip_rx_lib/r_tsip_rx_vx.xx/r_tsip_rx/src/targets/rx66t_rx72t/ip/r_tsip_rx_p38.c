...
*******************************************************************************************************************/ /**
* @details       RX66T AES-128 Decryption with GCM Mode Update
...
void R_TSIP_Aes128GcmDecryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX66T_RX72T_function001(change_endian_long(0xde95ee6au), change_endian_long(0xe642ed40u), change_endian_long(0xf5cd9bfbu), change_endian_long(0x352fbfa3u));
    ...
    RX66T_RX72T_function002(change_endian_long(0x5142b3e6u), change_endian_long(0xe7c9c6c5u), change_endian_long(0xffac34a4u), change_endian_long(0xfa25498bu));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX66T/RX66T_p38.prc
 *********************************************************************************************************************/
