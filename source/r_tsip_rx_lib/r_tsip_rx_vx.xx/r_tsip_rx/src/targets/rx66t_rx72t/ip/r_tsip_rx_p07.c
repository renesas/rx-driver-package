...
*******************************************************************************************************************/ /**
* @details       RX66T Create 256bit AES Key
...
e_tsip_err_t R_TSIP_GenerateAes256RandomKeyIndexSub(uint32_t *OutData_KeyIndex)
{
    ...
    RX66T_RX72T_function001(change_endian_long(0xe511c9bfu), change_endian_long(0x2d65d79bu), change_endian_long(0xb311fc2au), change_endian_long(0x9dacaab0u));
    ...
    TSIP.REG_100H.WORD = change_endian_long(0x00000000u);
    RX66T_RX72T_function001(change_endian_long(0xd89b2ddau), change_endian_long(0xf5f58109u), change_endian_long(0x5ce5d4eeu), change_endian_long(0x8660f025u));
    ...
    RX66T_RX72T_function001(change_endian_long(0x7c198ba0u), change_endian_long(0x4b223923u), change_endian_long(0xa39254abu), change_endian_long(0xb86549b1u));
    TSIP.REG_104H.WORD = 0x00000251u;
    TSIP.REG_A4H.WORD = 0x0020363cu;
    /* WAIT_LOOP */
    while (1u != TSIP.REG_104H.BIT.B31)
    ...
    TSIP.REG_100H.WORD = change_endian_long(0x00000000u);
    RX66T_RX72T_function001(change_endian_long(0x8dc7b336u), change_endian_long(0x62540b11u), change_endian_long(0x5f83f695u), change_endian_long(0xa5e4cbb0u));
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX66T_RX72T_function001(change_endian_long(0x3065b140u), change_endian_long(0x626f8d01u), change_endian_long(0x0c75938cu), change_endian_long(0xcb0d2df5u));
    ...
    RX66T_RX72T_function003(change_endian_long(0xa521590fu), change_endian_long(0x89dd8ac6u), change_endian_long(0x5b626918u), change_endian_long(0xf3852198u));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX66T/RX66T_p07.prc
 *********************************************************************************************************************/
