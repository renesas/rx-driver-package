...
*******************************************************************************************************************/ /**
* @details       RX66T TSIP Selftest Function1
* @retval        TSIP_SUCCESS
...
e_tsip_err_t R_TSIP_SelfCheck1Sub(void)
{
    ...
    RX66T_RX72T_function002(0x383645d1u, 0xaa31046bu, 0xb7dab884u, 0x141c2c8bu);
    ...
    TSIP.REG_100H.WORD = 0x596599d4u;
    TSIP.REG_100H.WORD = 0x24909fd0u;
    TSIP.REG_100H.WORD = 0xbe13091au;
    TSIP.REG_100H.WORD = 0x271d1631u;
    RX66T_RX72T_function002(0x3e2a0712u, 0x2a526dc0u, 0x79dea78du, 0xd6a8dd81u);
    RX66T_RX72T_function001(0xbaf16dd4u, 0x0c64b0a9u, 0x4769b5adu, 0x26ecc73bu);
    ...
    else
    {
        ...
        RX66T_RX72T_function003(0x0546cce5u, 0x4ea3313du, 0xca3d07fbu, 0x8a2747c9u);
...
/**********************************************************************************************************************
 End of function ./input_dir/RX66T/RX66T_p01.prc
 *********************************************************************************************************************/
TSIP_SEC_DEFAULT
