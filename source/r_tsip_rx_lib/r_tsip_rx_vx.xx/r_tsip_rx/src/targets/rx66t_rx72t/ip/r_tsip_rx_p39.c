...
*******************************************************************************************************************/ /**
* @details       RX66T AES-128 Decryption with GCM Mode Final
...
e_tsip_err_t R_TSIP_Aes128GcmDecryptFinalSub(uint32_t *InData_Text, uint32_t *InData_DataT, uint32_t *InData_DataALen, uint32_t *InData_TextLen, uint32_t *InData_DataTLen, uint32_t *OutData_Text)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX66T_RX72T_function001(change_endian_long(0x5d709b51u), change_endian_long(0xc5a56318u), change_endian_long(0x2cd3d800u), change_endian_long(0x33e66eaeu));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        TSIP.REG_1CH.WORD = 0x002d0000u;
        RX66T_RX72T_function001(change_endian_long(0xd0fd761bu), change_endian_long(0xe5640b9cu), change_endian_long(0x4688fcc7u), change_endian_long(0x1be0bd83u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            ...
            RX66T_RX72T_function002(change_endian_long(0x339eb031u), change_endian_long(0x90d38498u), change_endian_long(0x7f5320dfu), change_endian_long(0x42f1b0eau));
        }
        else
        {
            RX66T_RX72T_function002(change_endian_long(0x22e6d726u), change_endian_long(0xbf2360afu), change_endian_long(0xe9fdfebbu), change_endian_long(0x11280b9fu));
        }
        RX66T_RX72T_function003(change_endian_long(0x62a1f44fu), change_endian_long(0xf34e3638u), change_endian_long(0xf84548a5u), change_endian_long(0x432d26fcu));
    ...
    else
    {
        ...
        TSIP.REG_E0H.WORD = 0x00000080u;
        TSIP.REG_1CH.WORD = 0x00260000u;
        RX66T_RX72T_function001(change_endian_long(0x33aeb33au), change_endian_long(0x3e81ee85u), change_endian_long(0xbf4c8a94u), change_endian_long(0x02cfca8fu));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX66T_RX72T_function003(change_endian_long(0x8ebadbf3u), change_endian_long(0x15bd5f9eu), change_endian_long(0x260ff66cu), change_endian_long(0xdd34664eu));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        else
        {
            ...
            RX66T_RX72T_function001(change_endian_long(0x38558ec0u), change_endian_long(0xfd18a4deu), change_endian_long(0xec89b7c0u), change_endian_long(0x6171c922u));
            TSIP.REG_1CH.WORD = 0x00400000u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
            if (1u == (TSIP.REG_1CH.BIT.B22))
            {
                RX66T_RX72T_function001(change_endian_long(0x5461cb52u), change_endian_long(0x510e000cu), change_endian_long(0x7730c982u), change_endian_long(0x3a94dd4cu));
                ...
                RX66T_RX72T_function002(change_endian_long(0xd173c084u), change_endian_long(0x9bebb6cbu), change_endian_long(0xa7591006u), change_endian_long(0x22b514b4u));
            }
            ...
            TSIP.REG_1D0H.WORD = 0x00000000u;
            RX66T_RX72T_function001(change_endian_long(0x925475c9u), change_endian_long(0x343561cfu), change_endian_long(0x3e8865ceu), change_endian_long(0x9fa5974du));
            TSIP.REG_1CH.WORD = 0x00400000u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
            if (1u == (TSIP.REG_1CH.BIT.B22))
            {
                RX66T_RX72T_function003(change_endian_long(0xe8fd9845u), change_endian_long(0x20fcfbfeu), change_endian_long(0xc958349cu), change_endian_long(0x26fac8c4u));
                TSIP.REG_1BCH.WORD = 0x00000040u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_18H.BIT.B12)
                {
            ...
            {
                RX66T_RX72T_function003(change_endian_long(0xea8f21b8u), change_endian_long(0x563a0434u), change_endian_long(0x0299ab5eu), change_endian_long(0xeefd4ea1u));
                TSIP.REG_1BCH.WORD = 0x00000040u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_18H.BIT.B12)
                {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX66T/RX66T_p39.prc
 *********************************************************************************************************************/
