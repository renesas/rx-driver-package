...
*******************************************************************************************************************/ /**
* @details       RX66T AES-256 Encryption with CCM Mode Update
...
void R_TSIP_Aes256CcmEncryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX66T_RX72T_function001(change_endian_long(0x9a2398dcu), change_endian_long(0x1269bc90u), change_endian_long(0xc738c168u), change_endian_long(0x83529bc9u));
    ...
    RX66T_RX72T_function002(change_endian_long(0x4bb38c0au), change_endian_long(0x35d856d5u), change_endian_long(0xa4c44b2eu), change_endian_long(0x7911373bu));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX66T/RX66T_p77.prc
 *********************************************************************************************************************/
