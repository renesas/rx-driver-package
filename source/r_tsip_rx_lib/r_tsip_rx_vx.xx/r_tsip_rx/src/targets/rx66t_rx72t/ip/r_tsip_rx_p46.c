...
*******************************************************************************************************************/ /**
* @details       RX66T AES-256 Decryption with GCM Mode Update
...
void R_TSIP_Aes256GcmDecryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX66T_RX72T_function001(change_endian_long(0xf5c1abbcu), change_endian_long(0xe65de4b8u), change_endian_long(0xa85cbb07u), change_endian_long(0x95052b5cu));
    ...
    RX66T_RX72T_function002(change_endian_long(0x23ccb49au), change_endian_long(0xda4050f4u), change_endian_long(0xb922ef35u), change_endian_long(0x22d6c4c0u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX66T/RX66T_p46.prc
 *********************************************************************************************************************/
