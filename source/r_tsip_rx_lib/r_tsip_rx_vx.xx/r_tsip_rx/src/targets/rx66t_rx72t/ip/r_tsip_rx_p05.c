...
*******************************************************************************************************************/ /**
* @details       RX66T Install 256bit AES Key
...
e_tsip_err_t R_TSIP_GenerateAes256KeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX66T_RX72T_function001(change_endian_long(0x3d5e4f05u), change_endian_long(0x940dee8cu), change_endian_long(0x32530e14u), change_endian_long(0x5a2eba84u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX66T_RX72T_function003(change_endian_long(0x8c62132eu), change_endian_long(0x5f0d5406u), change_endian_long(0xba03ba94u), change_endian_long(0xd5e217deu));
    ...
    {
        RX66T_RX72T_function001(change_endian_long(0xc22dbcacu), change_endian_long(0xe003fbf5u), change_endian_long(0xe50c2505u), change_endian_long(0x6cf0eb07u));
        ...
        RX66T_RX72T_function001(change_endian_long(0xb5c2eb2du), change_endian_long(0xfa745795u), change_endian_long(0xd177e2ccu), change_endian_long(0xde9a204du));
        ...
        RX66T_RX72T_function001(change_endian_long(0x78522d98u), change_endian_long(0x18e9c086u), change_endian_long(0x36e7c7f0u), change_endian_long(0xc0d5a368u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX66T_RX72T_function001(change_endian_long(0xdb848437u), change_endian_long(0xa649c8a8u), change_endian_long(0x8b620059u), change_endian_long(0xe3ed7bd7u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        TSIP.REG_100H.WORD = change_endian_long(0x00000000u);
        RX66T_RX72T_function001(change_endian_long(0x9c0c33eeu), change_endian_long(0x76efdf50u), change_endian_long(0x18d869d8u), change_endian_long(0x7371a38bu));
        ...
        RX66T_RX72T_function001(change_endian_long(0x6dbc9c5bu), change_endian_long(0xfbb40211u), change_endian_long(0xf2932200u), change_endian_long(0x7baffe02u));
        TSIP.REG_104H.WORD = 0x00000361u;
        TSIP.REG_A4H.WORD = 0x00d049adu;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        ...
        RX66T_RX72T_function001(change_endian_long(0x3f9232e4u), change_endian_long(0x422e6084u), change_endian_long(0x40f3d04fu), change_endian_long(0x7a1582deu));
        TSIP.REG_104H.WORD = 0x00000051u;
        TSIP.REG_A4H.WORD = 0x01000684u;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX66T_RX72T_function001(change_endian_long(0x42d19653u), change_endian_long(0x88f8688eu), change_endian_long(0xa5e4c799u), change_endian_long(0x1005f831u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX66T_RX72T_function003(change_endian_long(0x3649ec73u), change_endian_long(0xc83b68efu), change_endian_long(0x00612950u), change_endian_long(0xf1a73c20u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX66T_RX72T_function001(change_endian_long(0x3e06ebf5u), change_endian_long(0x06cc4570u), change_endian_long(0xba9e93b5u), change_endian_long(0xabb82314u));
            TSIP.REG_E0H.WORD = 0x81040000u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
            ...
            RX66T_RX72T_function003(change_endian_long(0xba356326u), change_endian_long(0xf05d2373u), change_endian_long(0xf3f12e8cu), change_endian_long(0x2ef11e8bu));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX66T/RX66T_p05_r2.prc
 *********************************************************************************************************************/
