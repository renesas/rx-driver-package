...
*******************************************************************************************************************/ /**
* @details       RX231HU AES-256 Decryption with GCM Mode Update
...
void R_TSIP_Aes256GcmDecryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX231_RX23W_function001(change_endian_long(0x09200a48u), change_endian_long(0x6eeb6ec8u), change_endian_long(0xba478c59u), change_endian_long(0xc2ab267du));
    TSIP.REG_104H.WORD = 0x000000b5u;
    ...
    RX231_RX23W_function002(change_endian_long(0xad2b4ab8u), change_endian_long(0xda44a668u), change_endian_long(0xf9b85f2cu), change_endian_long(0xc3d29d32u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX231HU/RX231HU_p46.prc
 *********************************************************************************************************************/
