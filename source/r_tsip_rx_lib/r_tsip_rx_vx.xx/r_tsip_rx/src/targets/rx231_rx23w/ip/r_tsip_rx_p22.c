...
*******************************************************************************************************************/ /**
* @details       RX231HU GHASH calculation
* @param[in]     InData_HV
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_Ghash(uint32_t *InData_HV, uint32_t *InData_IV, uint32_t *InData_Text, uint32_t *OutData_DataT, uint32_t MAX_CNT)
{
    ...
    RX231_RX23W_function001(change_endian_long(0x025afb7au), change_endian_long(0xa812227fu), change_endian_long(0x53e63646u), change_endian_long(0xe3b9e052u));
    ...
    RX231_RX23W_function003(change_endian_long(0x5ec04d85u), change_endian_long(0x69614aaeu), change_endian_long(0x9a6c4205u), change_endian_long(0x449903a8u));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX231HU/RX231HU_p22.prc
 *********************************************************************************************************************/
