...
*******************************************************************************************************************/ /**
* @details       RX231HU Program integrity check
...
e_tsip_err_t R_TSIP_VerifyFirmwareMacSub(uint32_t *InData_Program, uint32_t MAX_CNT)
{
    ...
    firm_mac_read(tmp);
    TSIP.REG_100H.WORD = tmp[0];
    TSIP.REG_100H.WORD = tmp[1];
    TSIP.REG_100H.WORD = tmp[2];
    TSIP.REG_100H.WORD = tmp[3];
    RX231_RX23W_function001(change_endian_long(0xf9808309u), change_endian_long(0x2f54b803u), change_endian_long(0xe6a9a113u), change_endian_long(0x1311e8d6u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        TSIP.REG_13CH.WORD = 0x000002ffu;
        RX231_RX23W_function003(change_endian_long(0xb4dd95feu), change_endian_long(0x558df0a4u), change_endian_long(0xd7675e18u), change_endian_long(0xa3173121u));
    ...
    {
        RX231_RX23W_function003(change_endian_long(0x8e6a25b0u), change_endian_long(0xdabdbb78u), change_endian_long(0x70e1b01eu), change_endian_long(0x481e6dc6u));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX231HU/RX231HU_p25.prc
 *********************************************************************************************************************/
TSIP_SEC_DEFAULT
