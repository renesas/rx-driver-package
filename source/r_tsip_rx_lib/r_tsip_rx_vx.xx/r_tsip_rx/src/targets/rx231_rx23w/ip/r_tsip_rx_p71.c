...
*******************************************************************************************************************/ /**
* @details       RX231HU AES-128 Encryption with CCM Mode Update
...
void R_TSIP_Aes128CcmEncryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX231_RX23W_function001(change_endian_long(0xe899879eu), change_endian_long(0x2a39dea1u), change_endian_long(0x036cc500u), change_endian_long(0x9ee65a05u));
    TSIP.REG_104H.WORD = 0x000000b1u;
    TSIP.REG_A4H.WORD = 0x00e006beu;
    ...
    RX231_RX23W_function002(change_endian_long(0x5f213e90u), change_endian_long(0x535220ddu), change_endian_long(0xe2f2fda8u), change_endian_long(0x87e2ca35u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX231HU/RX231HU_p71.prc
 *********************************************************************************************************************/
