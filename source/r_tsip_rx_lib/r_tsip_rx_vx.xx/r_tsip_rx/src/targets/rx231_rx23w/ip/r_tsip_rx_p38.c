...
*******************************************************************************************************************/ /**
* @details       RX231HU AES-128 Decryption with GCM Mode Update
...
void R_TSIP_Aes128GcmDecryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX231_RX23W_function001(change_endian_long(0x5e30b03eu), change_endian_long(0x691a9eeeu), change_endian_long(0xdc07025eu), change_endian_long(0xaa1d2203u));
    ...
    RX231_RX23W_function002(change_endian_long(0x155d0219u), change_endian_long(0x73e6b832u), change_endian_long(0x118e6d02u), change_endian_long(0xbe1db770u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX231HU/RX231HU_p38.prc
 *********************************************************************************************************************/
