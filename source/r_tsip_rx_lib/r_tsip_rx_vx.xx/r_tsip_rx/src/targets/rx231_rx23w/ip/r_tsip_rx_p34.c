...
*******************************************************************************************************************/ /**
* @details       RX231HU AES-128 Encryption GCM Mode Final
...
e_tsip_err_t R_TSIP_Aes128GcmEncryptFinalSub(uint32_t *InData_Text, uint32_t *InData_DataALen, uint32_t *InData_TextLen, uint32_t *OutData_Text, uint32_t *OutData_DataT)
{
    ...
    RX231_RX23W_function001(change_endian_long(0x04dac39fu), change_endian_long(0x7d1b30aau), change_endian_long(0xf4880079u), change_endian_long(0xab996355u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX231_RX23W_function003(change_endian_long(0x88b89675u), change_endian_long(0x1595a5cau), change_endian_long(0x4712981eu), change_endian_long(0x9ebb61e6u));
    ...
    else
    {
        ...
        RX231_RX23W_function001(change_endian_long(0xfb5c9c09u), change_endian_long(0x580fb22au), change_endian_long(0x0d92194cu), change_endian_long(0x5395ac08u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX231_RX23W_function001(change_endian_long(0x6f08b2dau), change_endian_long(0x932e2a98u), change_endian_long(0xa565d8d9u), change_endian_long(0x347581cdu));
            ...
            RX231_RX23W_function002(change_endian_long(0x0b68533eu), change_endian_long(0x75509ae9u), change_endian_long(0xc483a753u), change_endian_long(0xd172f2aau));
        }
        RX231_RX23W_function001(change_endian_long(0x9f72eb70u), change_endian_long(0x95f18b06u), change_endian_long(0x61f8c036u), change_endian_long(0x19dfb42cu));
        ...
        RX231_RX23W_function003(change_endian_long(0xb7cb83ceu), change_endian_long(0x50f893b8u), change_endian_long(0x58456754u), change_endian_long(0xc51fcdbdu));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX231HU/RX231HU_p34.prc
 *********************************************************************************************************************/
