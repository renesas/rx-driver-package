...
*******************************************************************************************************************/ /**
* @details       RX231HU AES-256 CMAC generation/verification Update
...
void R_TSIP_Aes256CmacUpdateSub(uint32_t *InData_Text, uint32_t MAX_CNT)
{
    ...
    RX231_RX23W_function002(change_endian_long(0x1a383ac6u), change_endian_long(0xd5a49b8du), change_endian_long(0x89378086u), change_endian_long(0x8c6b2832u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX231HU/RX231HU_p54.prc
 *********************************************************************************************************************/
