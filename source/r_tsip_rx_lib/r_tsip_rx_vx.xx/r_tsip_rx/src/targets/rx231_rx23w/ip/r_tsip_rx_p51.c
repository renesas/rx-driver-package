...
*******************************************************************************************************************/ /**
* @details       RX231HU AES-128 CMAC generation/verification Update
...
void R_TSIP_Aes128CmacUpdateSub(uint32_t *InData_Text, uint32_t MAX_CNT)
{
    ...
    RX231_RX23W_function002(change_endian_long(0x88d0b75cu), change_endian_long(0x4eccf5ffu), change_endian_long(0x17aa009au), change_endian_long(0x9cf9ffe1u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX231HU/RX231HU_p51.prc
 *********************************************************************************************************************/
