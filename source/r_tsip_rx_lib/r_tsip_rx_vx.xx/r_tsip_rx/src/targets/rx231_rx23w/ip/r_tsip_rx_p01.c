...
*******************************************************************************************************************/ /**
* @details       RX231HU TSIP Selftest Function1
* @retval        TSIP_SUCCESS
...
e_tsip_err_t R_TSIP_SelfCheck1Sub(void)
{
    ...
    TSIP.REG_88H.WORD = 0x00008004u;
    TSIP.REG_104H.WORD = 0x00000351u;
    RX231_RX23W_function002(0xa772e576u, 0x2ad139f6u, 0xd080b395u, 0x5c2f3499u);
    ...
    TSIP.REG_100H.WORD = 0x2b862307u;
    TSIP.REG_100H.WORD = 0x7ace7bf4u;
    TSIP.REG_100H.WORD = 0x9b4aa6e7u;
    TSIP.REG_100H.WORD = 0x083772e6u;
    RX231_RX23W_function002(0x93367623u, 0x0e651630u, 0xc6044922u, 0xf4aaadb0u);
    RX231_RX23W_function001(0xb7703b63u, 0x4963bf04u, 0xea7822c6u, 0xd2b2e39fu);
    ...
    else
    {
        ...
        RX231_RX23W_function003(0x6cd089bau, 0x440e32ebu, 0x23cf0de9u, 0x2a645c5eu);
...
/**********************************************************************************************************************
 End of function ./input_dir/RX231HU/RX231HU_p01.prc
 *********************************************************************************************************************/
TSIP_SEC_DEFAULT
