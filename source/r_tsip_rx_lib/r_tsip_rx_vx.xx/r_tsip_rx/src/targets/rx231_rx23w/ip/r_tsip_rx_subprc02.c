...
*******************************************************************************************************************/ /**
* @details       RX231HU random number inspection subprocedure 02
* @note          None
*/
void R_TSIP_SelfCheck2SubSub(void)
{
    ...
    TSIP.REG_A4H.WORD = 0x40083a8cu;
    /* WAIT_LOOP */
    while (1u != TSIP.REG_104H.BIT.B31)
    {
        /* waiting */
    }
    TSIP.REG_100H.WORD = 0x63a83a19u;
    TSIP.REG_104H.WORD = 0x00000051u;
    TSIP.REG_A4H.WORD = 0x00010804u;
    /* WAIT_LOOP */
    while (1u != TSIP.REG_104H.BIT.B31)
    {
        /* waiting */
    ...
    TSIP.REG_1D0H.WORD = 0x00000000u;
    TSIP.REG_ECH.WORD = 0x00400003u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    TSIP.REG_A4H.WORD = 0xc0200c1eu;
    for(iLoop=0; iLoop<1024; iLoop=iLoop+1)
    {
        TSIP.REG_E0H.WORD = 0x80010020u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        TSIP.REG_00H.WORD = 0x00008407u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_00H.BIT.B25)
        {
            /* waiting */
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        TSIP.REG_ECH.WORD = 0x000034c1u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        for(jLoop=0; jLoop<32; jLoop=jLoop+1)
        {
            TSIP.REG_ECH.WORD = 0x0c016cc6u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
            TSIP.REG_ECH.WORD = 0x100008c7u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
        }
        ...
        for(jLoop=0; jLoop<8; jLoop=jLoop+1)
        {
            ...
            {
                TSIP.REG_ECH.WORD = 0x010038a0u;
                TSIP.REG_1D0H.WORD = 0x00000000u;
                TSIP.REG_ECH.WORD = 0x38000844u;
                TSIP.REG_1D0H.WORD = 0x00000000u;
                TSIP.REG_ECH.WORD = 0x10002ca0u;
                TSIP.REG_1D0H.WORD = 0x00000000u;
                TSIP.REG_ECH.WORD = 0x01003ca0u;
                TSIP.REG_1D0H.WORD = 0x00000000u;
                TSIP.REG_ECH.WORD = 0x00002403u;
                TSIP.REG_1D0H.WORD = 0x00000000u;
                TSIP.REG_ECH.WORD = 0x00002c80u;
                TSIP.REG_1D0H.WORD = 0x00000000u;
            }
            TSIP.REG_ECH.WORD = 0x00046821u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
        }
    }
    /* WAIT_LOOP */
    ...
    for(iLoop=0; iLoop<16; iLoop=iLoop+1)
    {
        TSIP.REG_ECH.WORD = 0x010038a0u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        TSIP.REG_ECH.WORD = 0x30002885u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        TSIP.REG_ECH.WORD = 0x00070020u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        TSIP.REG_ECH.WORD = 0x00005023u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        TSIP.REG_ECH.WORD = 0x00000080u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        TSIP.REG_ECH.WORD = 0x000024c5u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
...
/**********************************************************************************************************************
 End of function ./input_dir/RX231HU/RX231HU_subprc02.prc
 *********************************************************************************************************************/
TSIP_SEC_DEFAULT
