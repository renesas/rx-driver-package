...
*******************************************************************************************************************/ /**
* @details       RX231HU AES-256 Encryption with CCM Mode Update
...
void R_TSIP_Aes256CcmEncryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX231_RX23W_function001(change_endian_long(0x165424ceu), change_endian_long(0x02a4d32eu), change_endian_long(0x91b0affbu), change_endian_long(0xdf3993aau));
    TSIP.REG_104H.WORD = 0x000000b1u;
    TSIP.REG_B0H.WORD = 0x40000000u;
    TSIP.REG_A4H.WORD = 0x00e086beu;
    ...
    RX231_RX23W_function002(change_endian_long(0x5f37f086u), change_endian_long(0xbeea4551u), change_endian_long(0x1a8d9463u), change_endian_long(0x406c53e8u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX231HU/RX231HU_p77.prc
 *********************************************************************************************************************/
