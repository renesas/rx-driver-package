...
*******************************************************************************************************************/ /**
* @details       RX231HU Update 128bit AES Key
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateAes128KeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    TSIP.REG_84H.WORD = 0x00009101u;
    TSIP.REG_108H.WORD = 0x00000000u;
    RX231_RX23W_function001(change_endian_long(0xf6030a97u), change_endian_long(0x1a35ebeau), change_endian_long(0x775c941bu), change_endian_long(0xc8dab299u));
    ...
    RX231_RX23W_function001(change_endian_long(0x0c891c2fu), change_endian_long(0x69ead928u), change_endian_long(0xf7178d0au), change_endian_long(0x71ad32d4u));
    ...
    RX231_RX23W_function001(change_endian_long(0x4c9462bfu), change_endian_long(0xfc1d62a2u), change_endian_long(0xad07be79u), change_endian_long(0x398bceacu));
    ...
    TSIP.REG_100H.WORD = change_endian_long(0x00000000u);
    RX231_RX23W_function001(change_endian_long(0x9532550cu), change_endian_long(0xd3ad8c90u), change_endian_long(0x41c81505u), change_endian_long(0x7abd5867u));
    ...
    RX231_RX23W_function001(change_endian_long(0x7994e7b1u), change_endian_long(0xb77d1b62u), change_endian_long(0xb58a9aeeu), change_endian_long(0xc21c7a82u));
    TSIP.REG_104H.WORD = 0x00000051u;
    TSIP.REG_A4H.WORD = 0x01000684u;
    /* WAIT_LOOP */
    while (1u != TSIP.REG_104H.BIT.B31)
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX231_RX23W_function001(change_endian_long(0x13e573e0u), change_endian_long(0x467e887cu), change_endian_long(0x0cbf95eeu), change_endian_long(0x6eb9f37cu));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX231_RX23W_function003(change_endian_long(0xb440dcc5u), change_endian_long(0x814126aeu), change_endian_long(0xccfa076cu), change_endian_long(0x7ef0391au));
    ...
    {
        RX231_RX23W_function001(change_endian_long(0x0d9bfee1u), change_endian_long(0xcca45fafu), change_endian_long(0x79195f97u), change_endian_long(0xe8495b9cu));
        TSIP.REG_E0H.WORD = 0x81040000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        ...
        RX231_RX23W_function003(change_endian_long(0x996b4afdu), change_endian_long(0x10e9ca5eu), change_endian_long(0x69b80305u), change_endian_long(0x88baacc3u));
        TSIP.REG_1B4H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX231HU/RX231HU_p91.prc
 *********************************************************************************************************************/
