...
*******************************************************************************************************************/ /**
* @details       RX231HU Create 128bit AES Key
...
e_tsip_err_t R_TSIP_GenerateAes128RandomKeyIndexSub(uint32_t *OutData_KeyIndex)
{
    ...
    RX231_RX23W_function001(change_endian_long(0x23b0696du), change_endian_long(0x15e21147u), change_endian_long(0x2c3bd832u), change_endian_long(0x19cad629u));
    ...
    TSIP.REG_100H.WORD = change_endian_long(0x00000000u);
    RX231_RX23W_function001(change_endian_long(0x30d6d693u), change_endian_long(0xacb0bd2au), change_endian_long(0x050d3661u), change_endian_long(0xeb772334u));
    ...
    RX231_RX23W_function001(change_endian_long(0x53392dacu), change_endian_long(0xb7ccb9bdu), change_endian_long(0x116a2da5u), change_endian_long(0x1c872054u));
    TSIP.REG_104H.WORD = 0x00000251u;
    TSIP.REG_A4H.WORD = 0x0020363cu;
    /* WAIT_LOOP */
    while (1u != TSIP.REG_104H.BIT.B31)
    ...
    TSIP.REG_100H.WORD = change_endian_long(0x00000000u);
    RX231_RX23W_function001(change_endian_long(0xc3687ca4u), change_endian_long(0xe871acf0u), change_endian_long(0xec02a15cu), change_endian_long(0x2c708f11u));
    ...
    RX231_RX23W_function003(change_endian_long(0xfde7ab05u), change_endian_long(0xa48b3dc6u), change_endian_long(0xa4f7b942u), change_endian_long(0x3d21d8e1u));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX231HU/RX231HU_p06.prc
 *********************************************************************************************************************/
