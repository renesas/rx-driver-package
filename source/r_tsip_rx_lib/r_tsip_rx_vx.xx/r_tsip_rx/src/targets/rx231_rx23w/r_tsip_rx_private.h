...
#include "iodefine/r_tsip_rx231_rx23w_iodefine.h"
...
void RX231_RX23W_function001(uint32_t ARG1, uint32_t ARG2, uint32_t ARG3, uint32_t ARG4);
void RX231_RX23W_function002(uint32_t ARG1, uint32_t ARG2, uint32_t ARG3, uint32_t ARG4);
void RX231_RX23W_function003(uint32_t ARG1, uint32_t ARG2, uint32_t ARG3, uint32_t ARG4);
void RX231_RX23W_function030(void);
