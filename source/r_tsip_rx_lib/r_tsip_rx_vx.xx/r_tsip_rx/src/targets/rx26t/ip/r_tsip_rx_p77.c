...
*******************************************************************************************************************/ /**
* @details       RX26T AES-256 Encryption with CCM Mode Update
...
void R_TSIP_Aes256CcmEncryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX26T_function001(change_endian_long(0x78db1e6du), change_endian_long(0x10de65d7u), change_endian_long(0xec768a23u), change_endian_long(0x95582a89u));
    ...
    RX26T_function207();
    RX26T_function002(change_endian_long(0x3dce00b9u), change_endian_long(0xf3c19c97u), change_endian_long(0x9a72c572u), change_endian_long(0x9f379babu));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX26T/RX26T_p77.prc
 *********************************************************************************************************************/
