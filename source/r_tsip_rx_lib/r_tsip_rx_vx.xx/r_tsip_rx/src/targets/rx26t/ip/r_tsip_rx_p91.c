...
*******************************************************************************************************************/ /**
* @details       RX26T Update 128bit AES Key
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_UpdateAes128KeyIndexSub(uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX26T_function001(change_endian_long(0xe8b2eabcu), change_endian_long(0xb827ff0eu), change_endian_long(0xe681ade6u), change_endian_long(0x78ca831du));
    ...
    RX26T_function001(change_endian_long(0x9408a7cfu), change_endian_long(0x58342715u), change_endian_long(0x621eea5fu), change_endian_long(0x4346e0f6u));
    ...
    RX26T_function001(change_endian_long(0x3da56befu), change_endian_long(0xc287765du), change_endian_long(0x27b59d1eu), change_endian_long(0x59f87ad2u));
    ...
    TSIP.REG_100H.WORD = change_endian_long(0x00000000u);
    RX26T_function001(change_endian_long(0x7e8fb2adu), change_endian_long(0x4a3cae17u), change_endian_long(0xd2ed367du), change_endian_long(0x9be5ede5u));
    ...
    RX26T_function001(change_endian_long(0x5c938d06u), change_endian_long(0x70d86191u), change_endian_long(0xd032d821u), change_endian_long(0x04422765u));
    TSIP.REG_104H.WORD = 0x00000051u;
    TSIP.REG_A4H.WORD = 0x01000684u;
    /* WAIT_LOOP */
    while (1u != TSIP.REG_104H.BIT.B31)
    ...
    TSIP.REG_1CH.WORD = 0x00001800u;
    RX26T_function001(change_endian_long(0xbbe4e538u), change_endian_long(0xf1992e89u), change_endian_long(0x56bd48b4u), change_endian_long(0x937d6904u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX26T_function003(change_endian_long(0x0fdc6426u), change_endian_long(0xaeb08278u), change_endian_long(0x3b46a472u), change_endian_long(0xc7774a27u));
    ...
    {
        RX26T_function001(change_endian_long(0x9b70f835u), change_endian_long(0x79c3e44cu), change_endian_long(0x15d72297u), change_endian_long(0x3014fef5u));
        TSIP.REG_E0H.WORD = 0x81040000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        ...
        RX26T_function003(change_endian_long(0x69781672u), change_endian_long(0x14c4a5e9u), change_endian_long(0x84f660ffu), change_endian_long(0x2746d67au));
        TSIP.REG_1B4H.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX26T/RX26T_p91.prc
 *********************************************************************************************************************/
