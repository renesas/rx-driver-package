...
*******************************************************************************************************************/ /**
* @details       RX26T Install 128bit AES Key
...
e_tsip_err_t R_TSIP_GenerateAes128KeyIndexSub(uint32_t *InData_SharedKeyIndex, uint32_t *InData_SessionKey, uint32_t *InData_IV, uint32_t *InData_InstData, uint32_t *OutData_KeyIndex)
{
    ...
    RX26T_function001(change_endian_long(0x27b3f6fbu), change_endian_long(0xdbb72f0bu), change_endian_long(0x329b23f3u), change_endian_long(0x01484518u));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        RX26T_function003(change_endian_long(0x5e83bcd7u), change_endian_long(0xb660df40u), change_endian_long(0x89872b71u), change_endian_long(0x2ea7c9c0u));
    ...
    {
        RX26T_function001(change_endian_long(0x3bcd82b5u), change_endian_long(0x8111bb40u), change_endian_long(0x2a7814f3u), change_endian_long(0x5e90e68au));
        ...
        RX26T_function001(change_endian_long(0x0b089f31u), change_endian_long(0xe61573c3u), change_endian_long(0x42f9f515u), change_endian_long(0xc1504c1bu));
        ...
        RX26T_function001(change_endian_long(0x4389726au), change_endian_long(0xf73707e9u), change_endian_long(0xb8d1ebccu), change_endian_long(0xb69c5fd3u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        RX26T_function001(change_endian_long(0xf6324a30u), change_endian_long(0xf877d5bcu), change_endian_long(0x8a0e2455u), change_endian_long(0x93b12441u));
        TSIP.REG_104H.WORD = 0x00000361u;
        ...
        TSIP.REG_100H.WORD = change_endian_long(0x00000000u);
        RX26T_function001(change_endian_long(0xe7e37bfeu), change_endian_long(0x0a05b46eu), change_endian_long(0xf7e73cbau), change_endian_long(0xbaa0bd11u));
        ...
        RX26T_function001(change_endian_long(0x75063342u), change_endian_long(0x4d6aa95fu), change_endian_long(0xe0eaf17du), change_endian_long(0xc84ae6a5u));
        TSIP.REG_104H.WORD = 0x00000051u;
        TSIP.REG_A4H.WORD = 0x01000684u;
        /* WAIT_LOOP */
        while (1u != TSIP.REG_104H.BIT.B31)
        ...
        TSIP.REG_1CH.WORD = 0x00001800u;
        RX26T_function001(change_endian_long(0x551f0e30u), change_endian_long(0x1cafa254u), change_endian_long(0x4e2addd8u), change_endian_long(0x6abf3409u));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX26T_function003(change_endian_long(0x53ff6de8u), change_endian_long(0x9de6a328u), change_endian_long(0xf13f9d4cu), change_endian_long(0x8f914bb2u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        {
            RX26T_function001(change_endian_long(0xc5e090f6u), change_endian_long(0x2205a768u), change_endian_long(0x926dc28eu), change_endian_long(0x5bb71b8bu));
            TSIP.REG_E0H.WORD = 0x81040000u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
            ...
            RX26T_function003(change_endian_long(0x02e9d928u), change_endian_long(0x9b749b06u), change_endian_long(0xf912fdffu), change_endian_long(0xba1c850bu));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX26T/RX26T_p04.prc
 *********************************************************************************************************************/
TSIP_SEC_DEFAULT
