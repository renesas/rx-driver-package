...
*******************************************************************************************************************/ /**
* @details       RX26T AES-256 CMAC generation/verification Update
...
void R_TSIP_Aes256CmacUpdateSub(uint32_t *InData_Text, uint32_t MAX_CNT)
{
    ...
    RX26T_function205();
    RX26T_function002(change_endian_long(0xb32cbf31u), change_endian_long(0x7a962a03u), change_endian_long(0xf1fa4789u), change_endian_long(0x1038c1c8u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX26T/RX26T_p54.prc
 *********************************************************************************************************************/
