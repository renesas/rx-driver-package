...
*******************************************************************************************************************/ /**
* @details       RX26T GHASH calculation
* @param[in]     InData_HV
* @param[in]     InData_IV
...
e_tsip_err_t R_TSIP_Ghash(uint32_t *InData_HV, uint32_t *InData_IV, uint32_t *InData_Text, uint32_t *OutData_DataT, uint32_t MAX_CNT)
{
    ...
    RX26T_function001(change_endian_long(0xf647e766u), change_endian_long(0x4ae181d5u), change_endian_long(0xa7d60fe1u), change_endian_long(0x368bece0u));
    ...
    RX26T_function003(change_endian_long(0xf8814a86u), change_endian_long(0x05d21076u), change_endian_long(0x32d769fau), change_endian_long(0x721b39e0u));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX26T/RX26T_p22.prc
 *********************************************************************************************************************/
