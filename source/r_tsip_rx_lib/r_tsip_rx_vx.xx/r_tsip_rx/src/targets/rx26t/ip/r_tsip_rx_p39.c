...
*******************************************************************************************************************/ /**
* @details       RX26T AES-128 Decryption with GCM Mode Final
...
e_tsip_err_t R_TSIP_Aes128GcmDecryptFinalSub(uint32_t *InData_Text, uint32_t *InData_DataT, uint32_t *InData_DataALen, uint32_t *InData_TextLen, uint32_t *InData_DataTLen, uint32_t *OutData_Text)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX26T_function001(change_endian_long(0x0ff4a630u), change_endian_long(0xe60244acu), change_endian_long(0xb74fd880u), change_endian_long(0xac71819au));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        TSIP.REG_1CH.WORD = 0x002d0000u;
        RX26T_function001(change_endian_long(0xdcc05151u), change_endian_long(0xf6767836u), change_endian_long(0xc711f7aeu), change_endian_long(0x92c4182eu));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            ...
            RX26T_function002(change_endian_long(0x3a813e05u), change_endian_long(0x2bd317b0u), change_endian_long(0x17336103u), change_endian_long(0xad450488u));
        }
        else
        {
            RX26T_function002(change_endian_long(0x3f1fb99fu), change_endian_long(0x0d6be444u), change_endian_long(0xbd897aaeu), change_endian_long(0x3e15e28bu));
        }
        RX26T_function003(change_endian_long(0x3b5415d5u), change_endian_long(0x949b05c4u), change_endian_long(0xe8c903ffu), change_endian_long(0xbdd99028u));
    ...
    else
    {
        ...
        TSIP.REG_E0H.WORD = 0x00000080u;
        TSIP.REG_1CH.WORD = 0x00260000u;
        RX26T_function001(change_endian_long(0x8e5a9409u), change_endian_long(0x049c8983u), change_endian_long(0x7de5f313u), change_endian_long(0x6e7bc3ccu));
        TSIP.REG_1CH.WORD = 0x00400000u;
        TSIP.REG_1D0H.WORD = 0x00000000u;
        if (1u == (TSIP.REG_1CH.BIT.B22))
        {
            RX26T_function003(change_endian_long(0xdbd44493u), change_endian_long(0x29a9af91u), change_endian_long(0x0b50799au), change_endian_long(0x3e53cef3u));
            TSIP.REG_1BCH.WORD = 0x00000040u;
            /* WAIT_LOOP */
            while (0u != TSIP.REG_18H.BIT.B12)
            {
        ...
        else
        {
            ...
            RX26T_function001(change_endian_long(0x25660b91u), change_endian_long(0x3e80ee35u), change_endian_long(0x3c01eaa0u), change_endian_long(0x34eb8b10u));
            TSIP.REG_1CH.WORD = 0x00400000u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
            if (1u == (TSIP.REG_1CH.BIT.B22))
            {
                RX26T_function001(change_endian_long(0x7203fc4au), change_endian_long(0x2912e04eu), change_endian_long(0x28595ca9u), change_endian_long(0x8ce0deadu));
                ...
                RX26T_function002(change_endian_long(0x70e9369du), change_endian_long(0x414528ddu), change_endian_long(0x70f5c5c4u), change_endian_long(0x00ec312bu));
            }
            ...
            TSIP.REG_1D0H.WORD = 0x00000000u;
            RX26T_function001(change_endian_long(0x27443d47u), change_endian_long(0xea1d5e99u), change_endian_long(0x979d8810u), change_endian_long(0x262d5606u));
            TSIP.REG_1CH.WORD = 0x00400000u;
            TSIP.REG_1D0H.WORD = 0x00000000u;
            if (1u == (TSIP.REG_1CH.BIT.B22))
            {
                RX26T_function003(change_endian_long(0x375de0f7u), change_endian_long(0xa21a57b8u), change_endian_long(0x538d77f2u), change_endian_long(0xfc09164du));
                TSIP.REG_1BCH.WORD = 0x00000040u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_18H.BIT.B12)
                {
            ...
            {
                RX26T_function003(change_endian_long(0x4bbeb58du), change_endian_long(0xba2ad5cau), change_endian_long(0x4f651d42u), change_endian_long(0x3b6eeaf0u));
                TSIP.REG_1BCH.WORD = 0x00000040u;
                /* WAIT_LOOP */
                while (0u != TSIP.REG_18H.BIT.B12)
                {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX26T/RX26T_p39.prc
 *********************************************************************************************************************/
