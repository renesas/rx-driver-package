...
*******************************************************************************************************************/ /**
* @details       RX26T AES-128 CMAC generation/verification Update
...
void R_TSIP_Aes128CmacUpdateSub(uint32_t *InData_Text, uint32_t MAX_CNT)
{
    ...
    RX26T_function205();
    RX26T_function002(change_endian_long(0xf6ce892cu), change_endian_long(0x59cde473u), change_endian_long(0x894225cfu), change_endian_long(0xd4a09178u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX26T/RX26T_p51.prc
 *********************************************************************************************************************/
