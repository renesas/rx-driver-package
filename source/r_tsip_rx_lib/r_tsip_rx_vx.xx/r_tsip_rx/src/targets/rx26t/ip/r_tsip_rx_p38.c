...
*******************************************************************************************************************/ /**
* @details       RX26T AES-128 Decryption with GCM Mode Update
...
void R_TSIP_Aes128GcmDecryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX26T_function001(change_endian_long(0xdb14b819u), change_endian_long(0x885d4713u), change_endian_long(0xaa5ab9b5u), change_endian_long(0x6e108d93u));
    ...
    RX26T_function206();
    RX26T_function002(change_endian_long(0x77fea3f8u), change_endian_long(0xceb91deau), change_endian_long(0xf04ff057u), change_endian_long(0x2b9d2522u));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX26T/RX26T_p38.prc
 *********************************************************************************************************************/
