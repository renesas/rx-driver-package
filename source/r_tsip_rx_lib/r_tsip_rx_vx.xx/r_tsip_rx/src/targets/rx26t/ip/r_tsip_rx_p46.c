...
*******************************************************************************************************************/ /**
* @details       RX26T AES-256 Decryption with GCM Mode Update
...
void R_TSIP_Aes256GcmDecryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX26T_function001(change_endian_long(0x9cceda44u), change_endian_long(0x66c21ef1u), change_endian_long(0xbc2d70c5u), change_endian_long(0xb121385bu));
    ...
    RX26T_function206();
    RX26T_function002(change_endian_long(0x36feffbdu), change_endian_long(0xb02002f7u), change_endian_long(0x8cb4f418u), change_endian_long(0xc18f7b8du));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX26T/RX26T_p46.prc
 *********************************************************************************************************************/
