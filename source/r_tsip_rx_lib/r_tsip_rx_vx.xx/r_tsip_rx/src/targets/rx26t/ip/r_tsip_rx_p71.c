...
*******************************************************************************************************************/ /**
* @details       RX26T AES-128 Encryption with CCM Mode Update
...
void R_TSIP_Aes128CcmEncryptUpdateSub(uint32_t *InData_Text, uint32_t *OutData_Text, uint32_t MAX_CNT)
{
    ...
    (void)KEY_ADR;
    (void)OFS_ADR;
    RX26T_function001(change_endian_long(0x520a1eccu), change_endian_long(0x34edabbbu), change_endian_long(0x492a6642u), change_endian_long(0x41785451u));
    ...
    RX26T_function207();
    RX26T_function002(change_endian_long(0xd3b3c80eu), change_endian_long(0x669f6cf6u), change_endian_long(0x36ebce74u), change_endian_long(0x7017740cu));
}
/**********************************************************************************************************************
 End of function ./input_dir/RX26T/RX26T_p71.prc
 *********************************************************************************************************************/
