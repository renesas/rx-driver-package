...
*******************************************************************************************************************/ /**
* @details       RX26T Create 128bit AES Key
...
e_tsip_err_t R_TSIP_GenerateAes128RandomKeyIndexSub(uint32_t *OutData_KeyIndex)
{
    ...
    RX26T_function001(change_endian_long(0x327fa403u), change_endian_long(0xb0fcbf86u), change_endian_long(0x6bc41f7au), change_endian_long(0x52d149cbu));
    ...
    TSIP.REG_100H.WORD = change_endian_long(0x00000000u);
    RX26T_function001(change_endian_long(0xc4afa5bfu), change_endian_long(0xf9bcb1f2u), change_endian_long(0x012f2f67u), change_endian_long(0x792c8a23u));
    ...
    RX26T_function001(change_endian_long(0x75bde81bu), change_endian_long(0xa9d84166u), change_endian_long(0x81ab4bccu), change_endian_long(0x6044a252u));
    TSIP.REG_104H.WORD = 0x00000251u;
    TSIP.REG_A4H.WORD = 0x0020363cu;
    /* WAIT_LOOP */
    while (1u != TSIP.REG_104H.BIT.B31)
    ...
    TSIP.REG_100H.WORD = change_endian_long(0x00000000u);
    RX26T_function001(change_endian_long(0xb1929bc8u), change_endian_long(0x55102acau), change_endian_long(0xaaa35e84u), change_endian_long(0x5780c2d6u));
    ...
    RX26T_function003(change_endian_long(0x6c30092du), change_endian_long(0x48abfb38u), change_endian_long(0xd943e440u), change_endian_long(0x5a0077a7u));
...
/**********************************************************************************************************************
 End of function ./input_dir/RX26T/RX26T_p06.prc
 *********************************************************************************************************************/
