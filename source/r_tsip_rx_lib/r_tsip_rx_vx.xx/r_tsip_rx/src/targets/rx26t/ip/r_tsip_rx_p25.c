...
*******************************************************************************************************************/ /**
* @details       RX26T Program integrity check
...
e_tsip_err_t R_TSIP_VerifyFirmwareMacSub(uint32_t *InData_Program, uint32_t MAX_CNT)
{
    ...
    RX26T_function001(change_endian_long(0xaa373f3au), change_endian_long(0xdb8cddf9u), change_endian_long(0x44caf2cau), change_endian_long(0x667ada1du));
    TSIP.REG_1CH.WORD = 0x00400000u;
    TSIP.REG_1D0H.WORD = 0x00000000u;
    if (1u == (TSIP.REG_1CH.BIT.B22))
    {
        TSIP.REG_13CH.WORD = 0x000002ffu;
        RX26T_function003(change_endian_long(0x5cb47abcu), change_endian_long(0xd8bd07a2u), change_endian_long(0xbcd197eau), change_endian_long(0x99c40fc2u));
    ...
    {
        RX26T_function003(change_endian_long(0x8403db3du), change_endian_long(0x9798bed4u), change_endian_long(0xf1e7d182u), change_endian_long(0x329347abu));
        TSIP.REG_1BCH.WORD = 0x00000040u;
        /* WAIT_LOOP */
        while (0u != TSIP.REG_18H.BIT.B12)
        {
...
/**********************************************************************************************************************
 End of function ./input_dir/RX26T/RX26T_p25.prc
 *********************************************************************************************************************/
TSIP_SEC_DEFAULT
