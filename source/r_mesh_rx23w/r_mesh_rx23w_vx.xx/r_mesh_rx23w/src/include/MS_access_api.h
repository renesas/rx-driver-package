...
/**
 *  \brief Get element handle for a given model handle.
 *
 *  \par Description
 *  This routine searches for the element handle associated with specific model handle.
 *
 *  \param [in]  model_handle   Model handle.
 *  \param [out] elem_handle    Element handle associated with the model handle.
 *
 *  \return API_SUCCESS or an error code indicating reason for failure
 */
API_RESULT MS_access_get_element_handle_for_model_handle
           (
               /* IN */   MS_ACCESS_MODEL_HANDLE      model_handle,
               /* OUT */  MS_ACCESS_ELEMENT_HANDLE  * elem_handle
           );
