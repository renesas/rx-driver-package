...
/**
 * \defgroup net_module Network Layer (NET)
 * \ingroup mesh_core_block
 * \{
 *  \brief This section describes the interfaces & APIs offered by the EtherMind
 *  Mesh Network (NET) module to the Application and other upper
 *  layers of the stack.
 */
...
/**
 * \name GATT Proxy Configuration Opcodes
 * \{
 */
