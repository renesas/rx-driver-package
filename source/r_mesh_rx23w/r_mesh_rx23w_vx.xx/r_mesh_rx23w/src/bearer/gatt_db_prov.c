 ...
 *  ==========|==================================================|==============|==================================
 *    0x000A  |  0x2800 <<Primary Service>>                      |  RD          |  0x1827 <<Mesh Provisioning>>    
 *  ----------|--------------------------------------------------|--------------|----------------------------------
 *    0x000B  |  0x2803 <<Characteristic>>                       |  RD          |  Properties,Value Handle,UUID    
 *  ----------|--------------------------------------------------|--------------|----------------------------------
 *    0x000C  |  0x2ADB <<Mesh Provisioning Data In>>            |  WWR         |  0                               
 *  ----------|--------------------------------------------------|--------------|----------------------------------
 *    0x000D  |  0x2803 <<Characteristic>>                       |  RD          |  Properties,Value Handle,UUID    
 *  ----------|--------------------------------------------------|--------------|----------------------------------
 *    0x000E  |  0x2ADC <<Mesh Provisioning Data Out>>           |  NTF         |  N/A                             
 *  ----------|--------------------------------------------------|--------------|----------------------------------
...
static const uint8_t gs_gatt_const_uuid_arr[] =
{
    ...
    /* 20 - Mesh Provisioning */
    0x27, 0x18,

    /* 22 - Mesh Provisioning Data In */
    0xDB, 0x2A,

    /* 24 - Mesh Provisioning Data Out */
    0xDC, 0x2A,
...
static const uint8_t gs_gatt_const_value_arr[] =
{
    ...
    /* 15 - Mesh Provisioning Data In */
    0x04,       // Properties
    0x0C, 0x00, // Attr Handle
    0xDB, 0x2A, // UUID

    /* 20 - Mesh Provisioning Data Out */
    0x10,       // Properties
