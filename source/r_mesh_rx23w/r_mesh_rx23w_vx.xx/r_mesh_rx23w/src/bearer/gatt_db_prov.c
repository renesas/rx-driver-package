 ...
 *  --------+--------------------+------------------+---------------------
 *  0x0003  |       0x2A00       | Rd               | MT_Mesh_Provisioning!
 *  --------+--------------------+------------------+---------------------
 ...
 *  0x0021  |       0x2A50       | Rd               | 0
 *  ========+====================+==================+=====================
 *  0x0022  |       0x2800       | Rd               | 0x1827
 *  --------+--------------------+------------------+---------------------
 *  0x0023  |       0x2803       | Rd               | 0x04, 0x0024, 0x2ADB
 *  --------+--------------------+------------------+---------------------
 *  0x0024  |       0x2ADB       | Wwr              | 0
 *  --------+--------------------+------------------+---------------------
 *  0x0025  |       0x2803       | Rd               | 0x10, 0x0026, 0x2ADC
 *  --------+--------------------+------------------+---------------------
 *  0x0026  |       0x2ADC       | Ntf              | N/A
 *  --------+--------------------+------------------+---------------------
...
*******************************************************************************/
const uint8_t gatt_const_uuid_mesh_prov[] =
{
    ...
    /* 54 - Mesh Provisioning Service UUID */
    0x27, 0x18,

    /* 56 - Mesh Prov Data IN Characteristic UUID */
    0xDB, 0x2A,

    /* 58 - Mesh Prov Data OUT Characteristic UUID */
    0xDC, 0x2A,

};


uint8_t gatt_value_mesh_prov[] =
{
    /* 0 - BatteryLevel(3); Default: 100.0 */
    0x64,

    /* 1 - Mesh Prov Data IN(13); Default: 0 */
    0x42,
    ...
    /* 68 - Mesh Prov Data OUT(14); Default: N/A */
    0x42,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
const uint8_t gatt_const_value_mesh_prov[] =
{

    /* 0 - DeviceName(0); Property: 0x02, Value Handle: 0x0003, UUID: 0x2A00 */
    0x02, 0x03, 0x00, 0x00, 0x2A,

    /* 5 - DeviceName(0); Default: MT_Mesh_Provisioning! */
    0x4D, 0x54, 0x5F, 0x4D, 0x65, 0x73, 0x68, 0x5F, 0x50, 0x72, 0x6F, 0x76,
    0x69, 0x73, 0x69, 0x6F, 0x6E, 0x69, 0x6E, 0x67, 0x21,
    ...
    /* 188 - Mesh Prov Data IN(13); Property: 0x04, Value Handle: 0x0024, UUID: 0x2ADB */
    0x04, 0x24, 0x00, 0xDB, 0x2A,

    /* 193 - Mesh Prov Data OUT(14); Property: 0x10, Value Handle: 0x0026, UUID: 0x2ADC */
    0x10, 0x26, 0x00, 0xDC, 0x2A,
};

uint8_t gatt_db_peer_specific_val_mesh_prov[BLE_GATT_DB_MAX_PEER_CONFIGURATION];

const uint8_t gatt_db_const_peer_specific_val_mesh_prov[BLE_GATT_DB_PEER_VALUE_ARRAY_SIZE] =
{
    ...
    /* 4 - Client Configuration for Mesh Prov Data OUT */
    /* Client Instance 0 */
    0x00, 0x00,
};

const st_ble_gatts_db_uuid_cfg_t gatt_type_mesh_prov[] =
{
    {
        /* UUID Offset */
        0,
    ...
    },
    {
        ...
        /* Last Occurence for Type */
        BLE_GATT_DB_INVALID_ATTR_HANDLE_VAL_MESH_PROV,
...
const st_ble_gatts_db_attr_cfg_t gatt_db_attr_mesh_prov[] =
{
    /* Dummy */
    {
        /* Property */
    ...
    /* 0 - GAP - Service Declaration */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_uuid_mesh_prov + 20),
    },
    ...
    /* 0 - DeviceName - Characteristic Declaration */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_value_mesh_prov + 0),
    },
    ...
    /* 0 - DeviceName - Characteristic Value */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_value_mesh_prov + 5),
    },
    ...
    /* 1 - Appearance - Characteristic Declaration */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_value_mesh_prov + 26),
    },
    ...
    /* 1 - Appearance - Characteristic Value */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_value_mesh_prov + 31),
    },
    ...
    /* 1 - GATT - Service Declaration */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_uuid_mesh_prov + 26),
    },
    ...
    /* 2 - Service Changed - Characteristic Declaration */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_value_mesh_prov + 33),
    },
    ...
    /* 2 - Service Changed - CCD */
    {
        ...
        /* Value */
        gatt_db_peer_specific_val_mesh_prov + 0,
    },
    ...
    /* 2 - Battery - Service Declaration */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_uuid_mesh_prov + 30),
    },
    ...
    /* 3 - BatteryLevel - Characteristic Declaration */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_value_mesh_prov + 38),
    },
    ...
    /* 3 - BatteryLevel - CCD */
    {
        ...
        /* Value */
        gatt_db_peer_specific_val_mesh_prov + 2,
    },
    ...
    /* Characteristic 3 - BatteryLevel - Presentation Format */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_value_mesh_prov + 43),
    },
    ...
    /* 3 - DeviceInformation - Service Declaration */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_uuid_mesh_prov + 34),
    },
    ...
    /* 4 - ManufacturerName - Characteristic Declaration */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_value_mesh_prov + 50),
    },
    ...
    /* 4 - ManufacturerName - Characteristic Value */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_value_mesh_prov + 55),
    },
    ...
    /* 5 - ModelNumber - Characteristic Declaration */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_value_mesh_prov + 72),
    },
    ...
    /* 5 - ModelNumber - Characteristic Value */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_value_mesh_prov + 77),
    },
    ...
    /* 6 - SerialNumber - Characteristic Declaration */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_value_mesh_prov + 86),
    },
    ...
    /* 6 - SerialNumber - Characteristic Value */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_value_mesh_prov + 91),
    },
    ...
    /* 7 - FirmwareRevision - Characteristic Declaration */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_value_mesh_prov + 96),
    },
    ...
    /* 7 - FirmwareRevision - Characteristic Value */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_value_mesh_prov + 101),
    },
    ...
    /* 8 - HardwareRevision - Characteristic Declaration */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_value_mesh_prov + 106),
    },
    ...
    /* 8 - HardwareRevision - Characteristic Value */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_value_mesh_prov + 111),
    },
    ...
    /* 9 - SoftwareRevision - Characteristic Declaration */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_value_mesh_prov + 116),
    },
    ...
    /* 9 - SoftwareRevision - Characteristic Value */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_value_mesh_prov + 121),
    },
    ...
    /* 10 - SystemId - Characteristic Declaration */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_value_mesh_prov + 126),
    },
    ...
    /* 10 - SystemId - Characteristic Value */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_value_mesh_prov + 131),
    },
    ...
    /* 11 - RegCertDataList - Characteristic Declaration */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_value_mesh_prov + 139),
    },
    ...
    /* 11 - RegCertDataList - Characteristic Value */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_value_mesh_prov + 144),
    },
    ...
    /* 12 - PnPID - Characteristic Declaration */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_value_mesh_prov + 176),
    },
    ...
    /* 12 - PnPID - Characteristic Value */
    {
        ...
        /* Value */
        (uint8_t *)(gatt_const_value_mesh_prov + 181),
    },

    /* Handle - 0x0022 */
    /* 4 - Mesh Provisioning - Service Declaration */
    {
        /* Property */
        BLE_GATT_DB_READ,
        ...
        /* Value */
        (uint8_t *)(gatt_const_uuid_mesh_prov + 54),
    },

    /* Handle - 0x0023 */
    /* 13 - Mesh Prov Data IN - Characteristic Declaration */
    {
        /* Property */
        BLE_GATT_DB_READ,
        ...
        /* Value */
        (uint8_t *)(gatt_const_value_mesh_prov + 188),
    },

    /* Handle - 0x0024 */
    /* 13 - Mesh Prov Data IN - Characteristic Value */
    {
        /* Property */
        ...
        /* Value */
        gatt_value_mesh_prov + 1,
    },

    /* Handle - 0x0025 */
    /* 14 - Mesh Prov Data OUT - Characteristic Declaration */
    {
        /* Property */
        BLE_GATT_DB_READ,
        ...
        /* Value */
        (uint8_t *)(gatt_const_value_mesh_prov + 193),
    },

    /* Handle - 0x0026 */
    /* 14 - Mesh Prov Data OUT - Characteristic Value */
    {
        /* Property */
        BLE_GATT_DB_READ,
        ...
        /* Value */
        gatt_value_mesh_prov + 68,
    },

    /* Handle - 0x0027 */
    /* 14 - Mesh Prov Data OUT - CCD */
    {
        /* Property */
        BLE_GATT_DB_READ |
        BLE_GATT_DB_WRITE,
        ...
        /* Value */
        gatt_db_peer_specific_val_mesh_prov + 4,
    },

};


const st_ble_gatts_db_char_cfg_t gatt_char_mesh_prov[] =
{
...
const st_ble_gatts_db_serv_cfg_t gatt_serv_mesh_prov[] =
{
...
st_ble_gatts_db_cfg_t g_gatt_db_table_mesh_prov =
{
    gatt_const_uuid_mesh_prov,
    gatt_value_mesh_prov,
    gatt_const_value_mesh_prov,
    gatt_db_peer_specific_val_mesh_prov,
    gatt_db_const_peer_specific_val_mesh_prov,
    gatt_type_mesh_prov,
    gatt_db_attr_mesh_prov,
    gatt_char_mesh_prov,
    gatt_serv_mesh_prov,
    ARRAY_SIZE(gatt_serv_mesh_prov),
    ARRAY_SIZE(gatt_char_mesh_prov),
    ARRAY_SIZE(gatt_type_mesh_prov),
    ARRAY_SIZE(gatt_db_peer_specific_val_mesh_prov),
};
