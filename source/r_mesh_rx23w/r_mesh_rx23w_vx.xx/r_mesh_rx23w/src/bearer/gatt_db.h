...
extern st_ble_gatts_db_attr_cfg_t g_gatt_db_attr_table[];
...
typedef enum
{
    ...
    BLE_MESH_PROVS_DECL_HDL = 0x0010,
    BLE_MESH_PROVS_DATA_IN_DECL_HDL = 0x0011,
    BLE_MESH_PROVS_DATA_IN_VAL_HDL = 0x0012,
    BLE_MESH_PROVS_DATA_OUT_DECL_HDL = 0x0013,
    BLE_MESH_PROVS_DATA_OUT_VAL_HDL = 0x0014,
    BLE_MESH_PROVS_DATA_OUT_CLI_CNFG_DESC_HDL = 0x0015,
    BLE_MESH_PROXYS_DECL_HDL = 0x0016,
    BLE_MESH_PROXYS_DATA_IN_DECL_HDL = 0x0017,
    BLE_MESH_PROXYS_DATA_IN_VAL_HDL = 0x0018,
    BLE_MESH_PROXYS_DATA_OUT_DECL_HDL = 0x0019,
    BLE_MESH_PROXYS_DATA_OUT_VAL_HDL = 0x001A,
    BLE_MESH_PROXYS_DATA_OUT_CLI_CNFG_DESC_HDL = 0x001B,
} e_ble_attr_hdl_t;

#define BLE_GAPS_DEV_NAME_LEN (32)
...
#define BLE_MESH_PROVS_DATA_IN_LEN (66)
#define BLE_MESH_PROVS_DATA_OUT_LEN (66)
#define BLE_MESH_PROVS_DATA_OUT_CLI_CNFG_LEN (2)
#define BLE_MESH_PROXYS_DATA_IN_LEN (66)
#define BLE_MESH_PROXYS_DATA_OUT_LEN (66)
#define BLE_MESH_PROXYS_DATA_OUT_CLI_CNFG_LEN (2)
