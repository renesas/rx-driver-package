...
#define TOUCH_RATIO_CALC(a)    ((uint16_t) (a / 100))
  ...
  #define sci_err_t         rsci_err_t
  #define sci_cfg_t         rsci_cfg_t
  #define sci_hdl_t         rsci_hdl_t
  #define parity_en         parity_type
  #define sci_cb_args_t     rsci_cb_args_t
  #define SCI_EVT_TEI       RSCI_EVT_TEI
  #define SCI_EVT_RX_CHAR   RSCI_EVT_RX_CHAR
  #define SCI_CLK_INT       RSCI_CLK_INT
  #define SCI_DATA_8BIT     RSCI_DATA_8BIT
  #define SCI_PARITY_OFF    RSCI_NONE_PARITY
  #define SCI_EVEN_PARITY   RSCI_NONE_PARITY
  #define SCI_STOPBITS_1    RSCI_STOPBITS_1
  #define SCI_MODE_ASYNC    RSCI_MODE_ASYNC
  #define R_SCI_Open        R_RSCI_Open
  #define R_SCI_Close       R_RSCI_Close
  #define R_SCI_Send        R_RSCI_Send
