 ...
 **********************************************************************************************************************/
 ...
 #include "platform.h"
 #include "rm_rai_data_collector_r_timer_api_complement.h"
 #include "rm_rai_data_collector_r_transfer_api_complement.h"
#elif defined(__CCRL__) || defined(__ICCRL78__) || defined(__RL78__)
 #include <stddef.h>
 #include <stdbool.h>
 #include "r_cg_macrodriver.h"
 #include "r_fsp_error.h"
 #include "r_timer_api_complement.h"
 #include "r_transfer_api_complement.h"
#else
