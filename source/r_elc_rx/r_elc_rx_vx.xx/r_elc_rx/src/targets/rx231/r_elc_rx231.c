...
#if defined (BSP_MCU_RX231) /* This pre-processer need for complie when module added by FIT-Plugin */
...
void elc_open_init_register (void)
{
    ...
    ELC.ELSR[1].BYTE = 0x00;  /* Event Link Setting Register 1 initialize */
    ELC.ELSR[2].BYTE = 0x00;  /* Event Link Setting Register 2 initialize */
    ELC.ELSR[3].BYTE = 0x00;  /* Event Link Setting Register 3 initialize */
    ELC.ELSR[4].BYTE = 0x00;  /* Event Link Setting Register 4 initialize */
    ELC.ELSR[7].BYTE = 0x00;  /* Event Link Setting Register 7 initialize */
    ELC.ELSR[8].BYTE = 0x00;  /* Event Link Setting Register 8 initialize */
    ELC.ELSR[10].BYTE = 0x00; /* Event Link Setting Register 10 initialize */
    ELC.ELSR[12].BYTE = 0x00; /* Event Link Setting Register 12 initialize */
    ELC.ELSR[14].BYTE = 0x00; /* Event Link Setting Register 14 initialize */
    ELC.ELSR[15].BYTE = 0x00; /* Event Link Setting Register 15 initialize */
    ELC.ELSR[16].BYTE = 0x00; /* Event Link Setting Register 16 initialize */
    ELC.ELSR[18].BYTE = 0x00; /* Event Link Setting Register 18 initialize */
    ELC.ELSR[19].BYTE = 0x00; /* Event Link Setting Register 19 initialize */
    ELC.ELSR[20].BYTE = 0x00; /* Event Link Setting Register 20 initialize */
    ELC.ELSR[21].BYTE = 0x00; /* Event Link Setting Register 21 initialize */
    ELC.ELSR[22].BYTE = 0x00; /* Event Link Setting Register 22 initialize */
    ELC.ELSR[23].BYTE = 0x00; /* Event Link Setting Register 23 initialize */
    ELC.ELSR[24].BYTE = 0x00; /* Event Link Setting Register 24 initialize */
    ELC.ELSR[25].BYTE = 0x00; /* Event Link Setting Register 25 initialize */
    ELC.ELSR[26].BYTE = 0x00; /* Event Link Setting Register 26 initialize */
    ELC.ELSR[27].BYTE = 0x00; /* Event Link Setting Register 27 initialize */
    ELC.ELSR[28].BYTE = 0x00; /* Event Link Setting Register 28 initialize */
    ELC.ELSR[29].BYTE = 0x00; /* Event Link Setting Register 29 initialize */
    ...
    IEN(ELC,ELSR8I) = 0;    /* Interrupt Request Enable Register initialize */
 ...
 * Return Value : none
 ***********************************************************************************************************************/
#pragma interrupt elc_intelc_icu_lpt_isr(vect = VECT_ELC_ELSR8I)
