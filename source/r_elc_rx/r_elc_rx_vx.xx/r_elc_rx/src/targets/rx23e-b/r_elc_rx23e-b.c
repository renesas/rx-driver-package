...
#if defined (BSP_MCU_RX23E_B) /* This pre-processer need for complie when module added by FIT-Plugin */
...
void elc_open_init_register (void)
{
    ...
    ELC.ELSR29.BYTE = 0x00; /* Event Link Setting Register 29 initialize */
    ELC.ELSR46.BYTE = 0x00; /* Event Link Setting Register 46 initialize */
 ...
 ***********************************************************************************************************************/
#endif /* #if defined (BSP_MCU_RX23E_B) */
