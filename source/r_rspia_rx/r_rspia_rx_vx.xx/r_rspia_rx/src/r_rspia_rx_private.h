...
*                               Added macro for MRCKS bit: RSPIA_SPCR_MRCKS
...
#ifdef BSP_MCU_RX26T
#define RSPIA_SPCR_MRCKS   (0x00000080) /* Set this bit to 1. */
#endif
#define RSPIA_SPCR_SPPE    (0x00000100) /* 0: No parity.  */
                                        /* 1: Adds parity bit. */
#define RSPIA_SPCR_SPOE    (0x00000200) /* 0: Even parity. */
                                        /* 1: Odd parity. */
#define RSPIA_SPCR_PTE     (0x00000800) /* 0: Disable parity self diagnostic. */
                                        /* 1: Enable parity self diagnostic. */
#define RSPIA_SPCR_SCKASE  (0x00001000) /* 0: Disables the RSPCK auto-stop function. */
                                        /* 1: Enables the RSPCK auto-stop function */
#define RSPIA_SPCR_SCKDDIS (0x00002000) /* 0: Disables the RSPCK auto-stop function. */
                                        /* 1: Enables the RSPCK auto-stop function */
#define RSPIA_SPCR_MODFEN  (0x00004000) /* 0: Mode fault error detection disabled. */
                                        /* 1: Detection enabled. */
#define RSPIA_SPCR_SPEIE   (0x00010000) /* 0: Error Interrupt disabled. */
                                        /* 1: Error Interrupt enabled.*/
#define RSPIA_SPCR_SPRIE   (0x00020000) /* 0: Receive Interrupt disabled. */
                                        /* 1: Receive Interrupt enabled. */
#define RSPIA_SPCR_SPIIE   (0x00040000) /* 0: Disable Idle interrupt. */
                                        /* 1: Enable Idle interrupt */
#define RSPIA_SPCR_RDDIS   (0x00080000) /* 0: Select Receive data full interrupt. */
                                        /* 1: Select Error interrupt */
#define RSPIA_SPCR_SPTIE   (0x00100000) /* 0: Transmit Interrupt disabled */
                                        /* 1: Transmit Interrupt enabled */
#define RSPIA_SPCR_SPCIE   (0x00200000) /* 0: Communication End interrupt disabled */
                                        /* 1: Communication End interrupt enabled */
...
#define RSPIA_SPCR_FRFS    (0x02000000) /* 0: Motorola SPI. */
                                        /* 1: TI SSP */
#define RSPIA_SPCR_MSTR    (0x40000000) /* 0: Slave mode. */
                                        /* 1: Master mode. */
...
#define RSPIA_SSLP_SSL0P  (0x01)    /* [Motorola SPI] 0 = active low.  1 = active high. */
                                    /* [TI SSP]       0 = active high. 1 = active low. */
...
#define RSPIA_SPPCR_SPLP  (0x01)    /* 0: Normal mode. */
                                    /* 1: Loop-back mode (reversed transmit data = receive). */
#define RSPIA_SPPCR_SPLP2 (0x02)    /* 0: Normal mode. */
                                    /* 1: Loop-back mode (transmit data = receive data). */
#define RSPIA_SPPCR_MOIFV (0x10)    /* 0: MOSI pin idles low. */
                                    /* 1: MOSI pin idles high. */
#define RSPIA_SPPCR_MOIFE (0x20)    /* 0: MOSI pin idles at final previous data. */
                                    /* 1: MOSI pin idles at MOIFV. */
#define RSPIA_SPPCR_MASK  (0x33)    /* Protect reserved bits */

/* RSPIA Status Register  (SPSR) only Read */
#define RSPIA_SPSR_RRDYF (0x0080)   /* 0: Receive data ready is not detected. */
                                    /* 1: Receive data ready is detected. */
#define RSPIA_SPSR_OVRF  (0x0100)   /* 0: No overrun error. */
                                    /* 1: An overrun error occurred. */
#define RSPIA_SPSR_IDLNF (0x0200)   /* 0: RSPIA is in the idle state. */
                                    /* 1: RSPIA is in the transfer state. */
#define RSPIA_SPSR_MODF  (0x0400)   /* 0: No mode fault error */
                                    /* 1: A mode fault error occurred or an under run error occurs */
#define RSPIA_SPSR_PERF  (0x0800)   /* 0: No parity error. */
                                    /* 1: A parity error occurred. */
#define RSPIA_SPSR_UDRF  (0x1000)   /* 0: No under run error. */
                                    /* 1: An under run error occurs */
#define RSPIA_SPSR_SPTEF (0x2000)   /* 0: The number of empty stages in the transmit FIFO <= the value, */
                                    /*    which is set by the SPFCR.TTRG[1:0] bits */
                                    /* 1: The number of empty stages in the transmit FIFO  > the value, */
                                    /*    which is set by the SPFCR.TTRG[1:0] bits */
#define RSPIA_SPSR_SPCF  (0x4000)   /* 0: RSPIA is not communicating or communicating. */
                                    /* 1: RSPIA communication is completed. */
#define RSPIA_SPSR_SPRF  (0x8000)   /* 0: The number of data stored in the receive FIFO <= number of frames, */
                                    /*    which is set by the SPFCR.RTRG[1:0] bits. */
                                    /* 1: The number of data stored in the receive FIFO  > number of frames, */
                                    /*    which is set by the SPFCR.RTRG[1:0] bits. */
...
#define RSPIA_SPSCLR_UDRFC  (0x1000) /* 1: The under run error flag can be cleared. */
...
#define RSPIA_SPSCLR_MODF_UDRF_MASK   (0x1400) /* Mask clear mode fault and under run error flag */

/* RSPIA Data Control Register (SPDCR) masks*/
#define RSPIA_SPDCR_BYSW   (0x0001) /* 0: Byte swapping of SPDR data disabled */
#define RSPIA_SPDCR_SPRDTD (0x0008) /* 0: read SPDR values from RX buffer. */
                                    /* 1: values read from transmit buffer */
#define RSPIA_SPDCR_DINV   (0x0010) /* 0: Not invert serial data. */
...
#define RSPIA_SPCMD_CPOL   (0x00000002) /* 0: RSPCK is low when idle. */
                                        /* 1: RSPCK is high when idle. */
#define RSPIA_SPCMD_BRDV   (0x0000000C) /* Base bit-rate divisor. Div 2^N.  2-bits  */
#define RSPIA_SPCMD_SSLKP  (0x00000080) /* 0: SSL signal negated at end of transfer. */
                                        /* 1: Keep SSL level at end until next. */
#define RSPIA_SPCMD_LSBF   (0x00001000) /* 0: MSB first. */
                                        /* 1: LSB first. */
...
typedef struct rspia_cfg_block_s
{
    ...
    bool                      rspia_chan_opened; // RSPIA status - whether RSPIA module opened.
    void (*p_callback)(void * p_cbdat);          // A pointer to user callback function.
} rspia_cfg_block_t;
