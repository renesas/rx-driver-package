...
typedef struct st_abs_advertising_parameter
{
    union
    {
        ...
        ble_abs_non_connectable_advertising_parameter_t non_connectable_advertising_parameter; // Non-Connectable  
...
typedef struct st_ble_abs_instance_ctrl
{
    ...
    ble_abs_cfg_t * p_cfg;       ///< Pointer to the BLE ABS configuration block.
 ...
 **********************************************************************************************************************/
fsp_err_t RM_BLE_ABS_Open(ble_abs_ctrl_t * const p_ctrl, ble_abs_cfg_t * p_cfg);
