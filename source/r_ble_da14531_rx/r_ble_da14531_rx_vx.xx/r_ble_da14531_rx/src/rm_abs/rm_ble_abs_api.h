...
typedef enum e_ble_abs_advertising_filter
{
    ...
    BLE_ABS_ADVERTISING_FILTER_ALLOW_WHITE_LIST = 0x01, ///< Receive a connect request from only the devices 
                                                        ///< registered in White List.
...
/** ble_gap_connection_parameter_t is Connection parameters included in connection interval, slave latency, 
 * supervision timeout, ce length. */
...
typedef struct st_ble_gap_connection_phy_parameter
{
    ...
    ble_gap_connection_parameter_t * p_conn_param; ///< Connection interval, slave latency, 
                                                   ///< supervision timeout, and CE length.
...
typedef struct st_ble_abs_callback_args
{
    ...
    void const   * p_context;          ///< Placeholder for user data.  
                                       ///< Set in ble_abs_api_t::open function in ::ble_abs_cfg_t.
...
typedef struct st_ble_abs_legacy_advertising_parameter
{
     ...
     *  If the p_peer_address parameter is not NULL, Direct Connectable Advertising is 
     *  performed to the remote address. \n
     *  If the p_peer_address parameter is NULL, Undirect Connectable Advertising is 
     ...
     *  Time = duration * 10ms.\n
     *  After the elapse of the @ref fast_advertising_period, @ref BLE_GAP_EVENT_ADV_OFF event notifies 
     *  that the advertising has stopped.\n
     *  Valid range is 0x0000 - 0xFFFF. \n
     *  If the @ref fast_advertising_period parameter is 0x0000, advertising with the @ref fast_advertising_interval 
     *  parameter is not performed.
     */
     ...
     *  Time = duration * 10ms. \n
     *  After the elapse of the @ref slow_advertising_period, @ref BLE_GAP_EVENT_ADV_OFF event notifies 
     *  that the advertising has stopped. \n
     *  Valid range is 0x0000 - 0xFFFF. \n
     ...
     *  If the p_peer_address parameter is NULL, the advertising is performed according to 
     *  the advertising filter policy. \n
     *  If the p_peer_address parameter is not NULL, this parameter is ignored. \n
     *    |  macro                                              |   description                        |
     *    |:----------------------------------------------------|:-------------------------------------|
     *    | BLE_ABS_ADVERTISING_FILTER_ALLOW_ANY(0x00)          | Process scan and connection requests |
     *    |                                                     | from all devices.                    |
     *    | BLE_ABS_ADVERTISING_FILTER_ALLOW_WHITE_LIST(0x01)   | Process scan and connection requests |
     *    |                                                     | from only devices in the White List. |
     */
     ...
     *    | BLE_GAP_ADDR_RPA_ID_PUBLIC(0x02)    | Resolvable Private Address. \n If the IRK (Identity Resolving Key)|
     *    |                                     | of local device has not been registered in Resolving List,        |
...
typedef struct st_ble_abs_extend_advertising_parameter
{
    ...
    /**
     *  @brief After the elapse of the @ref fast_advertising_period, advertising with the 
     *  @ref slow_advertising_interval parameter \n
     ...
     *  that the advertising has stopped. \n
     *  Valid range is 0x0000 - 0xFFFF. \n
     *  If the @ref fast_advertising_period parameter is 0x0000, the @ref fast_advertising_interval 
...
typedef struct st_ble_abs_non_connectable_advertising_parameter
{
    /**
     *  @brief The remote device address. \n
     *  If the p_peer_address parameter is not NULL, Direct Connectable Advertising is performed 
    ...
    /**
     *  @brief Advertising with the advertising_interval parameter continues for the period specified 
     ...
     *  After the elapse of the advertising_duration, @ref BLE_GAP_EVENT_ADV_OFF event notifies 
     *  that the advertising has stopped. \n
     *  Valid range is 0x0000 - 0xFFFF. \n
    ...
    /**
     *  @brief Advertising data length (in bytes).\n
     *  If the primary_advertising_phy parameter is @ref BLE_ABS_ADVERTISING_PHY_LEGACY(0x00), 
     ...
     *    |  macro                               |   description                                                |
     *    |:-------------------------------------|:-------------------------------------------------------------|
     *    | BLE_ABS_ADVERTISING_PHY_LEGACY(0x00) | Use 1M PHY as Primary Advertising PHY for Non-Connectable    |
     *    |                                      | Legacy Advertising. \n If Periodic Advertising is performed, |
     *    |                                      | this value shall not set to the adv_phy parameter.           |
     *    | BLE_GAP_ADV_PHY_1M(0x01)             | Use 1M PHY as Primary Advertising PHY. \n When the           |
     *    |                                      | adv_prop_type field is Legacy Advertising PDU type, this     |
     *    |                                      | field shall be set to BLE_GAP_ADV_PHY_1M.                    |
     *    | BLE_GAP_ADV_PHY_CD(0x03)             | Use Coded PHY as Primary Advertising PHY. \n Coding scheme   |
     *    |                                      | is configured by @ref R_BLE_VS_SetCodingScheme().            |
     */
    uint8_t primary_advertising_phy;
...
typedef struct st_ble_abs_scan_parameter
{
     ...
     *  Valid range is 0x0000 - 0xFFFF. \n
     *  If the fast_scan_period parameter is 0x0000, scan with the fast scan interval/fast scan window 
     *  is not performed. \n
     ...
     *    | BLE_GAP_ADDR_RPA_ID_PUBLIC(0x02) | If the IRK (Identity Resolving Key) of local device has been        |
     *    |                                  | registered in Resolving list, use RPA. If not, use Public Address.  |
     *    | BLE_GAP_ADDR_RPA_ID_RANDOM(0x03) | If the IRK (Identity Resolving Key) of local device has been        |
     *    |                                  | registered in Resolving list, use RPA. If not, use Random Address.  |
     *
     *    - White list setting (Field [3:0])
     *    |  macro                                            |   description                                        |
     *    |:--------------------------------------------------|:-----------------------------------------------------|
     *    | BLE_GAP_SCAN_ALLOW_ADV_ALL(0x00)                  | Accept all advertising and scan response PDUs except |
     *    |                                                   | directed advertising PDUs not addressed to local     |
     *    |                                                   | device.                                              |
     *    | BLE_GAP_SCAN_ALLOW_ADV_WLST(0x01)                 | Accept only advertising and scan response PDUs from  |
     *    |                                                   | remote devices whose address is registered in the    |
     *    |                                                   | White List. \n Directed advertising PDUs which are   |
     *    |                                                   | not addressed to local device is ignored.            |
     *    | BLE_GAP_SCAN_ALLOW_ADV_EXCEPT_DIRECTED(0x02)      | Accept all advertising and scan response PDUs except |
     *    |                                                   | directed advertising PDUs whose the target address is| 
     *    |                                                   | identity address but doesn't address local device.   |
     *    |                                                   | However directed advertising PDUs whose the target   |
     *    |                                                   | address is the local resolvable private address      |
     *    |                                                   | are accepted.                                        |
     *    | BLE_GAP_SCAN_ALLOW_ADV_EXCEPT_DIRECTED_WLST(0x03) | Accept all advertising and scan response PDUs.       |
     *    |                                                   | The following are excluded.  \n \arg Advertising and |
     *    |                                                   | scan response PDUs where the advertiser's identity   |
     *    |                                                   | address is not in the White List. \n \arg Directed   |
     *    |                                                   | advertising PDUs whose the target address is identity|
     *    |                                                   | address but doesn't address local device. However    |
     *    |                                                   | directed advertising PDUs whose the target address is|
     *    |                                                   | the local resolvable private address are accepted.   |
     */
     ...
     *    | BLE_GAP_SCAN_FILT_DUPLIC_ENABLE_FOR_PERIOD(0x02)) | Duplicate filtering enabled, reset for |
     *    |                                                   | each scan period.                      |
     *
     */
...
typedef struct st_ble_abs_connection_parameter
{
     ...
     *  If the filter field is @ref BLE_GAP_INIT_FILT_USE_WLST(0x01), this parameter is ignored and please fill 
     *  p_device_address.addr with 0x00.
     */
     ...
     *    | BLE_GAP_ADDR_RAND(0x01)          | Use Random Address.                                         |
     *    | BLE_GAP_ADDR_RPA_ID_PUBLIC(0x02) | If the IRK (Identity Resolving Key) of local device has been| 
     *    |                                  | registered in Resolving list, use RPA. If not,              |
     *    |                                  | use Public Address.                                         |
     *    | BLE_GAP_ADDR_RPA_ID_RANDOM(0x03) | If the IRK (Identity Resolving Key) of local device has been| 
     *    |                                  | registered in Resolving list, use RPA. If not, use Random   |
     *    |                                  | Address.                                                    |
     *
     *    - White list setting (Field [3:0])
     *    |  macro                           |   description                                               |
     ...
     *    |                                  | is specified by the p_addr field is used.                   |
     *    | BLE_GAP_INIT_FILT_USE_WLST(0x01) | White List is used. \n The remote device registered in White|
     *    |                                  | List is connected with local device. \n The p_addr field is |
     *    |                                  | ignored.                                                    |
     */
...
typedef struct st_ble_abs_bond_information_parameter
{
    ...
    ble_abs_delete_bond_application_callback_t abs_delete_bond_callback; ///< User callback function executed when 
                                                                        ///<  erasing the remote device key.
...
typedef struct st_ble_abs_api
{
     ...
     */
    fsp_err_t (* startExtendedAdvertising)(
     ...
     */
    fsp_err_t (* deleteBondInformation)(
        ble_abs_ctrl_t * const                             p_ctrl,
     ...
     */
    fsp_err_t (* importKeyInformation)(ble_abs_ctrl_t * const p_ctrl,
     ...
     */
    fsp_err_t (* exportKeyInformation)(ble_abs_ctrl_t * const p_ctrl,
                                       ble_device_address_t * p_local_identity_address,
                                       uint8_t * p_local_irk,
                                       uint8_t * p_local_csrk);
} ble_abs_api_t;
