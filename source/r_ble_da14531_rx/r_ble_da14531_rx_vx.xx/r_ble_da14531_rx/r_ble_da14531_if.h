 ...
 * @brief Interface for Bluetooth Low Energy (BLE) functions.
 *
...
#ifndef R_BLE_DA14531_IF_H
#define R_BLE_DA14531_IF_H
...
typedef struct BLE_PACKED_OPTION
{
    ...
    /**
     *  @brief Minimum time in number of connection events to be observed once the path loss crosses 
     *  the threshold before an event is generated.
     */
 ...
 *  @brief  This structure notifies that OOB data for Secure Connections has been generated 
 *  by R_BLE_GAP_CreateScOobData().
 **********************************************************************************************************************/
typedef struct BLE_PACKED_OPTION
{
    /**
...
typedef struct BLE_PACKED_OPTION
{
    ...
    /**
     *  @brief Maximum time for a payload from the Central to Peripheral to be transmitted and re-transmitted, 
     *  after which it is flushed.
     */
    uint8_t c_ft;

    /**
     *  @brief Maximum time for a payload from the Peripheral to Central to be transmitted and re-transmitted, 
     *  after which it is flushed.
     */
    uint8_t p_ft;
...
typedef enum
{
     ...
     *                  <td>
     *                      When the maximum connections are established, a new connectable advertising tried starting.
     *                  </td>
     *              </tr>
     *          </table>
     *  </dd></dt></dl>
     ...
     *                  <td class="paramname">BLE_ERR_INVALID_STATE(0x0008)</td>
     *                  <td>
     *                       The add or delete operation was called, before the previous clear 
     ...
     *  @details
     *  This event notifies a request for updating packet data length and 
     *  transmission timer has been sent to Controller.
     *
     * ## Event Code: 0x111B
     *
     *  ## result:
...
typedef struct BLE_PACKED_OPTION
{
     ...
     *  @details  The address in the array registered in No.1-No.4 is specified to set the attribute value storage 
     *  area of the defined attribute.
     */
...
typedef struct BLE_PACKED_OPTION
{
     ...
     *                      <td>Unauthenticated pairing(Security Mode1 Security Level 2, 
     *                      Security Mode 2 Security Level 1)<BR/>
     *                      Unauthenticated pairing is required to access the service.
     *                      </td>
     *                  </tr>
     *                  <tr>
     *                      <td>BLE_GATT_DB_SER_SECURITY_AUTH(0x00000002)</td>
     *                      <td>Authenticated pairing(Security Mode1 Security Level 3, 
     *                      Security Mode 2 Security Level 2)<BR/>
     *                      Authenticated pairing is required to access the service.
     *                      </td>
     *                  </tr>
     *                  <tr>
     *                      <td>BLE_GATT_DB_SER_SECURITY_SECONN(0x00000004)</td>
     *                      <td>Authenticated LE secure connections that generates 16bytes 
     *                      LTK(Security Mode1 Security Level 4)<BR/>
     *                      Authenticated LE secure connections pairing that generates 16bytes LTK is required to 
     *                      access the service. If this bit is set, bit24-27 are ignored.
     *                      </td>
     *                  </tr>
     *              </table>
     *              <BR/>
     ...
     *              specify the bit0-bit4 to BLE_GATT_DB_SER_NO_SECURITY_PROPERTY(0x00000000).
     *              (Security Mode1 Security Level 1)<BR/>
...
typedef struct BLE_PACKED_OPTION
{
    ...
    /**
     *  @brief MTU of local (specified in @ref BLE_L2CAP_EVENT_CF_CONN_IND)
     *         / remote (notified in @ref BLE_L2CAP_EVENT_CF_CONN_CNF) device.
     */
    uint16_t mtu;

    /**
     *  @brief MPS of local (specified in @ref BLE_L2CAP_EVENT_CF_CONN_IND)
     *         / remote (notified in @ref BLE_L2CAP_EVENT_CF_CONN_CNF) device.
     */
    uint16_t mps;

    /**
     *  @brief Credit of local (specified in @ref BLE_L2CAP_EVENT_CF_CONN_IND)
     *         / remote (notified in @ref BLE_L2CAP_EVENT_CF_CONN_CNF) device.
     */
    uint16_t credit;
 ...
 *                                      - scan_type of p_scan_param's p_phy_param_1M 
 *                                        or p_phy_param_coded is out of range.
 *
 * @retval  BLE_ERR_UNSUPPORTED(0x0007) Not supported.
 * @retval  BLE_ERR_INVALID_STATE(0x0008) The task for host stack is not running.
 * @retval  BLE_ERR_MEM_ALLOC_FAILED(0x000C) Insufficient memory is needed to generate this function.
 ...
 * @details send synchronization information about the periodic advertising train identified by the Sync_Handle 
 *          parameter to a connected device.
 ...
 * @details BLE_GAP_EVENT_TX_POWER_REPT is received as a result when R_BLE_GAP_SetTransmitPowerReportingEnable
 *          is enabled.
...
/******************************************************************************************************************//**
 * @fn ble_status_t R_BLE_GAP_SetTransmitPowerReportingEnable(uint16_t conn_hdl, 
 ...
 *
 *          The transmitter is configured to one of the following, the receiver can't receive the packets 
 *          by this function.\n
