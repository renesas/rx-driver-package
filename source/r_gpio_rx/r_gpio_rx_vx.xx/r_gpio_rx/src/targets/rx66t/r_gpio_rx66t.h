...
***********************************************************************************************************************/
/***********************************************************************************************************************
* File Name    : r_gpio_rx66t.h
* Description  : Specifics for the r_gpio_rx driver for the RX66T.
***********************************************************************************************************************/
/***********************************************************************************************************************
...
#include "platform.h"
#if defined(BSP_MCU_RX66T)  /* Prevents the compiler from finding multiple definitions of constant in this file. */
...
#define GPIO_INFO_NUM_PORTS                 (20)    /* Includes PORTJ for proper indexing */
...
#define GPIO_DSCR_IS_SUPPORTED    /* High-drive output is supported for the RX66T */
#define GPIO_DSCR2_IS_SUPPORTED   /* Large current output, high-drive output is supported for the RX66T */
...
typedef enum
{
    ...
    GPIO_PORTK_PIN_MASK = 0x07,    /* Available pins: PK0 to PK2           */
} gpio_pin_bit_mask_t;
...
typedef enum
{
    ...
    GPIO_PORTB_PIN_MASK = 0xFF,    /* Available pins: PB0 to PB7           */
    GPIO_PORTC_PIN_MASK = 0x07,    /* Available pins: PC0 to PC2           */
    GPIO_PORTD_PIN_MASK = 0xFF,    /* Available pins: PD0 to PD7           */
...
typedef enum
{
    ...
    GPIO_PORT4_PIN_MASK = 0xFF,    /* Available pins: P40 to P47           */
    GPIO_PORT5_PIN_MASK = 0x3C,    /* Available pins: P52 to P55           */
    GPIO_PORT6_PIN_MASK = 0x34,    /* Available pins: P62, P64, P65        */
    GPIO_PORT7_PIN_MASK = 0x7F,    /* Available pins: P70 to P76           */
    GPIO_PORT9_PIN_MASK = 0x7F,    /* Available pins: P90 to P96           */
...
typedef enum
{
    ...
    GPIO_PORT9_PIN_MASK = 0x10,    /* Available pins: P94                   */
    GPIO_PORTA_PIN_MASK = 0x28,    /* Available pins: PA3, PA5              */
    GPIO_PORTB_PIN_MASK = 0x7F,    /* Available pins: PB0 to PB6            */
