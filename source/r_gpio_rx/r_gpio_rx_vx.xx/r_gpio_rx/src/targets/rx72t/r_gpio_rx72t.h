...
***********************************************************************************************************************/
/***********************************************************************************************************************
* File Name    : r_gpio_rx72t.h
* Description  : Specifics for the r_gpio_rx driver for the RX72T.
***********************************************************************************************************************/
/***********************************************************************************************************************
...
#include "platform.h"
#if defined(BSP_MCU_RX72T)  /* Prevents the compiler from finding multiple definitions of constant in this file. */
...
#define GPIO_DSCR_IS_SUPPORTED    /* High-drive output is supported for the RX72T */
#define GPIO_DSCR2_IS_SUPPORTED   /* Large current output, high-drive output is supported for the RX72T */
