...
#include "platform.h"
#if defined(BSP_MCU_RX660)  /* Prevents the compiler from finding multiple definitions of constant in this file. */
...
#define GPIO_INFO_NUM_PORTS                 (23)
    ...
    #define GPIO_INFO_NUM_PINS              (134)
#elif (BSP_PACKAGE_PINS == 100)
    #define GPIO_INFO_NUM_PINS              (92)
#elif (BSP_PACKAGE_PINS == 80)
    #define GPIO_INFO_NUM_PINS              (72)
#elif (BSP_PACKAGE_PINS == 64)
    #define GPIO_INFO_NUM_PINS              (56)
#elif (BSP_PACKAGE_PINS == 48)
    #define GPIO_INFO_NUM_PINS              (40)
#else
    #error "r_gpio_rx does not have information about this RX660 package. Please update r_gpio_rx660.h"
#endif
...
#define GPIO_DSCR_IS_SUPPORTED    /* High-drive output is supported for the RX660 */
...
typedef enum
{
    GPIO_PORT0_PIN_MASK = 0xFF,    /* Available pins: P00 to P07 */
    ...
    GPIO_PORTF_PIN_MASK = 0xE0,    /* Available pins: PF5 to PF7           */
    ...
    GPIO_PORTH_PIN_MASK = 0x0F,    /* Available pins: PH0 to PH3           */
                                   /* Products with a sub-clock oscillator do not have the PH6 and PH7 pins.*/
#endif
    GPIO_PORTJ_PIN_MASK = 0xFA,    /* Available pins: PJ1,PJ3 to PJ7       */
    ...
    GPIO_PORTN_PIN_MASK = 0x40,    /* Available pins: PN6                  */
                                   /* Products with a JTAG interface do not have the PN7 pin.*/
#endif
} gpio_pin_bit_mask_t;
...
#if (BSP_JTAG_INTERFACE == 0)
    GPIO_PORT_N_PIN_7 = 0x1607, /* Products with a JTAG interface do not have the PN7 pin.*/
#endif
} gpio_port_pin_t;
...
#else
    GPIO_PORT0_PIN_MASK = 0xF0,    /* Available pins: P04 to P07 */
                                   /* Products with a JTAG interface do not have the P03 pin. */
#endif
    GPIO_PORT1_PIN_MASK = 0xFC,    /* Available pins: P12 to P17           */
    GPIO_PORT2_PIN_MASK = 0xFF,    /* Available pins: P20 to P27           */
    GPIO_PORT3_PIN_MASK = 0xFF,    /* Available pins: P30 to P37           */
...
typedef enum
{
    GPIO_PORT0_PIN_MASK = 0x88,    /* Available pins: P03,P07                */
