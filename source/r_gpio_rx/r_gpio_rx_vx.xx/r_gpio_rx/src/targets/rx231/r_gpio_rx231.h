...
***********************************************************************************************************************/
/***********************************************************************************************************************
* File Name    : r_gpio_rx231.h
* Description  : Specifics for the r_gpio_rx driver for the RX231.
***********************************************************************************************************************/
/***********************************************************************************************************************
* History : DD.MM.YYYY Version Description
*         : 22.04.2015 1.00    First Release
*         : 14.05.2015 1.01    Updated to newer iodefine.h 0.9E
***********************************************************************************************************************/
#ifndef GPIO_RX231
#define GPIO_RX231
...
#include "platform.h"
#if defined(BSP_MCU_RX231)  //Prevents the compiler from finding multiple definitions of constant in this file.
...
#else
    #error "r_gpio_rx does not have information about this RX231 package. Please update r_gpio_rx231.h"
#endif
...
#define GPIO_DSCR_IS_SUPPORTED    //High-drive is supported for the RX231
