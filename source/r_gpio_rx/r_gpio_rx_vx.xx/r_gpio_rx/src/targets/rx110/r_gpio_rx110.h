...
* Description  : Specifics for the r_gpio_rx driver for the RX110.
***********************************************************************************************************************/
/***********************************************************************************************************************
...
#include "platform.h"
#if defined(BSP_MCU_RX110)  //Prevents the compiler from finding multiple definitions of constant in this file.
