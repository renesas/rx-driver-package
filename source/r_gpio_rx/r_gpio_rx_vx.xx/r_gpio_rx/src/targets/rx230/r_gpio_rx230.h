...
***********************************************************************************************************************/
/***********************************************************************************************************************
* File Name    : r_gpio_rx230.h
* Description  : Specifics for the r_gpio_rx driver for the RX230.
***********************************************************************************************************************/
/***********************************************************************************************************************
...
#include "platform.h"
#if defined(BSP_MCU_RX230)  //Prevents the compiler from finding multiple definitions of constant in this file.
...
#else
    #error "r_gpio_rx does not have information about this RX230 package. Please update r_gpio_rx230.h"
#endif
...
#define GPIO_DSCR_IS_SUPPORTED    //High-drive is supported for the RX230
