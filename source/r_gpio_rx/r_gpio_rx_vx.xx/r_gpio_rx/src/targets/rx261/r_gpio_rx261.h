...
***********************************************************************************************************************/
/***********************************************************************************************************************
* File Name    : r_gpio_rx261.h
* Description  : Specifics for the r_gpio_rx driver for the RX261.
***********************************************************************************************************************/
/***********************************************************************************************************************
...
#include "platform.h"
#if defined(BSP_MCU_RX261)  /* Prevents the compiler from finding multiple definitions of constant in this file */
...
#define GPIO_INFO_NUM_PORTS                 (19)
    ...
    #define GPIO_INFO_NUM_PINS              (90)
#elif (BSP_PACKAGE_PINS == 80)
    #define GPIO_INFO_NUM_PINS              (70)
#elif (BSP_PACKAGE_PINS == 64)
    #define GPIO_INFO_NUM_PINS              (54)
#elif (BSP_PACKAGE_PINS == 48)
    #define GPIO_INFO_NUM_PINS              (38)
#else
    #error "r_gpio_rx does not have information about this RX261 package. Please update r_gpio_rx261.h"
#endif
...
typedef enum
{
    ...
    GPIO_PORTH_PIN_MASK = 0xC9,    /* Available pins: PH0, PH3, PH6, PH7     */
...
{ 
    ...
    GPIO_PORTG_PIN_MASK = 0x80,    /* Available pins: PG7                      */
    GPIO_PORTH_PIN_MASK = 0x09,    /* Available pins: PH0, PH3                 */
    GPIO_PORTJ_PIN_MASK = 0xC0,    /* Available pins: PJ6, PJ7                 */
} gpio_pin_bit_mask_t;
