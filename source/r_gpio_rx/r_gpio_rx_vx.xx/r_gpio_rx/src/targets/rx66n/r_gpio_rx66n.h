...
***********************************************************************************************************************/
/***********************************************************************************************************************
* File Name    : r_gpio_rx66n.h
* Description  : Specifics for the r_gpio_rx driver for the RX66N.
***********************************************************************************************************************/
/***********************************************************************************************************************
...
#include "platform.h"
#if defined(BSP_MCU_RX66N)  /* Prevents the compiler from finding multiple definitions of constant in this file. */
...
#else
    #error "r_gpio_rx does not have information about this RX66N package. Please update r_gpio_rx66n.h"
#endif
...
#define GPIO_DSCR_IS_SUPPORTED    /* High-drive output is supported for the RX66N */
#define GPIO_DSCR2_IS_SUPPORTED   /* Large current output, high-drive output is supported for the RX66N */
