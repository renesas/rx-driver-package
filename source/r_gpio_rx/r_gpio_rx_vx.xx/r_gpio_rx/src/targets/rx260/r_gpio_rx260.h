...
***********************************************************************************************************************/
/***********************************************************************************************************************
* File Name    : r_gpio_rx260.h
* Description  : Specifics for the r_gpio_rx driver for the RX260.
***********************************************************************************************************************/
/***********************************************************************************************************************
...
#include "platform.h"
#if defined(BSP_MCU_RX260)  /* Prevents the compiler from finding multiple definitions of constant in this file */
...
#else
    #error "r_gpio_rx does not have information about this RX260 package. Please update r_gpio_rx260.h"
#endif
