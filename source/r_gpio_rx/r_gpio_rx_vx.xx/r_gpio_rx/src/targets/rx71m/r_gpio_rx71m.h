...
***********************************************************************************************************************/
/***********************************************************************************************************************
* File Name    : r_gpio_rx71m.h
* Description  : Specifics for the r_gpio_rx driver for the RX71M.
***********************************************************************************************************************/
/***********************************************************************************************************************
* History : DD.MM.YYYY Version Description
*         : 02.09.2015 1.00    First Release
*         : 03.06.2015 1.01    Fixed an error in the definition for GPIO_PRV_BASE_ADDR_DSCR.
*         : 24.04.2015 1.02    Added the compiler directive: "#if defined(BSP_MCU_RX71M)"
***********************************************************************************************************************/
#ifndef GPIO_RX71M
#define GPIO_RX71M
...
#include "platform.h"
#if defined(BSP_MCU_RX71M)  //Prevents the compiler from finding multiple definitions of constant in this file.
...
#else
    #error "r_gpio_rx does not have information about this RX71M package. Please update r_gpio_rx64m.h"
#endif
...
#define GPIO_DSCR_IS_SUPPORTED    //High-drive is supported for the RX71M
