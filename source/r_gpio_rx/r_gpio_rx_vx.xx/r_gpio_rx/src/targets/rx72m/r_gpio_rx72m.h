...
*         : 01.04.2021 2.00    Added support for RX72M 144pins, 100pins.
***********************************************************************************************************************/
#ifndef GPIO_RX72M
#define GPIO_RX72M
...
#include "platform.h"
#if defined(BSP_MCU_RX72M)  /* Prevents the compiler from finding multiple definitions of constant in this file. */
...
#define GPIO_INFO_NUM_PORTS                 (24)
    ...
    #define GPIO_INFO_NUM_PINS              (73)
#else
    #error "r_gpio_rx does not have information about this RX72M package. Please update r_gpio_rx72M.h"
#endif
...
typedef enum
{
    GPIO_PORT0_PIN_MASK = 0x2F,    /* Available pins: P00 to P03,P05        */
    ...
    GPIO_PORT6_PIN_MASK = 0xFF,    /* Available pins: P60 to P67            */
    GPIO_PORT7_PIN_MASK = 0xF8,    /* Available pins: P73 to P77            */
    GPIO_PORT8_PIN_MASK = 0xCF,    /* Available pins: P80 to P83,P86,P87    */
    GPIO_PORT9_PIN_MASK = 0xCF,    /* Available pins: P90 to P93,P96,P97    */
    GPIO_PORTA_PIN_MASK = 0xFF,    /* Available pins: PA0 to PA7            */
    GPIO_PORTB_PIN_MASK = 0xFF,    /* Available pins: PB0 to PB7            */
    GPIO_PORTC_PIN_MASK = 0xFF,    /* Available pins: PC0 to PC7            */
    GPIO_PORTD_PIN_MASK = 0xFF,    /* Available pins: PD0 to PD7            */
    GPIO_PORTE_PIN_MASK = 0xFF,    /* Available pins: PE0 to PE7            */
    GPIO_PORTG_PIN_MASK = 0xE7,    /* Available pins: PG0 to PG2,PG5 to PG7 */
    GPIO_PORTJ_PIN_MASK = 0x0C,    /* Available pins: PJ2, PJ3              */
} gpio_pin_bit_mask_t;
...
typedef enum
{
    ...
    GPIO_PORT2_PIN_MASK = 0xFB,    /* Available pins: P20,P21,P23 to P27    */
    GPIO_PORT3_PIN_MASK = 0xFF,    /* Available pins: P30 to P37            */
    GPIO_PORT4_PIN_MASK = 0x07,    /* Available pins: P40 to P42            */
    GPIO_PORT5_PIN_MASK = 0x47,    /* Available pins: P50 to P52,P56        */
    GPIO_PORT6_PIN_MASK = 0xDF,    /* Available pins: P60 to P64,P66,P67    */
    GPIO_PORT8_PIN_MASK = 0xC7,    /* Available pins: P80 to P82,P86,P87    */
    GPIO_PORT9_PIN_MASK = 0xCF,    /* Available pins: P90 to P93,P96,P97    */
    GPIO_PORTA_PIN_MASK = 0x5F,    /* Available pins: PA0 to PA4,PA6        */
    GPIO_PORTB_PIN_MASK = 0xFB,    /* Available pins: PB0,PB1,PB3 to PB7    */
    GPIO_PORTC_PIN_MASK = 0xF4,    /* Available pins: PC2,PC4 to PC7        */
    GPIO_PORTD_PIN_MASK = 0xC6,    /* Available pins: PD1,PD2,PD6,PD7       */
    GPIO_PORTE_PIN_MASK = 0x38,    /* Available pins: PE3 to PE5            */
    GPIO_PORTG_PIN_MASK = 0x64,    /* Available pins: PG2,PG5,PG6           */
} gpio_pin_bit_mask_t;
