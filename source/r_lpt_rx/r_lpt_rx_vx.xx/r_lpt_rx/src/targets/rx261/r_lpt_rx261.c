...
#if defined (BSP_MCU_RX261) /* This pre-processer need for compile when module added by FIT-Plugin */
...
lpt_err_t lpt_initchan(lpt_ch_t chan, uint32_t const cmt_period)
{
    ...
    {
        /* RX261 has only channel 0 and 1 */
        /* Do nothing */
    }
