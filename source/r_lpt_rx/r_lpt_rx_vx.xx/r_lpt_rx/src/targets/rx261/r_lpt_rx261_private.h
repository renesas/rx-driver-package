 ...
 *********************************************************************************************************************/
/**********************************************************************************************************************
 * File Name    : r_lpt_rx261_private.h
 * Version      : 1.00
...
/*******************************************************************************
  Macro definitions
*******************************************************************************/
#ifndef LPT_RX261_PRIVATE_H
#define LPT_RX261_PRIVATE_H
...
#else
    #error "ERROR - LPT_CFG_LPT_CLOCK_SOURCE - Unknown lpt clock source chosen in r_lpt_rx261_private.h"
#endif

#if   (2000000 < LPT_LPTSRCCLK_HZ)
    /* lpt_regval_calc() calculation result overflow when lpt clock source 2MHz greater. */
    #error "ERROR - LPT_LPTSRCCLK_HZ - 2MHz < lpt clock frequency in r_lpt_rx261_private.h"
#endif


#endif /* LPT_RX261_PRIVATE_H */
