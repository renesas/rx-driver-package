...
#define	CMPC0	(*(volatile struct st_cmpc0       *)0xA0C80)
#define	CMPC1	(*(volatile struct st_cmpc1       *)0xA0CA0)
#define	CMPC2	(*(volatile struct st_cmpc1       *)0xA0CC0)
...
#define	FLASH	(*(volatile struct st_flash       *)0x7FC100)
