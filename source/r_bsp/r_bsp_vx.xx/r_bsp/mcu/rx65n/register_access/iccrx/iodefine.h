...
*            : V2.30A (2025-02-14)  [Hardware Manual Revision : 2.30]
*
...
#define	SDSI		(*(volatile struct st_sdsi    __sfr __evenaccess *)0x95000)
...
#define	SMCI10		(*(volatile struct st_smci10  __sfr __evenaccess *)0xD0040)
#define	SMCI11		(*(volatile struct st_smci10  __sfr __evenaccess *)0xD0060)
