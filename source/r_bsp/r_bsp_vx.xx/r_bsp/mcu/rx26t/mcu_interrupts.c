...
R_BSP_ATTRIB_STATIC_INTERRUPT void group_bl1_handler_isr (void)
{
    ...
    if (1 == ICU.GRPBL1.BIT.IS25)
    {
        ...
        R_BSP_InterruptControl(BSP_INT_SRC_BL1_RSCI8_ERI, BSP_INT_CMD_CALL_CALLBACK, FIT_NO_PTR);
    }
    ...
    if (1 == ICU.GRPBL1.BIT.IS24)
    {
        ...
        R_BSP_InterruptControl(BSP_INT_SRC_BL1_RSCI8_TEI, BSP_INT_CMD_CALL_CALLBACK, FIT_NO_PTR);
    }
    ...
    if (1 == ICU.GRPBL1.BIT.IS27)
    {
        ...
        R_BSP_InterruptControl(BSP_INT_SRC_BL1_RSCI9_ERI, BSP_INT_CMD_CALL_CALLBACK, FIT_NO_PTR);
    }
    ...
    if (1 == ICU.GRPBL1.BIT.IS26)
    {
        ...
        R_BSP_InterruptControl(BSP_INT_SRC_BL1_RSCI9_TEI, BSP_INT_CMD_CALL_CALLBACK, FIT_NO_PTR);
    }

    /* BL1 IS31 */
    if (1 == ICU.GRPBL1.BIT.IS31)
    {
        /* BSP_INT_SRC_BL1_RSCI9_BFD */
        R_BSP_InterruptControl(BSP_INT_SRC_BL1_RSCI9_BFD, BSP_INT_CMD_CALL_CALLBACK, FIT_NO_PTR);
    }
...
R_BSP_ATTRIB_STATIC_INTERRUPT void group_al1_handler_isr (void)
{
    ...
    if (1 == ICU.GRPAL1.BIT.IS13)
    {
        ...
        R_BSP_InterruptControl(BSP_INT_SRC_AL1_RI3C0_EEI, BSP_INT_CMD_CALL_CALLBACK, FIT_NO_PTR);
    }
