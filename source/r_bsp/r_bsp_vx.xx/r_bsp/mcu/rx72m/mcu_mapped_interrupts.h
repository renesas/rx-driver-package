...
#define BSP_PRV_INT_A_NUM_ESC_SYNC0                                       92
#define BSP_PRV_INT_A_NUM_ESC_SYNC1                                       93
#define BSP_PRV_INT_A_NUM_ESC_SOF                                         94
#define BSP_PRV_INT_A_NUM_ESC_EOF                                         95
#define BSP_PRV_INT_A_NUM_ESC_WDT                                         96
#define BSP_PRV_INT_A_NUM_ESC_RESET                                       97
...
#if BSP_PRV_VALID_MAP_INT(A, BSP_MAPPED_INT_CFG_A_VECT_ESC_SYNC0)
#define IR_ESC_SYNC0       BSP_PRV_IR(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_ESC_SYNC0)
#define DTCE_ESC_SYNC0     BSP_PRV_DTCE(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_ESC_SYNC0)
#define IER_ESC_SYNC0      BSP_PRIV_CALC_IER_REG(BSP_MAPPED_INT_CFG_A_VECT_ESC_SYNC0)
#define IPR_ESC_SYNC0      BSP_PRV_IPR(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_ESC_SYNC0)
#define IEN_ESC_SYNC0      BSP_PRV_IEN(BSP_MAPPED_INT_CFG_A_VECT_ESC_SYNC0)
#define VECT_ESC_SYNC0     BSP_PRV_VECT(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_ESC_SYNC0)
#endif

#if BSP_PRV_VALID_MAP_INT(A, BSP_MAPPED_INT_CFG_A_VECT_ESC_SYNC1)
#define IR_ESC_SYNC1       BSP_PRV_IR(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_ESC_SYNC1)
#define DTCE_ESC_SYNC1     BSP_PRV_DTCE(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_ESC_SYNC1)
#define IER_ESC_SYNC1      BSP_PRIV_CALC_IER_REG(BSP_MAPPED_INT_CFG_A_VECT_ESC_SYNC1)
#define IPR_ESC_SYNC1      BSP_PRV_IPR(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_ESC_SYNC1)
#define IEN_ESC_SYNC1      BSP_PRV_IEN(BSP_MAPPED_INT_CFG_A_VECT_ESC_SYNC1)
#define VECT_ESC_SYNC1     BSP_PRV_VECT(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_ESC_SYNC1)
#endif

#if BSP_PRV_VALID_MAP_INT(A, BSP_MAPPED_INT_CFG_A_VECT_ESC_SOF)
#define IR_ESC_SOF       BSP_PRV_IR(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_ESC_SOF)
#define DTCE_ESC_SOF     BSP_PRV_DTCE(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_ESC_SOF)
#define IER_ESC_SOF      BSP_PRIV_CALC_IER_REG(BSP_MAPPED_INT_CFG_A_VECT_ESC_SOF)
#define IPR_ESC_SOF      BSP_PRV_IPR(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_ESC_SOF)
#define IEN_ESC_SOF      BSP_PRV_IEN(BSP_MAPPED_INT_CFG_A_VECT_ESC_SOF)
#define VECT_ESC_SOF     BSP_PRV_VECT(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_ESC_SOF)
#endif

#if BSP_PRV_VALID_MAP_INT(A, BSP_MAPPED_INT_CFG_A_VECT_ESC_EOF)
#define IR_ESC_EOF       BSP_PRV_IR(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_ESC_EOF)
#define DTCE_ESC_EOF     BSP_PRV_DTCE(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_ESC_EOF)
#define IER_ESC_EOF      BSP_PRIV_CALC_IER_REG(BSP_MAPPED_INT_CFG_A_VECT_ESC_EOF)
#define IPR_ESC_EOF      BSP_PRV_IPR(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_ESC_EOF)
#define IEN_ESC_EOF      BSP_PRV_IEN(BSP_MAPPED_INT_CFG_A_VECT_ESC_EOF)
#define VECT_ESC_EOF     BSP_PRV_VECT(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_ESC_EOF)
#endif

#if BSP_PRV_VALID_MAP_INT(A, BSP_MAPPED_INT_CFG_A_VECT_ESC_WDT)
#define IR_ESC_WDT       BSP_PRV_IR(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_ESC_WDT)
#define DTCE_ESC_WDT     BSP_PRV_DTCE(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_ESC_WDT)
#define IER_ESC_WDT      BSP_PRIV_CALC_IER_REG(BSP_MAPPED_INT_CFG_A_VECT_ESC_WDT)
#define IPR_ESC_WDT      BSP_PRV_IPR(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_ESC_WDT)
#define IEN_ESC_WDT      BSP_PRV_IEN(BSP_MAPPED_INT_CFG_A_VECT_ESC_WDT)
#define VECT_ESC_WDT     BSP_PRV_VECT(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_ESC_WDT)
#endif

#if BSP_PRV_VALID_MAP_INT(A, BSP_MAPPED_INT_CFG_A_VECT_ESC_RESET)
#define IR_ESC_RESET       BSP_PRV_IR(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_ESC_RESET)
#define DTCE_ESC_RESET     BSP_PRV_DTCE(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_ESC_RESET)
#define IER_ESC_RESET      BSP_PRIV_CALC_IER_REG(BSP_MAPPED_INT_CFG_A_VECT_ESC_RESET)
#define IPR_ESC_RESET      BSP_PRV_IPR(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_ESC_RESET)
#define IEN_ESC_RESET      BSP_PRV_IEN(BSP_MAPPED_INT_CFG_A_VECT_ESC_RESET)
#define VECT_ESC_RESET     BSP_PRV_VECT(BSP_PRV_A, BSP_MAPPED_INT_CFG_A_VECT_ESC_RESET)
#endif
