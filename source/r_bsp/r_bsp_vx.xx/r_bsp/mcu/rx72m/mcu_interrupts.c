...
R_BSP_ATTRIB_STATIC_INTERRUPT void group_bl2_handler_isr (void)
{
    ...
    if (1 == ICU.GRPBL2.BIT.IS1)
    {
        ...
        R_BSP_InterruptControl(BSP_INT_SRC_BL2_DSMIF0_OCDI0, BSP_INT_CMD_CALL_CALLBACK, FIT_NO_PTR);
    }
    ...
    if (1 == ICU.GRPBL2.BIT.IS2)
    {
        ...
        R_BSP_InterruptControl(BSP_INT_SRC_BL2_DSMIF0_SUMEI0, BSP_INT_CMD_CALL_CALLBACK, FIT_NO_PTR);
    }
    ...
    if (1 == ICU.GRPBL2.BIT.IS3)
    {
        ...
        R_BSP_InterruptControl(BSP_INT_SRC_BL2_DSMIF0_SCDI0, BSP_INT_CMD_CALL_CALLBACK, FIT_NO_PTR);
    }
    ...
    if (1 == ICU.GRPBL2.BIT.IS4)
    {
        ...
        R_BSP_InterruptControl(BSP_INT_SRC_BL2_DSMIF1_OCDI1, BSP_INT_CMD_CALL_CALLBACK, FIT_NO_PTR);
    }
    ...
    if (1 == ICU.GRPBL2.BIT.IS5)
    {
        ...
        R_BSP_InterruptControl(BSP_INT_SRC_BL2_DSMIF1_SUMEI1, BSP_INT_CMD_CALL_CALLBACK, FIT_NO_PTR);
    }
    ...
    if (1 == ICU.GRPBL2.BIT.IS6)
    {
        ...
        R_BSP_InterruptControl(BSP_INT_SRC_BL2_DSMIF1_SCDI1, BSP_INT_CMD_CALL_CALLBACK, FIT_NO_PTR);
    }
...
R_BSP_ATTRIB_STATIC_INTERRUPT void group_al1_handler_isr (void)
{
    ...
    if (1 == ICU.GRPAL1.BIT.IS13)
    {
        ...
        R_BSP_InterruptControl(BSP_INT_SRC_AL1_ESC_ESCI, BSP_INT_CMD_CALL_CALLBACK, FIT_NO_PTR);
    }
