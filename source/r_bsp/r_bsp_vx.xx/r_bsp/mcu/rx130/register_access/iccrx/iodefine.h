...
#define	REMC1	(*(volatile struct st_remc   __sfr __evenaccess *)0xA0B80)
#define	REMCOM	(*(volatile struct st_remcom __sfr __evenaccess *)0xA0C00)
...
#define	SMCI1	(*(volatile struct st_smci1  __sfr __evenaccess *)0x8A020)
#define	SMCI5	(*(volatile struct st_smci  __sfr __evenaccess *)0x8A0A0)
#define	SMCI6	(*(volatile struct st_smci1  __sfr __evenaccess *)0x8A0C0)
#define	SMCI8	(*(volatile struct st_smci  __sfr __evenaccess *)0x8A100)
#define	SMCI9	(*(volatile struct st_smci1  __sfr __evenaccess *)0x8A120)
#define	SMCI12	(*(volatile struct st_smci1  __sfr __evenaccess *)0x8B300)
#define	SYSTEM	(*(volatile struct st_system __sfr __evenaccess *)0x80000)
#define	TEMPS	(*(volatile struct st_temps  __sfr __evenaccess *)0x7FC0AC)
