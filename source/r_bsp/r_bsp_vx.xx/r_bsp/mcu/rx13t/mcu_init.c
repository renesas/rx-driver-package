 ...
 * for their group (e.g. MCU with 32 pins when maximum is 48 pins) these 'non-existent' pins that are not bonded out
 ...
 */
    ...
    /* Refer User's Manual: Hardware Table 17.3. */
    ...
    /* Refer User's Manual: Hardware Table 17.4. */
    #define BSP_PRV_PORT1_NE_PIN_MASK     (0x01)
    #define BSP_PRV_PORT2_NE_PIN_MASK     (0x1C)
    #define BSP_PRV_PORT3_NE_PIN_MASK     (0x00)
    #define BSP_PRV_PORT4_NE_PIN_MASK     (0xE0)
    #define BSP_PRV_PORT7_NE_PIN_MASK     (0x01)
    #define BSP_PRV_PORT9_NE_PIN_MASK     (0x00)
    #define BSP_PRV_PORTA_NE_PIN_MASK     (0x00)
    #define BSP_PRV_PORTB_NE_PIN_MASK     (0x30)
    #define BSP_PRV_PORTD_NE_PIN_MASK     (0x78)
#else
