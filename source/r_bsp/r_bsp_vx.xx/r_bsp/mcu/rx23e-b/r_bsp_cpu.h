...
typedef enum
{
    /* PRC0
       ...
       MOSCCR, SOSCCR, LOCOCR, ILOCOCR, HOCOCR, OSTDCR, OSTDSR, CKOCR, LCDSCLKCR, LCDSCLKCR2, LOCOTRR, ILOCOTRR,
       HOCOTRR0 */
    ...
    /* PRC1
       ...
       and software reset: SYSCR1, SBYCR, MSTPCRA, MSTPCRB, MSTPCRC, MSTPCRD, OPCCR, SOPCCR, RSTCKCR,
       MOFCR, MOSCWTCR, SWRR */
