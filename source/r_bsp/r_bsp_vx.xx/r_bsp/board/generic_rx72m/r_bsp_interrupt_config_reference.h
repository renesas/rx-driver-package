...
#define BSP_MAPPED_INT_CFG_A_VECT_ESC_SYNC0
#define BSP_MAPPED_INT_CFG_A_VECT_ESC_SYNC1
#define BSP_MAPPED_INT_CFG_A_VECT_ESC_SOF  
#define BSP_MAPPED_INT_CFG_A_VECT_ESC_EOF  
#define BSP_MAPPED_INT_CFG_A_VECT_ESC_WDT  
#define BSP_MAPPED_INT_CFG_A_VECT_ESC_RESET
