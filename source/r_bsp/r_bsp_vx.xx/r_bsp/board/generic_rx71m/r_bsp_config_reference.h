...
*         : 21.11.2023 4.04    Modified comment.
...
*         : 27.11.2024 4.05    Changed comment of BSP_CFG_RTC_ENABLE.
*         : 26.02.2025 4.06    Changed the disclaimer.
*         : 28.05.2025 4.07    Added the following macro definitions.
...
/* Group name.
   ...
   1M           = RX71M Group
*/
#define BSP_CFG_MCU_PART_GROUP          "RX71M"
...
/* Select the priority order for memory bus 1 (RAM) and memory bus 3 (ECCRAM).
