...
*         : 27.11.2024 1.02    Changed comment of BSP_CFG_RTC_ENABLE.
*         : 26.02.2025 1.03    Changed the disclaimer.
*         : 28.05.2025 1.04    Added the following macro definitions.
...
/* NOTE:
 The default settings are the same as when using RSSKRX23E-B.
...
/* Enter the product part number for your MCU. This information will be used to obtain information about your MCU such 
   ...
   | | | |  |  |________BSP_CFG_MCU_PART_MEMORY_SIZE  = ROM, RAM, and E2 DataFlash capacity
...
/* Chip version.
   ...
   B            = 0xB             = B: 24-bit delta-sigma A/D converter with a sampling rate of up to 125 kSPS, up to 5-V analog input range, LCD driver not included
   J            = 0x13            = J: 24-bit delta-sigma A/D converter with a sampling rate of up to 125 kSPS, up to 5-V analog input range, LCD driver included
   K            = 0x14            = K: 24-bit delta-sigma A/D converter with a sampling rate of up to 125 kSPS, up to 10-V analog input range, LCD driver not included
   L            = 0x15            = L: 24-bit delta-sigma A/D converter with a sampling rate of up to 125 kSPS, up to 10-V analog input range, LCD driver included
   M            = 0x16            = M: 24-bit delta-sigma A/D converter with a sampling rate of up to 31.25 kSPS, up to 5-V analog input range, LCD driver not included
   N            = 0x17            = N: 24-bit delta-sigma A/D converter with a sampling rate of up to 31.25 kSPS, up to 5-V analog input range, LCD driver included
*/
...
/* Group name.
   ...
   3E           = RX23E Group
*/
#define BSP_CFG_MCU_PART_GROUP          "RX23E-B"
...
/* The input clock frequency is specified and then the system clocks are set by specifying the multipliers used. The
   ...
   ICLK is 32MHz, PCLKB is 32MHz, PCLKC is 32MHz, PCLKD is 32MHz, and FCLK is 32MHz then the settings would be:
   ...
   BSP_CFG_PCKC_DIV = 1      : Peripheral Clock C (PCLKC) = 
                               (((BSP_CFG_XTAL_HZ/BSP_CFG_PLL_DIV) * BSP_CFG_PLL_MUL) / BSP_CFG_PCKC_DIV) = 32MHz
...
*/
#define BSP_CFG_CONFIGURATOR_VERSION                (2140)
