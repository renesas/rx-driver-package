...
*                                - BSP_CFG_SWINT_UNIT1_ENABLE
*         : 28.02.2023 3.02    Modified comment.
*         : 21.11.2023 3.03    Added the following macro definitions.
...
*         : 27.11.2024 3.04    Changed comment of BSP_CFG_RTC_ENABLE.
*         : 26.02.2025 3.05    Changed the disclaimer.
*         : 28.05.2025 3.06    Added the following macro definitions.
...
/* Group name.
   ...
   30           = RX130 Group
*/
#define BSP_CFG_MCU_PART_GROUP          "RX130"
