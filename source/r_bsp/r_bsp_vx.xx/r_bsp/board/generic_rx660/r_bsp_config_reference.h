...
*         : 28.02.2023 1.02     Modified comment.
*         : 21.11.2023 1.03     Added the following macro definitions.
...
/* NOTE:
   The default settings are the same as when using RSKRX660.
...
/* Enter the product part number for your MCU. This information will be used to obtain information about your MCU such 
   ...
   | | | |  |  | |______BSP_CFG_MCU_PART_FUNCTION            = JTAG interface included/not included,
   | | | |  |  |                                               sub-clock oscillator included/not include,
   | | | |  |  |                                               CAN FD mode supported/not supported.
...
/* Whether Encryption is included or not.
   ...
   A            = 0xA             = Without JTAG interface, without sub-clock oscillator,
                                    Only CAN 2.0 protocol supported
   B            = 0xB             = Without JTAG interface, without sub-clock oscillator,
                                    CAN FD protocol supported
   C            = 0xC             = Without JTAG interface, with sub-clock oscillator,
                                    Only CAN 2.0 protocol supported
   D            = 0xD             = Without JTAG interface, with sub-clock oscillator,
                                    CAN FD protocol supported
   E            = 0xE             = With JTAG interface, without sub-clock oscillator,
                                    Only CAN 2.0 protocol supported
   F            = 0xF             = With JTAG interface, without sub-clock oscillator,
                                    CAN FD protocol supported
   G            = 0x10            = With JTAG interface, with sub-clock oscillator,
                                    Only CAN 2.0 protocol supported
   H            = 0x11            = With JTAG interface, with sub-clock oscillator,
                                    CAN FD protocol supported
*/
...
/* ROM, RAM, and Data Flash Capacity.
   ...
   4            = 0x4             = 512KB/128KB/32KB
   9            = 0x9             = 1MB/128KB/32KB
*/
...
/* Group name.
   ...
   60           = RX660 Group
*/
#define BSP_CFG_MCU_PART_GROUP          "RX660"
...
/* Clock configuration options.
   ...
   ICLK is 120MHz, PCLKA is 120MHz, PCLKB is 60MHz, PCLKD is 60MHz, FCLK is 60MHz, CANFD Clock is 60MHz,
   and BCLK is 60MHz then the settings would be:
