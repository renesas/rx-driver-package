...
/*  According to HW Manual the Max Erasure Time for a 8KB Data Flash block is
    around 2558 ms.  This is with a FCLK of 1MHz. The calculation below
    calculates the number of ICLK ticks needed for the timeout delay.
    The 2558 ms number is adjusted linearly depending on the FCLK frequency.
*/
#define WAIT_MAX_ERASE_DF_1K \
        ((int32_t)(2558000 * (MCU_CFG_ICLK_HZ/1000000)))
