...
***********************************************************************************************************************/
/***********************************************************************************************************************
* File Name    : r_flash_rx66t.h
* Description  : This file contains equates for memory layout and timing constraints for
*                Code Flash (CF)/ROM and Data Flash (DF) on RX66T MCUs.
***********************************************************************************************************************/
/***********************************************************************************************************************
* History : DD.MM.YYYY Version Description
*         : 08.03.2018 1.00    First Release
***********************************************************************************************************************/

#ifndef RX_66T_FLASH_API_FILE
#define RX_66T_FLASH_API_FILE
...
#elif ((MCU_CFG_PART_MEMORY_SIZE == 0x0E) || (MCU_CFG_PART_MEMORY_SIZE == 0x0F))
 #define FLASH_NUM_BLOCKS_CF (22)
#elif (MCU_CFG_PART_MEMORY_SIZE == 0xA )
 #define FLASH_NUM_BLOCKS_CF (14)
#endif
...
#if MCU_CFG_PART_MEMORY_SIZE == 0x0A  /*   'A' parts 256K ROM */
...
#if ((MCU_CFG_PART_MEMORY_SIZE == 0x0E) || (MCU_CFG_PART_MEMORY_SIZE == 0x0F)) // 512K ROM
