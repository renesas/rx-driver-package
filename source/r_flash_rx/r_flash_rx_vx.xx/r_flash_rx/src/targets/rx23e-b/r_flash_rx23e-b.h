...
*         : 28.02.2023 5.10     First Release
***********************************************************************************************************************/

#ifndef R_FLASH_RX23E_B_H
#define R_FLASH_RX23E_B_H
...
/*  According to HW Manual the Max Erasure Time for a 2KB block is
    around 279.7ms.  This is with a FCLK of 1MHz. The calculation below
    calculates the number of ICLK ticks needed for the timeout delay.
    The 279.7ms number is adjusted linearly depending on the FCLK frequency.
*/
#define WAIT_MAX_ERASE_CF_1K \
        ((int32_t)(279700 *(MCU_CFG_ICLK_HZ/1000000)))

/*  According to HW Manual the Max Erasure Time for a 1KB Data Flash block is
    around 500.1 ms.  This is with a FCLK of 1MHz. The calculation below
    calculates the number of ICLK ticks needed for the timeout delay.
    The 500.1 ms number is adjusted linearly depending on the FCLK frequency.
*/
#define WAIT_MAX_ERASE_DF_1K \
        ((int32_t)(500100 * (MCU_CFG_ICLK_HZ/1000000)))
