...
*         : 09.09.2019 4.30     First Release
***********************************************************************************************************************/

#ifndef R_FLASH_RX13T_H
#define R_FLASH_RX13T_H
...
typedef enum _flash_block_address
{
    ...
    FLASH_DF_BLOCK_INVALID = 0x00101000     /*   1KB: Can't write beyond 0x00100fff */
} flash_block_address_t;


/*  According to HW Manual the Max Programming Time for 4 bytes (ROM)
    is 489 us.  This is with a FCLK of 32MHz. The calculation below
    calculates the number of ICLK ticks needed for the timeout delay.
    The 489us number is adjusted linearly depending on the FCLK frequency.
*/
#define WAIT_MAX_ROM_WRITE \
        ((int32_t)(489 * (32.0/(MCU_CFG_FCLK_HZ/1000000)))*(MCU_CFG_ICLK_HZ/1000000))
