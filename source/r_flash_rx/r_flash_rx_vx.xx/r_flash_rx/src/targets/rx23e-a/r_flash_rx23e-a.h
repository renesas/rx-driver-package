...
*         : 27.09.2019 4.40     First Release
***********************************************************************************************************************/

#ifndef R_FLASH_RX23E_A_H
#define R_FLASH_RX23E_A_H
...
/*  According to HW Manual the Max Erasure Time for a 256KB block is
    around 9816.9ms.  This is with a FCLK of 1MHz. The calculation below
    calculates the number of ICLK ticks needed for the timeout delay.
    The 9816.9ms number is adjusted linearly depending on the FCLK frequency.
*/
#define WAIT_MAX_ERASE_CF_1K \
        ((int32_t)(9816900 *(MCU_CFG_ICLK_HZ/1000000)))

/*  According to HW Manual the Max Erasure Time for a 8KB Data Flash block is
    around 2557.4 ms.  This is with a FCLK of 1MHz. The calculation below
    calculates the number of ICLK ticks needed for the timeout delay.
    The 2557.4 ms number is adjusted linearly depending on the FCLK frequency.
*/
#define WAIT_MAX_ERASE_DF_1K \
        ((int32_t)(2557400 * (MCU_CFG_ICLK_HZ/1000000)))

#define WAIT_MAX_ERASE_CF   WAIT_MAX_ERASE_CF_1K
#define WAIT_MAX_ERASE_DF   WAIT_MAX_ERASE_DF_1K

#endif /* R_FLASH_RX23E_A_H */
