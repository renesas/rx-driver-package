...
#define RX_71M_FLASH_API_PRIVATE_HEADER_FILE
...
#if (((FLASH_CFG_CODE_FLASH_ENABLE == 1) && (FLASH_CFG_CODE_FLASH_RUN_FROM_ROM == 1)) && (MCU_CFG_PART_MEMORY_SIZE == 0xF))
...
#endif/* RX_71M_FLASH_API_PRIVATE_HEADER_FILE */
